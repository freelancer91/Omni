...
public abstract class IntArrSeq implements OmniCollection.OfInt,Cloneable,Externalizable
{
  ...
  @Override public void readExternal(ObjectInput in) throws IOException
  {
    ...
    if(size!=0)
    {
      OmniArray.OfInt.readArray(this.arr=new int[size],0,size-1,in);
    }
  }
  private static  long markSurvivors(int[] arr,int srcOffset,int srcBound,IntPredicate filter)
  {
  ...
  private static  int markSurvivors(int[] arr,int srcOffset,int srcBound,IntPredicate filter,long[] survivorSet)
  {
        ...
        ,Serializable
  {
    ...
    private static class SerializableSubList implements Serializable
    {
      ...
      private void readObject(ObjectInputStream ois) throws IOException
      {
        ...
        if(size!=0)
        {
          OmniArray.OfInt.readArray(this.arr=new int[size],0,size-1,ois);
        }
      }
