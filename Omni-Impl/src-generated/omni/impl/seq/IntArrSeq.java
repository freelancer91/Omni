...
public abstract class IntArrSeq extends AbstractIntList implements OmniCollection.OfInt
{
  ...
  static boolean uncheckedcontains(int[] arr,int offset,int bound,int val)
  {
    for(;val!=(arr[offset]);)
    {
      if(++offset==bound)
  ...
  private static int uncheckedindexOf(int[] arr,int offset,int bound,int val)
  {
    int index;
  ...
  private static int uncheckedindexOf(int[] arr,int bound,int val)
  {
    int index;
  ...
  private static int uncheckedlastIndexOf(int[] arr,int offset,int bound,int val)
  {
    for(;val!=(arr[--bound]);)
    {
      if(bound==offset)
  ...
  private static int uncheckedlastIndexOf(int[] arr,int bound,int val)
  {
    for(;val!=(arr[--bound]);)
    {
      if(bound==0)
  ...
  private static int uncheckedsearch(int[] arr,int bound,int val)
  {
    int index;
  ...
  private static  void uncheckedreplaceAll(int[] arr,int offset,int bound,IntUnaryOperator operator)
  {
    do
    {
  ...
  static  void uncheckedForwardForEach(int[] arr,int offset,int bound,IntConsumer action)
  {
    do
    {
  ...
  static  void uncheckedReverseForEach(int[] arr,int offset,int bound,IntConsumer action)
  {
    do
    {
  ...
  private static int forwardHashCode(int[] arr,int offset,int bound)
  {
  ...
  private static int reverseHashCode(int[] arr,int offset,int bound)
  {
    int hash=31+(arr[offset]);
    while(bound!=offset)
    {
  ...
  private static void forwardToString(int[] arr,int offset,int bound,StringBuilder builder)
  {
    for(builder.append(arr[offset]);++offset!=bound;builder.append(',').append(' ').append(arr[offset]));
  }
  private static void reverseToString(int[] arr,int offset,int bound,StringBuilder builder)
  {
    for(builder.append(arr[--bound]);bound!=offset;builder.append(',').append(' ').append(arr[--bound]));
  }
  static  int pullSurvivorsUp(int[] arr,int srcBegin,int srcEnd,IntPredicate filter)
  {
    int dstOffset=srcBegin;
    while(srcBegin!=srcEnd)
    {
      final int v;
      if(!filter.test((int)(v=arr[--srcBegin])))
      {
        arr[dstOffset--]=v;
      }
    }
  ...
  static  int pullSurvivorsDown(int[] arr,int srcBegin,int srcEnd,IntPredicate filter)
  {
    int dstOffset=srcBegin;
    while(srcBegin!=srcEnd)
    {
  ...
  static  int markSurvivorsAndPullUp(CheckedCollection.AbstractModCountChecker modCountChecker,int[] arr,int srcOffset,int srcBound,IntPredicate filter)
  {
  ...
  static  int markSurvivorsAndPullDown(CheckedCollection.AbstractModCountChecker modCountChecker,int[] arr,int srcOffset,int srcBound,IntPredicate filter)
  {
    int dstOffset=srcOffset;
    for(;;)
    {
  ...
  static  int markSurvivorsReverse(int[] arr,long[] survivorSet,int offset,int bound,IntPredicate filter)
  {
  ...
  static  int markSurvivors(int[] arr,long[] survivorSet,int offset,int bound,IntPredicate filter)
  {
  ...
  static int pullSurvivorsUp(int[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors)
  {
  ...
  static int pullSurvivorsDown(int[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors)
  {
  ...
  public boolean contains(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      {
        return IntArrSeq.uncheckedcontains(arr,0,size,(int)(val));
      }
    }
    return false;
  }
  public int indexOf(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return IntArrSeq.uncheckedindexOf(arr,size,(int)(val));
      }
    }
    return -1;
  }
  public int lastIndexOf(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return IntArrSeq.uncheckedlastIndexOf(arr,size,(int)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return IntArrSeq.uncheckedsearch(arr,size,(int)(val));
      }
    }
    return -1;
  }
  ...
  public boolean contains(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return IntArrSeq.uncheckedcontains(arr,0,size,(int)TypeUtil.castToByte(val));
    }
    return false;
  }
  @Override
  public boolean contains(final int val)
  {
    ...
    {
      {
        return IntArrSeq.uncheckedcontains(arr,0,size,(val));
      }
    }
    return false;
  }
  ...
  public boolean contains(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntArrSeq.uncheckedcontains(arr,0,size,v);
      }
    }
    return false;
  }
  ...
  public int indexOf(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return IntArrSeq.uncheckedindexOf(arr,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int indexOf(final int val)
  {
    ...
    {
      {
        return IntArrSeq.uncheckedindexOf(arr,size,(val));
      }
    }
    return -1;
  }
  public int indexOf(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntArrSeq.uncheckedindexOf(arr,size,v);
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return IntArrSeq.uncheckedlastIndexOf(arr,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int lastIndexOf(final int val)
  {
    ...
    {
      {
        return IntArrSeq.uncheckedlastIndexOf(arr,size,(val));
      }
    }
    return -1;
  }
  public int lastIndexOf(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntArrSeq.uncheckedlastIndexOf(arr,size,v);
      }
    }
    return -1;
  }
  ...
  abstract void uncheckedCopyInto(final Integer[] dst,final int length);
  ...
  public int search(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return IntArrSeq.uncheckedsearch(arr,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int search(final int val)
  {
    ...
    {
      {
        return IntArrSeq.uncheckedsearch(arr,size,(val));
      }
    }
    return -1;
  }
  public int search(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntArrSeq.uncheckedsearch(arr,size,v);
      }
    }
    return -1;
  }
  ...
  public static abstract class Checked extends IntArrSeq
  {
    ...
    private Checked(final int size,final int[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    @Override
    boolean uncheckedRemoveIf(int size,final IntPredicate filter)
    {
      int srcOffset;
  ...
  public static class CheckedList extends Checked implements OmniList.OfInt
  {
    public CheckedList()
    {
      super();
    ...
    public CheckedList(final int size,final int[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    @Override
    public OmniListIterator.OfInt listIterator(final int index)
    {
      CheckedCollection.checkLo(index);
    ...
    public void replaceAll(final IntUnaryOperator operator)
    {
      ...
      if(0!=((size=this.size)))
      {
        ...
        try
        {
          IntArrSeq.uncheckedreplaceAll(arr,0,size,operator);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    @Override
    public void sort(final IntBinaryOperator sorter)
    {
      final int size;
      if(1<((size=this.size)))
      {
    ...
    public void replaceAll(final UnaryOperator<Integer> operator)
    {
      ...
      if(0!=((size=this.size)))
      {
        ...
        try
        {
          IntArrSeq.uncheckedreplaceAll(arr,0,size,operator::apply);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    @Override
    public void sort(final Comparator<? super Integer> sorter)
    {
      final int size;
      if(1<((size=this.size)))
      {
    ...
    @Override
    public OmniList.OfInt subList(final int fromIndex,final int toIndex)
    {
    ...
    @Override
    void uncheckedCopyInto(final Integer[] arr,final int size)
    {
      ArrCopy.uncheckedCopy(this.arr,0,arr,0,size);
    }
    @Override
    ...
    @Override
    void uncheckedForEach(final int size,final IntConsumer action)
    {
      int modCount=this.modCount;
      try
      {
    ...
    private static class BidirectionalItr implements OmniListIterator.OfInt
    {
      ...
      public void add(final int val)
      {
        ...
        {
          ((IntArrSeq)root).uncheckedInsert(cursor,val,rootSize);
        }
        else
        {
    ...
    private static class SubList extends AbstractIntList implements OmniList.OfInt
    {
      ...
      public boolean add(final int val)
      {
        ...
        if((rootSize=root.size)!=0)
        {
          ((IntArrSeq)root).uncheckedInsert(rootOffset+size,val,rootSize);
        }
        else
        {
          ((IntArrSeq)root).uncheckedInit(val);
      ...
      public void add(final int index,final int val)
      {
        ...
        if((rootSize=root.size)!=0)
        {
          ((IntArrSeq)root).uncheckedInsert(rootOffset+index,val,rootSize);
        }
        else
        {
          ((IntArrSeq)root).uncheckedInit(val);
      ...
      public boolean contains(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedcontains(size,(int)TypeUtil.castToByte(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return false;
      }
      ...
      public int indexOf(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedindexOf(size,(int)TypeUtil.castToByte(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return -1;
      }
      ...
      public int lastIndexOf(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedlastIndexOf(size,(int)TypeUtil.castToByte(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return -1;
      }
      ...
      public int removeIntAt(int index)
      {
        ...
        CheckedCollection.checkReadHi(index,size=this.size);
        final int[] arr;
        final var removed=(int)(arr=root.arr)[index+=rootOffset];
      ...
      @Override
      public int set(int index,final int val)
      {
        final var root=checkModCountAndGetRoot();
        CheckedCollection.checkLo(index);
        CheckedCollection.checkReadHi(index,this.size);
      ...
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedcontains(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedindexOf(final int size,final int val)
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedindexOf(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedlastIndexOf(final int size,final int val)
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedlastIndexOf(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      ...
      private boolean uncheckedRemoveIf(int size,final IntPredicate filter)
      {
        ...
        try
        {
          ...
          root.modCount=++modCount;
          this.modCount=modCount;
          this.size=size-(size=((IntArrSeq)root).finalizeSubListBatchRemove(arr,dstOffset,srcBound));
          bubbleUpDecrementSize(parent,size);
        }
        catch(final RuntimeException e)
        {
  ...
  public static class CheckedStack extends Checked implements OmniStack.OfInt
  {
    public CheckedStack()
    {
      super();
    ...
    public CheckedStack(final int size,final int[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    public OmniIterator.OfInt iterator()
    {
      return new CheckedDescendingItr(this);
        ...
        public int pollInt()
        {
          ...
          {
            ++modCount;
            return (int)(((IntArrSeq)this).uncheckedPop(size-1));
          }
          return Integer.MIN_VALUE;
        }
        @Override
        public Integer poll()
        {
          ...
          {
            ++modCount;
            return (Integer)(((IntArrSeq)this).uncheckedPop(size-1));
          }
          return null;
        }
        @Override
        public double pollDouble()
        {
          ...
          {
            ++modCount;
            return (double)(((IntArrSeq)this).uncheckedPop(size-1));
          }
          return Double.NaN;
        }
        @Override
        public float pollFloat()
        {
          ...
          {
            ++modCount;
            return (float)(((IntArrSeq)this).uncheckedPop(size-1));
          }
          return Float.NaN;
        }
        @Override
        public long pollLong()
        {
          ...
          {
            ++modCount;
            return (long)(((IntArrSeq)this).uncheckedPop(size-1));
          }
          return Long.MIN_VALUE;
        }
    @Override
    ...
    private static class CheckedDescendingItr extends AbstractIntItr implements OmniIterator.OfInt
    {
  ...
  public static abstract class Unchecked extends IntArrSeq
  {
    ...
    boolean uncheckedRemoveIf(int size,final IntPredicate filter)
    {
      int srcOffset;
      srcOffset=0;
      while(!filter.test((int)arr[srcOffset]))
      {
        if(++srcOffset==size)
        {
          return false;
  ...
  public static class UncheckedList extends Unchecked implements OmniList.OfInt
  {
    ...
    private static class SubList extends AbstractIntList implements OmniList.OfInt
    {
      ...
      public void replaceAll(final IntUnaryOperator operator)
      {
        ...
        {
          final int rootOffset;
          IntArrSeq.uncheckedreplaceAll(root.arr,rootOffset=this.rootOffset,rootOffset+size,operator);
        }
      }
      @Override
      public void reverseSort()
      ...
      public void replaceAll(final UnaryOperator<Integer> operator)
      {
        ...
        {
          final int rootOffset;
          IntArrSeq.uncheckedreplaceAll(root.arr,rootOffset=this.rootOffset,rootOffset+size,operator::apply);
        }
      }
      @Override
      public void sort(final Comparator<? super Integer> sorter)
      ...
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedcontains(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedindexOf(int size,int val)
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedindexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedlastIndexOf(int size,int val)
      { 
        final int rootOffset;
        return IntArrSeq.uncheckedlastIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private boolean uncheckedRemoveIf(int size,final IntPredicate filter)
      {
        final Unchecked root;
        ...
        this.size=size-(size=((IntArrSeq)root).finalizeSubListBatchRemove(arr,pullSurvivorsDown(arr,srcOffset,srcBound-1,filter),srcBound));
        bubbleUpDecrementSize(parent,size);
        return true;
      }
  ...
  public static class UncheckedStack extends Unchecked implements OmniStack.OfInt
  {
    ...
    public UncheckedStack(final int size,final int[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    private static class UncheckedDescendingItr extends AbstractIntItr implements OmniIterator.OfInt
    {
