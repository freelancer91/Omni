...
public abstract class DoubleArrSeq implements OmniCollection.OfDouble,Cloneable,Externalizable
{
  ...
  private static void pullSurvivorsDown(double[] arr,int srcOffset,int dstOffset,int dstBound,long word)
  {
  ...
  private static void pullSurvivorsDown(double[] arr,int srcOffset,int dstOffset,int dstBound,long[] survivorSet)
  {
