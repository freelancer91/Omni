...
public abstract class CharArrSeq implements OmniCollection.OfChar,Cloneable,Externalizable
{
  ...
  private static void pullSurvivorsDown(char[] arr,int srcOffset,int dstOffset,int dstBound,long word)
  {
  ...
  private static void pullSurvivorsDown(char[] arr,int srcOffset,int dstOffset,int dstBound,long[] survivorSet)
  {
