...
public abstract class CharArrSeq extends AbstractCharList implements OmniCollection.OfChar
{
  ...
  static boolean uncheckedcontains(char[] arr,int offset,int bound,int val)
  {
    for(;val!=(arr[offset]);)
    {
      if(++offset==bound)
  ...
  private static int uncheckedindexOf(char[] arr,int offset,int bound,int val)
  {
    int index;
  ...
  private static int uncheckedindexOf(char[] arr,int bound,int val)
  {
    int index;
  ...
  private static int uncheckedlastIndexOf(char[] arr,int offset,int bound,int val)
  {
    for(;val!=(arr[--bound]);)
    {
      if(bound==offset)
  ...
  private static int uncheckedlastIndexOf(char[] arr,int bound,int val)
  {
    for(;val!=(arr[--bound]);)
    {
      if(bound==0)
  ...
  private static int uncheckedsearch(char[] arr,int bound,int val)
  {
    int index;
  ...
  private static  void uncheckedreplaceAll(char[] arr,int offset,int bound,CharUnaryOperator operator)
  {
    do
    {
  ...
  static  void uncheckedForwardForEach(char[] arr,int offset,int bound,CharConsumer action)
  {
    do
    {
  ...
  static  void uncheckedReverseForEach(char[] arr,int offset,int bound,CharConsumer action)
  {
    do
    {
  ...
  private static int forwardHashCode(char[] arr,int offset,int bound)
  {
  ...
  private static int reverseHashCode(char[] arr,int offset,int bound)
  {
    int hash=31+(arr[offset]);
    while(bound!=offset)
    {
  ...
  private static void forwardToString(char[] arr,int offset,int bound,StringBuilder builder)
  {
    for(builder.append(arr[offset]);++offset!=bound;builder.append(',').append(' ').append(arr[offset]));
  }
  private static void reverseToString(char[] arr,int offset,int bound,StringBuilder builder)
  {
    for(builder.append(arr[--bound]);bound!=offset;builder.append(',').append(' ').append(arr[--bound]));
  }
  static  int pullSurvivorsUp(char[] arr,int srcBegin,int srcEnd,CharPredicate filter)
  {
    int dstOffset=srcBegin;
    while(srcBegin!=srcEnd)
    {
      final char v;
      if(!filter.test((char)(v=arr[--srcBegin])))
      {
        arr[dstOffset--]=v;
      }
    }
  ...
  static  int pullSurvivorsDown(char[] arr,int srcBegin,int srcEnd,CharPredicate filter)
  {
    int dstOffset=srcBegin;
    while(srcBegin!=srcEnd)
    {
  ...
  static  int markSurvivorsAndPullUp(CheckedCollection.AbstractModCountChecker modCountChecker,char[] arr,int srcOffset,int srcBound,CharPredicate filter)
  {
  ...
  static  int markSurvivorsAndPullDown(CheckedCollection.AbstractModCountChecker modCountChecker,char[] arr,int srcOffset,int srcBound,CharPredicate filter)
  {
    int dstOffset=srcOffset;
    for(;;)
    {
  ...
  static  int markSurvivorsReverse(char[] arr,long[] survivorSet,int offset,int bound,CharPredicate filter)
  {
    for(int numSurvivors=0,wordOffset=survivorSet.length-1;;)
    {
      ...
      do
      {
        if(!filter.test((char)arr[offset]))
        {
          ++numSurvivors;
          word|=marker;
        }
  ...
  static  int markSurvivors(char[] arr,long[] survivorSet,int offset,int bound,CharPredicate filter)
  {
  ...
  static int pullSurvivorsUp(char[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors)
  {
  ...
  static int pullSurvivorsDown(char[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors)
  {
  ...
  public boolean contains(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      {
        return CharArrSeq.uncheckedcontains(arr,0,size,(char)(val));
      }
    }
    return false;
  }
  public int indexOf(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return CharArrSeq.uncheckedindexOf(arr,size,(char)(val));
      }
    }
    return -1;
  }
  public int lastIndexOf(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return CharArrSeq.uncheckedlastIndexOf(arr,size,(char)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return CharArrSeq.uncheckedsearch(arr,size,(char)(val));
      }
    }
    return -1;
  }
  ...
  public boolean contains(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return CharArrSeq.uncheckedcontains(arr,0,size,TypeUtil.castToChar(val));
    }
    return false;
  }
  @Override
  public boolean contains(final int val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val==(char)val)
      {
        return CharArrSeq.uncheckedcontains(arr,0,size,(val));
      }
    }
    return false;
  }
  ...
  public boolean contains(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(char)val))
      {
        return CharArrSeq.uncheckedcontains(arr,0,size,v);
      }
    }
    return false;
  }
  ...
  @Override
  public boolean removeIf(final Predicate<? super Character> filter)
  {
    final int size;
    if((size=this.size)!=0)
    {
  ...
  public int indexOf(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return CharArrSeq.uncheckedindexOf(arr,size,TypeUtil.castToChar(val));
    }
    return -1;
  }
  public int indexOf(final int val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val==(char)val)
      {
        return CharArrSeq.uncheckedindexOf(arr,size,(val));
      }
    }
    return -1;
  }
  public int indexOf(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(char)val))
      {
        return CharArrSeq.uncheckedindexOf(arr,size,v);
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return CharArrSeq.uncheckedlastIndexOf(arr,size,TypeUtil.castToChar(val));
    }
    return -1;
  }
  public int lastIndexOf(final int val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val==(char)val)
      {
        return CharArrSeq.uncheckedlastIndexOf(arr,size,(val));
      }
    }
    return -1;
  }
  public int lastIndexOf(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(char)val))
      {
        return CharArrSeq.uncheckedlastIndexOf(arr,size,v);
      }
    }
    return -1;
  }
  ...
  abstract void uncheckedCopyInto(final Character[] dst,final int length);
  ...
  public int search(final boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return CharArrSeq.uncheckedsearch(arr,size,TypeUtil.castToChar(val));
    }
    return -1;
  }
  public int search(final int val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val==(char)val)
      {
        return CharArrSeq.uncheckedsearch(arr,size,(val));
      }
    }
    return -1;
  }
  public int search(final long val)
  {
    ...
    if((size=this.size)!=0)
    {
      ...
      if(val==(v=(char)val))
      {
        return CharArrSeq.uncheckedsearch(arr,size,v);
      }
    }
    return -1;
  }
  ...
  public static abstract class Checked extends CharArrSeq
  {
    ...
    private Checked(final int size,final char[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    @Override
    boolean uncheckedRemoveIf(int size,final CharPredicate filter)
    {
      int srcOffset;
  ...
  public static class CheckedList extends Checked implements OmniList.OfChar
  {
    public CheckedList()
    {
      super();
    ...
    public CheckedList(final int size,final char[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    @Override
    public OmniListIterator.OfChar listIterator(final int index)
    {
      CheckedCollection.checkLo(index);
    ...
    public void replaceAll(final CharUnaryOperator operator)
    {
      ...
      if(0!=((size=this.size)))
      {
        ...
        try
        {
          CharArrSeq.uncheckedreplaceAll(arr,0,size,operator);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    @Override
    public void sort(final CharComparator sorter)
    {
      final int size;
      if(1<((size=this.size)))
      {
        ...
        try
        {
          CharSortUtil.uncheckedcomparatorSort(arr,0,size-1,sorter);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    @Override
    public void replaceAll(final UnaryOperator<Character> operator)
    {
      final int size;
      if(0!=((size=this.size)))
      {
        ...
        try
        {
          CharArrSeq.uncheckedreplaceAll(arr,0,size,operator::apply);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    @Override
    public void sort(final Comparator<? super Character> sorter)
    {
      final int size;
      if(1<((size=this.size)))
      {
        ...
        try
        {
          CharSortUtil.uncheckedcomparatorSort(arr,0,size-1,sorter::compare);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    public void reverseSort()
    {
      ...
      if((size=this.size)>1)
      {
         CharSortUtil.uncheckedreverseSort(arr,0,size-1);
         ++this.modCount;
      }
    }
    public void sort()
    {
      ...
      if((size=this.size)>1)
      {
         CharSortUtil.uncheckedsort(arr,0,size-1);
         ++this.modCount;
      }
    }
    @Override
    public OmniList.OfChar subList(final int fromIndex,final int toIndex)
    {
    ...
    @Override
    void uncheckedCopyInto(final Character[] arr,final int size)
    {
      ArrCopy.uncheckedCopy(this.arr,0,arr,0,size);
    }
    @Override
    ...
    @Override
    void uncheckedForEach(final int size,final CharConsumer action)
    {
      int modCount=this.modCount;
      try
      {
    ...
    private static class BidirectionalItr implements OmniListIterator.OfChar
    {
      ...
      public void add(final char val)
      {
        ...
        {
          ((CharArrSeq)root).uncheckedInsert(cursor,val,rootSize);
        }
        else
        {
      ...
      @Override
      public void set(final char val)
      {
        final int lastRet;
        if((lastRet=this.lastRet)!=-1)
        {
    ...
    private static class SubList extends AbstractCharList implements OmniList.OfChar
    {
      ...
      public boolean add(final char val)
      {
        ...
        if((rootSize=root.size)!=0)
        {
          ((CharArrSeq)root).uncheckedInsert(rootOffset+size,val,rootSize);
        }
        else
        {
          ((CharArrSeq)root).uncheckedInit(val);
      ...
      public void add(final int index,final char val)
      {
        ...
        if((rootSize=root.size)!=0)
        {
          ((CharArrSeq)root).uncheckedInsert(rootOffset+index,val,rootSize);
        }
        else
        {
          ((CharArrSeq)root).uncheckedInit(val);
      ...
      public boolean contains(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedcontains(size,TypeUtil.castToChar(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return false;
      }
      ...
      public int indexOf(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedindexOf(size,TypeUtil.castToChar(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return -1;
      }
      ...
      public int lastIndexOf(final boolean val)
      {
        ...
        if((size=this.size)!=0)
        {
          return this.uncheckedlastIndexOf(size,TypeUtil.castToChar(val));
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return -1;
      }
      ...
      public char removeCharAt(int index)
      {
        ...
        CheckedCollection.checkReadHi(index,size=this.size);
        final char[] arr;
        final var removed=(char)(arr=root.arr)[index+=rootOffset];
      ...
      public void sort(final CharComparator sorter)
      {
        ...
        if(1<(size=this.size))
        {
          ...
          try
          {
            final int rootOffset;CharSortUtil.uncheckedcomparatorSort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1,sorter);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      public void reverseSort()
      {
        ...
        {
          final int rootOffset;
          CharSortUtil.uncheckedreverseSort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1);
              root.modCount=++modCount;
              bubbleUpIncrementModCount(parent);
              this.modCount=modCount;
        }
      ...
      public void sort()
      {
        ...
        {
          final int rootOffset;
          CharSortUtil.uncheckedsort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1);
              root.modCount=++modCount;
              bubbleUpIncrementModCount(parent);
              this.modCount=modCount;
        }
      ...
      public void sort(final Comparator<? super Character> sorter)
      {
        ...
        if(1<(size=this.size))
        {
          ...
          try
          {
            final int rootOffset;CharSortUtil.uncheckedcomparatorSort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1,sorter::compare);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      @Override
      public char set(int index,final char val)
      {
        final var root=checkModCountAndGetRoot();
        CheckedCollection.checkLo(index);
        CheckedCollection.checkReadHi(index,this.size);
      ...
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedcontains(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedindexOf(final int size,final int val)
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedindexOf(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedlastIndexOf(final int size,final int val)
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedlastIndexOf(checkModCountAndGetRoot().arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      ...
      private boolean uncheckedRemoveIf(int size,final CharPredicate filter)
      {
        ...
        try
        {
          ...
          root.modCount=++modCount;
          this.modCount=modCount;
          this.size=size-(size=((CharArrSeq)root).finalizeSubListBatchRemove(arr,dstOffset,srcBound));
          bubbleUpDecrementSize(parent,size);
        }
        catch(final RuntimeException e)
        {
  ...
  public static class CheckedStack extends Checked implements OmniStack.OfChar
  {
    public CheckedStack()
    {
      super();
    ...
    public CheckedStack(final int size,final char[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    public OmniIterator.OfChar iterator()
    {
      return new CheckedDescendingItr(this);
        ...
        public char pollChar()
        {
          ...
          {
            ++modCount;
            return (char)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return Character.MIN_VALUE;
        }
        @Override
        public Character poll()
        {
          ...
          {
            ++modCount;
            return (Character)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return null;
        }
        @Override
        public double pollDouble()
        {
          ...
          {
            ++modCount;
            return (double)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return Double.NaN;
        }
        @Override
        public float pollFloat()
        {
          ...
          {
            ++modCount;
            return (float)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return Float.NaN;
        }
        @Override
        public long pollLong()
        {
          ...
          {
            ++modCount;
            return (long)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return Long.MIN_VALUE;
        }
        @Override
        public int pollInt()
        {
          ...
          {
            ++modCount;
            return (int)(((CharArrSeq)this).uncheckedPop(size-1));
          }
          return Integer.MIN_VALUE;
        }
    @Override
    ...
    private static class CheckedDescendingItr extends AbstractCharItr implements OmniIterator.OfChar
    {
  ...
  public static abstract class Unchecked extends CharArrSeq
  {
    ...
    boolean uncheckedRemoveIf(int size,final CharPredicate filter)
    {
      int srcOffset;
      srcOffset=0;
      while(!filter.test((char)arr[srcOffset]))
      {
        if(++srcOffset==size)
        {
          return false;
  ...
  public static class UncheckedList extends Unchecked implements OmniList.OfChar
  {
    ...
    private static class SubList extends AbstractCharList implements OmniList.OfChar
    {
      ...
      public void replaceAll(final CharUnaryOperator operator)
      {
        ...
        {
          final int rootOffset;
          CharArrSeq.uncheckedreplaceAll(root.arr,rootOffset=this.rootOffset,rootOffset+size,operator);
        }
      }
      @Override
      public void reverseSort()
      ...
      public void sort(final CharComparator sorter)
      {
        ...
        {
          final int rootOffset;
          CharSortUtil.uncheckedcomparatorSort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1,sorter);
        }
      }
      @Override
      public void replaceAll(final UnaryOperator<Character> operator)
      {
        ...
        {
          final int rootOffset;
          CharArrSeq.uncheckedreplaceAll(root.arr,rootOffset=this.rootOffset,rootOffset+size,operator::apply);
        }
      }
      @Override
      public void sort(final Comparator<? super Character> sorter)
      {
        ...
        {
          final int rootOffset;
          CharSortUtil.uncheckedcomparatorSort(root.arr,rootOffset=this.rootOffset,rootOffset+size-1,sorter::compare);
        }
      }
      @Override
      public boolean removeIf(final Predicate<? super Character> filter)
      ...
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedcontains(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedindexOf(int size,int val)
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedindexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private int uncheckedlastIndexOf(int size,int val)
      { 
        final int rootOffset;
        return CharArrSeq.uncheckedlastIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,val);
      }
      private boolean uncheckedRemoveIf(int size,final CharPredicate filter)
      {
        final Unchecked root;
        ...
        this.size=size-(size=((CharArrSeq)root).finalizeSubListBatchRemove(arr,pullSurvivorsDown(arr,srcOffset,srcBound-1,filter),srcBound));
        bubbleUpDecrementSize(parent,size);
        return true;
      }
  ...
  public static class UncheckedStack extends Unchecked implements OmniStack.OfChar
  {
    ...
    public UncheckedStack(final int size,final char[] arr)
    {
      super(size,arr);
    }
    @Override
    ...
    private static class UncheckedDescendingItr extends AbstractCharItr implements OmniIterator.OfChar
    {
