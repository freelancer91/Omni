...
public class RefArrDeq<E> implements OmniDeque.OfRef<E>,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked<E> extends RefArrDeq<E>{
    ...
    private static class BigCollapseData<E> extends CollapseData<E>{
      ...
      private void fragmentedPullSurvivorsUpToNonFragmented(Object[] arr,int dstOffset,int numToSkip,int dstBound){
      ...
      private void fragmentedPullSurvivorsUp(Object[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset,s;
        long[] survivorSet;
        long word=(survivorSet=this.survivorSet)[wordOffset=numToSkip>>6]<<(-(numToSkip+1));
        int srcOffset=(s=dstOffset-1)-(((numToSkip)&63)+1);
    ...
    private static class AscendingItr<E> extends AbstractDeqItr<E>{
      ...
      @Override void uncheckedForEachRemaining(final int expectedCursor,Consumer<? super E> action){
        int modCount=this.modCount;
        final Checked<E> root;
