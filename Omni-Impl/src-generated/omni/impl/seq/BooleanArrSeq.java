...
AbstractBooleanArrSeq
 implements OmniCollection.OfBoolean,Externalizable,RandomAccess{
      ...
      implements BooleanListDefault,Cloneable,RandomAccess
  {
    ...
    private boolean isEqualTo(ListIterator<?> itr,int thisOffset,int thisBound){
      ...
      if(itr.hasNext() && (val=itr.next()) instanceof Boolean){
        for(final var arr=this.arr;(boolean)val==arr[thisOffset];){
          ...
          if(++thisOffset>=thisBound || !((val=itr.next()) instanceof Boolean)){
            break;
          }
        }
      }
    ...
    private boolean isEqualTo(int rootOffset,int size,OmniList.OfBoolean list){
      if(list instanceof AbstractBooleanArrSeq){
        ...
        return subList.size==size && SequenceEqualityUtil.isEqualTo(rootOffset,rootOffset+size,this.arr,subList.rootOffset,thatRoot.words);
      }else{
    ...
    private boolean isEqualTo(int size,OmniList.OfBoolean list){
      if(list instanceof AbstractBooleanArrSeq){
        ...
        if(abstractBooleanArrSeq instanceof BooleanArrSeq.UncheckedList){
           return this.isEqualToHelper(0,size,((BooleanArrSeq.UncheckedList)abstractBooleanArrSeq).arr,0);
        }else{
           //must be PackedBooleanArrSeq.UncheckedList
           return SequenceEqualityUtil.isEqualTo(0,((PackedBooleanArrSeq.UncheckedList)abstractBooleanArrSeq).words,size,this.arr,0);
        }
        ...
        final BooleanArrSeq.UncheckedSubList subList;
        final BooleanArrSeq.UncheckedList thatRoot;
        return (subList=(BooleanArrSeq.UncheckedSubList)list).size==size && ((thatRoot=subList.root)==this || this.isEqualToHelper(0,size,thatRoot.arr,subList.rootOffset));
       }else if(list instanceof BooleanArrSeq.CheckedSubList){
        final BooleanArrSeq.CheckedSubList subList;
        final BooleanArrSeq.CheckedList thatRoot;
        CheckedCollection.checkModCount((subList=(BooleanArrSeq.CheckedSubList)list).modCount,(thatRoot=subList.root).modCount);
        ...
        final PackedBooleanArrSeq.UncheckedSubList subList;
        return size==(subList=(PackedBooleanArrSeq.UncheckedSubList)list).size && SequenceEqualityUtil.isEqualTo(rootOffset=subList.rootOffset,subList.root.words,rootOffset+size,this.arr,0);
      }else{
        ...
        CheckedCollection.checkModCount((subList=(PackedBooleanArrSeq.CheckedSubList)list).modCount,(thatRoot=subList.root).modCount);
        final int rootOffset;
        return subList.size==size && SequenceEqualityUtil.isEqualTo(rootOffset=subList.rootOffset,thatRoot.words,rootOffset+size,this.arr,0);
      }
    }
      ...
      extends UncheckedList
  {
    ...
    private boolean isEqualTo(int rootOffset,int size,OmniList.OfBoolean list){
      if(list instanceof AbstractBooleanArrSeq){
        ...
        final PackedBooleanArrSeq.UncheckedSubList subList;
        return (subList=(PackedBooleanArrSeq.UncheckedSubList)list).size == size && SequenceEqualityUtil.isEqualTo(rootOffset,rootOffset+size,this.arr,subList.rootOffset,subList.root.words);
      }else{
        //must be BooleanDblLnkSeq
        final BooleanDblLnkSeq dls;
        if((dls=(BooleanDblLnkSeq)list) instanceof BooleanDblLnkSeq.CheckedSubList){
    ...
    private boolean isEqualTo(int size,OmniList.OfBoolean list){
      if(list instanceof AbstractBooleanArrSeq){
        ...
        if(abstractBooleanArrSeq instanceof BooleanArrSeq.UncheckedList){
           return super.isEqualToHelper(0,size,((BooleanArrSeq.UncheckedList)abstractBooleanArrSeq).arr,0);
        }else{
           //must be PackedBooleanArrSeq.UncheckedList
           return SequenceEqualityUtil.isEqualTo(0,((PackedBooleanArrSeq.UncheckedList)abstractBooleanArrSeq).words,size,this.arr,0);
        }
        ...
        final BooleanArrSeq.UncheckedSubList subList;
        return size==(subList=(BooleanArrSeq.UncheckedSubList)list).size&&super.isEqualToHelper(0,size,subList.root.arr,subList.rootOffset);
      }else if(list instanceof PackedBooleanArrSeq.UncheckedSubList){
        final int rootOffset;
        final PackedBooleanArrSeq.UncheckedSubList subList;
        return (subList=(PackedBooleanArrSeq.UncheckedSubList)list).size==size && SequenceEqualityUtil.isEqualTo(rootOffset=subList.rootOffset,subList.root.words,rootOffset+size,this.arr,0);
      }else{
        //must be PackedBooleanArrSeq.CheckedSubList
        final PackedBooleanArrSeq.CheckedSubList subList;
        final PackedBooleanArrSeq.CheckedList thatRoot;
        CheckedCollection.checkModCount((subList=(PackedBooleanArrSeq.CheckedSubList)list).modCount,(thatRoot=subList.root).modCount);
        final int rootOffset;
        return size==subList.size && SequenceEqualityUtil.isEqualTo(rootOffset=subList.rootOffset,thatRoot.words,rootOffset+size,this.arr,0);
      }
    }
    @Override public boolean equals(Object val){
      if(val==this){
