...
public class IntArrDeq implements OmniDeque.OfInt,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends IntArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void fragmentedPullSurvivorsDownToNonFragmented(int[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void fragmentedPullSurvivorsDown(int[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    ...
    private static abstract class CollapseData{
      ...
      abstract void nonfragmentedPullSurvivorsUp(int[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void nonfragmentedPullSurvivorsDown(int[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDownToNonFragmented(int[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDown(int[] arr,int dstOffset,int numToSkip,int dstBound);
    }
