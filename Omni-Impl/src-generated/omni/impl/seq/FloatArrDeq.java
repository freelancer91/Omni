...
public class FloatArrDeq implements OmniDeque.OfFloat,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends FloatArrDeq{
    ...
    private static abstract class CollapseData{
      ...
      abstract void pullDownMarkRangeSpansSplit(float[] arr,int srcOffset,int dstOffset,int dstBound);
      abstract void pullDownMarkRangeSpansSplitDstBoundGoesBoundSplit(float[] arr,int srcOffset,int dstOffset,int dstBound);
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void pullDownMarkRangeSpansSplit(float[] arr,int srcOffset,int dstOffset,int dstBound){
        throw new UnsupportedOperationException();
      }
      @Override void pullDownMarkRangeSpansSplitDstBoundGoesBoundSplit(float[] arr,int srcOffset,int dstOffset,int dstBound){
        throw new UnsupportedOperationException();
      }
    }
