...
public class ShortArrDeque implements OmniDeque.OfShort
{
  transient short[] arr;
  transient int head;
  transient int tail;
  public ShortArrDeque()
  {
    this.tail=-1;
    this.arr=OmniArray.OfShort.DEFAULT_ARR;
  }
  public ShortArrDeque(int capacity)
  {
    this.tail=-1;
    switch(capacity)
    {
  ...
  public ShortArrDeque(int head,int tail,short[] arr)
  {
    this.head=head;
    this.tail=tail;
    this.arr=arr;
  ...
  public Object clone()
  {
    ...
    if((tail=this.tail+1)!=0)
    {
      ...
      {
        ArrCopy.uncheckedCopy(arr,head,newArr=new short[size+=arr.length],0,head);
        ArrCopy.uncheckedCopy(arr,0,newArr,head,tail);
      }
      else
      {
        ArrCopy.uncheckedCopy(arr,head,newArr=new short[size],0,size);
      }
      return new ShortArrDeque(0,size-1,newArr);
    }
    return new ShortArrDeque();
  }
  @Override
    ...
    if((tail=this.tail)!=-1)
    {
      ...
      switch(Integer.signum((++tail)-(head=this.head)))
      {
        case 0:
          ...
          final short[] newArr;
          ArrCopy.uncheckedCopy(arr,0,newArr=new short[newArrSize=OmniArray.growBy50Pct(oldArrSize=arr.length)],0,tail);
      ...
      switch(Integer.signum((++tail)-(head=this.head)))
      {
        ...
        default:
          if(--head==-1)
          {
            ...
            {
              ArrCopy.uncheckedCopy(arr,0,arr=new short[arrLength=OmniArray.growBy50Pct(tail)],arrLength-=tail,tail);
              this.arr=arr;
            }
            head=arrLength-1;
          }
  ...
  public short pollLastShort()
  {
    ...
    {
      short[] arr;
      final var ret=(short)((arr=this.arr)[tail]);
  ...
  public short pollShort()
  {
    ...
    if((tail=this.tail)!=-1)
    {
      int head;
      short[] arr;
      final var ret=(short)((arr=this.arr)[head=this.head]);
  ...
  @Override
  public boolean offerLast(final short val)
  {
    addLast((val));
    return true;
  }
  @Override
  public boolean offerFirst(final short val)
  {
    push((val));
    return true;
  }
  @Override
  public boolean offer(final short val)
  {
    addLast((val));
    return true;
  }
  @Override
  public void addFirst(final Short val)
  {
    push((short)(val));
  }
  @Override
  ...
  private void initialize(short val)
  {
    short[] arr;
  ...
  private short uncheckedExtractFirst(int tail)
  {
    short[] arr;
    int head;
  ...
  private short uncheckedExtractLast(int tail)
  {
    short[] arr;
  ...
  {
    return (Short)getLastShort();
  }
  @Override
  public Short removeLast()
  {
    return (Short)removeLastShort();
  }
  @Override
  public Short pop()
  {
  ...
  private static class DescendingItr
    ...
    implements OmniIterator.OfShort
  {
    transient final ShortArrDeque root;
    transient int nextIndex;
    DescendingItr(ShortArrDeque root)
    {
      this.root=root;
    ...
    public short nextShort()
    {
      final short[] arr;
      int index;
      final short ret=(short)(arr=root.arr)[index=this.nextIndex];
      if(--index==-1)
      {
        index=arr.length-1;
      }
    ...
    public void forEachRemaining(ShortConsumer action)
    {
      ...
      {
        ShortArrSeq.uncheckedReverseForEach(root.arr,head,index,action);
        this.nextIndex=head-1;
      }
      else if(index<=(tail=root.tail) && tail<head)
      {
        short[] arr;
        ShortArrSeq.uncheckedReverseForEach(arr=root.arr,0,index,action);
        ShortArrSeq.uncheckedReverseForEach(arr,head,arr.length,action);
        this.nextIndex=head-1;
      }
    }
    @Override
    public void forEachRemaining(Consumer<? super Short> action)
    {
      ...
      if((index=this.nextIndex+1)>(head=(root=this.root).head))
      {
        ShortArrSeq.uncheckedReverseForEach(root.arr,head,index,action::accept);
        this.nextIndex=head-1;
      }
      else if(index<=(tail=root.tail) && tail<head)
      {
        short[] arr;
        ShortArrSeq.uncheckedReverseForEach(arr=root.arr,0,index,action::accept);
        ShortArrSeq.uncheckedReverseForEach(arr,head,arr.length,action::accept);
        this.nextIndex=head-1;
      }
    }
    @Override
    ...
    implements OmniIterator.OfShort
  {
    transient final ShortArrDeque root;
    transient int nextIndex;
    AscendingItr(ShortArrDeque root)
    {
      this.root=root;
    ...
    public void forEachRemaining(ShortConsumer action)
    {
      ...
      {
        ShortArrSeq.uncheckedForwardForEach(root.arr,index,tail,action);
        this.nextIndex=tail;
      }
      else if(index>=(head=root.head) && tail<=head)
      {
        final short[] arr;
        ShortArrSeq.uncheckedForwardForEach(arr=root.arr,index,arr.length,action);
        ShortArrSeq.uncheckedForwardForEach(arr,0,tail,action);
        this.nextIndex=tail; 
      }
    }
    @Override
    public void forEachRemaining(Consumer<? super Short> action)
    {
      ...
      if((index=this.nextIndex)<(tail=(root=this.root).tail+1))
      {
        ShortArrSeq.uncheckedForwardForEach(root.arr,index,tail,action::accept);
        this.nextIndex=tail;
      }
      else if(index>=(head=root.head) && tail<=head)
      {
        final short[] arr;
        ShortArrSeq.uncheckedForwardForEach(arr=root.arr,index,arr.length,action::accept);
        ShortArrSeq.uncheckedForwardForEach(arr,0,tail,action::accept);
        this.nextIndex=tail; 
      }
    }
    @Override
  ...
  public boolean contains(final Object val)
  {
    ...
    if((tail=this.tail)!=-1)
    {
      ...
      {
        return uncheckedcontains(tail,(short)(val));
      }
    }
    return false;
  }
  ...
  public int search(final Object val)
  {
    ...
    if((tail=this.tail)!=-1)
    {
      if(val instanceof Short)
      {
        return uncheckedsearch(tail,(short)(val));
      }
    }
    return -1;
  }
  ...
  public boolean remove(final Object val)
  {
    ...
    if((tail=this.tail)!=-1)
    {
      if(val instanceof Short)
      {
        return uncheckedremoveVal(tail,(short)(val));
      }
    }
    return false;
  }
  ...
  public static class Checked extends ShortArrDeque
  {
    ...
    public Checked(int head,int tail,short[] arr)
    {
      super(head,tail,arr);
    }
    @Override
    ...
    private void collapseheadNonFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      int dstOffset;
      for(;;)
      {
        ...
        {
          dstOffset=ShortArrSeq.markSurvivorsAndPullUp(new ModCountChecker(modCount),arr,tail,head,filter);
          break;
        }
      }
    ...
    private void collapsetailNonFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      int dstOffset;
      for(;;)
      {
        ...
        {
          dstOffset=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,head,tail,filter);
          break;
        }
      }
    ...
    private void collapseheadFragmentedHelper(int modCount,short[] arr,int tail,ShortPredicate filter)
    {
      for(;;)
      {
        if(tail==0)
      ...
      this.head=(tail=ShortArrSeq.markSurvivorsAndPullUp(new ModCountChecker(modCount),arr,tail,-1,filter))+1;
    }
    private void collapsetailFragmentedHelper(int modCount,short[] arr,int head,ShortPredicate filter)
    {
      ...
      this.tail=(head=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,head,bound,filter))-1;
    }
    private void collapseheadFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
    ...
    private void collapsetailFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      for(;;)
      {
        if(tail==0)
    ...
    private void collapseheadFragmentedHelper(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      for(int headOffset=arr.length-1;headOffset!=head;--headOffset)
      {
        if(filter.test((short)arr[headOffset]))
        {
          ...
          this.head=headOffset=ShortArrSeq.markSurvivorsAndPullUp(new ModCountChecker(modCount),arr,headOffset,head,filter);
      ...
      for(int tailOffset=0;tailOffset!=tail;++tailOffset)
      {
        if(filter.test((short)arr[tailOffset]))
        {
          this.tail=tailOffset=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,tailOffset,tail,filter);
          arr[tailOffset]=arr[tail];
          return;
        }
      }
    }
    private void collapsetailFragmentedHelper(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      for(int tailOffset=0;tailOffset!=tail;++tailOffset)
      {
        if(filter.test((short)arr[tailOffset]))
    ...
    private void collapseheadandtailFragmentedHelper(int modCount,short[] arr,int head,int tail,int headOffset,int tailOffset,ShortPredicate filter)
    {
      ...
      outer:for(;;)
      {
        if(++tailOffset==tail)
        {
          headDstOffset=ShortArrSeq.markSurvivorsAndPullUp(new ModCountChecker(modCount),arr,headOffset,head,filter);
          break;
        }
        final short tailVal;
        if(!filter.test((short)(tailVal=arr[tailOffset])))
        {
          ...
          for(;;)
          {
            if(--headOffset==head)
            {
              ...
              if((numTailSurvivors=tail-++tailOffset)!=0)
              {
                ...
                {
                  tailDstOffset=ShortArrSeq.pullSurvivorsDown(arr,survivors,tailDstOffset,tailOffset,numTailSurvivors);
                }
              }
              else
              {
            ...
            final short headVal;
            if(!filter.test((short)(headVal=arr[headOffset])))
            {
              int numHeadSurvivors,numTailSurvivors;
              if((numHeadSurvivors=(--headOffset)-head)+(numTailSurvivors=tail-++tailOffset)!=0)
              {
                final long[] survivors;
                numTailSurvivors=ShortArrSeq.markSurvivors(arr,survivors=new long[((numTailSurvivors-1)>>>6)+((numHeadSurvivors-1)>>>6)+2],tailOffset,tail,filter);
                numHeadSurvivors=ShortArrSeq.markSurvivorsReverse(arr,survivors,headOffset,head,filter);
                CheckedCollection.checkModCount(modCount,this.modCount);
                arr[headDstOffset--]=headVal;
                if(numHeadSurvivors!=0)
                {
                  headDstOffset=ShortArrSeq.pullSurvivorsUp(arr,survivors,headDstOffset,headOffset,numHeadSurvivors);
                }
                arr[tailDstOffset++]=tailVal;
                if(numTailSurvivors!=0)
                {
    ...
    private boolean collapsebodyFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      for(int tailOffset=0;tailOffset!=tail;++tailOffset)
      {
        if(filter.test((short)arr[tailOffset]))
        {
          ...
          arr[tailOffset=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,head,tail,filter)]=arr[tail];
          this.modCount=modCount+1;
    ...
    private void collapseheadandtailFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      outer:for(;;)
      {
        if(tail==0)
        {
          ...
          else if(filter.test((short)arr[tail=arr.length-1]))
          {
        ...
        final short tailVal;
        if(!filter.test((short)(tailVal=arr[--tail])))
        {
          inner: for(int bound=arr.length-1;;)
          {
            if(head==bound)
            {
              ...
              {
                if(filter.test((short)arr[head=0]))
                {
                  collapseheadNonFragmented(modCount,arr,head,tail,filter);
                  this.tail=tail;
                  return;
                ...
                else
                {
                  for(;;)
                  {
                    ...
                    if(filter.test((short)arr[head]))
                    {
                      arr[tail=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,head,tail,filter)]=tailVal;
                      break;
                    }
                  }
                }
            ...
            final short headVal;
            if(!filter.test((short)(headVal=arr[++head])))
            {
              for(int tailOffset=0;tailOffset!=tail;++tailOffset)
              {
                if(filter.test((short)arr[tailOffset]))
                {
                  ...
                  arr[tail=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,tailOffset,tail,filter)]=tailVal;
                  break inner;
                }
              }
              for(int headOffset=bound;headOffset!=head;--headOffset)
              {
                if(filter.test((short)arr[headOffset]))
                {
                  arr[head=ShortArrSeq.markSurvivorsAndPullUp(new ModCountChecker(modCount),arr,headOffset,head,filter)]=headVal;
                  break inner;
                }
              }
              CheckedCollection.checkModCount(modCount,this.modCount);
    ...
    private void collapseheadandtailNonFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      for(;;)
      {
        if(++head==tail)
    ...
    private boolean collapsebodyNonFragmented(int modCount,short[] arr,int head,int tail,ShortPredicate filter)
    {
      while(++head!=tail)
      {
        if(filter.test((short)arr[head]))
        {
          int dstOffset;
          this.tail=dstOffset=ShortArrSeq.markSurvivorsAndPullDown(new ModCountChecker(modCount),arr,head,tail,filter);
    ...
    private boolean uncheckedRemoveIf1(int tail,ShortPredicate filter)
    {
      int modCount=this.modCount;
      try
      {
    ...
    private boolean uncheckedRemoveIfFragmented(int head,int tail,ShortPredicate filter)
    {
      int modCount=this.modCount;
      try
      {
  ...
  private void collapseheadNonFragmented(short[] arr,int head,int tail,
  ShortPredicate filter)
  {
    while(++head!=tail)
    {
      final short v;
      if(!filter.test((short)(v=arr[head])))
      {
  ...
  private void collapsetailNonFragmented(short[] arr,int head,int tail,
  ShortPredicate filter)
  {
    while(--tail!=head)
    {
      final short v;
      if(!filter.test((short)(v=arr[tail])))
      {
  ...
  private void collapseheadFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    ...
    while(head!=bound)
    {
      if(!filter.test((short)arr[++head]))
      {
        for(int srcOffset=bound;srcOffset!=head;--srcOffset)
        {
          ...
          {
            arr[srcOffset=ShortArrSeq.pullSurvivorsUp(arr,srcOffset,head+1,filter)]=arr[head];
            this.head=srcOffset;
            break;
          }
        }
  ...
  private void collapsetailFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    while(tail!=0)
    {
      if(!filter.test((short)arr[--tail]))
      {
        for(int srcOffset=0;srcOffset!=tail;++srcOffset)
        {
          if(filter.test((short)arr[srcOffset]))
          {
            arr[srcOffset=ShortArrSeq.pullSurvivorsDown(arr,srcOffset,tail-1,filter)]=arr[tail];
            this.tail=srcOffset;
            break;
          }
        }
  ...
  private static  int pullDown(short[] arr,int srcOffset,int srcBound,ShortPredicate filter)
  {
    while(++srcOffset!=srcBound)
    {
      if(filter.test((short)arr[srcOffset]))
      {
        return ShortArrSeq.pullSurvivorsDown(arr,srcOffset,srcBound-1,filter);
      }
    }
    return srcOffset;
  }
  private static  int pullUp(short[] arr,int srcOffset,int srcBound,ShortPredicate filter)
  {
    while(--srcOffset!=srcBound)
    {
      if(filter.test((short)arr[srcOffset]))
      {
        return ShortArrSeq.pullSurvivorsUp(arr,srcOffset,srcBound+1,filter);
      }
    }
    return srcOffset;
  }
  private void collapseheadandtailFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    while(tail!=0)
    {
      if(!filter.test((short)arr[--tail]))
  ...
  private boolean collapsebodyFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    for(int srcOffset=0;srcOffset!=tail;++srcOffset)
    {
      if(filter.test((short)arr[srcOffset]))
  ...
  private void collapseheadandtailNonFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    while(++head!=tail)
    {
      if(!filter.test((short)arr[head]))
  ...
  private boolean collapsebodyNonFragmented(short[] arr,int head,int tail,ShortPredicate filter)
  {
    while(++head!=tail)
    {
      short v;
      if(filter.test((short)(v=arr[head])))
      {
        arr[head=ShortArrSeq.pullSurvivorsDown(arr,head,tail-1,filter)]=v;
        this.tail=head;
        return true;
      }
    }
  ...
  private boolean uncheckedcontains(int tail,int val)
  {
    ...
    {
      final short[] arr;
      return ShortArrSeq.uncheckedcontains(arr=this.arr,0,tail+1,val)
      || ShortArrSeq.uncheckedcontains(arr,head,arr.length,val);
    }
    return ShortArrSeq.uncheckedcontains(arr,head,tail+1,val);
  }
