...
public abstract class ByteDblLnkSeq extends AbstractByteList implements OmniList.OfByte
{
  ...
  private ByteDblLnkSeq(Node onlyNode)
  {
    super(1);
  ...
  @Override
  public final boolean add(final byte val)
  {
    addLast((byte)val);
    return true;
  }
  public final void addFirst(final byte val)
  {
    push((byte)val);
  }
  public final boolean offer(final byte val)
  {
    addLast((byte)val);
    return true;
  }
  public final boolean offerLast(final byte val)
  {
    addLast((byte)val);
    return true;
  }
  public final boolean offerFirst(final byte val)
  {
    push((byte)val);
    return true;
  }
  ...
  public final void addLast(final Byte val)
  {
    addLast((byte)val);
  }
  public final boolean offer(final Byte val)
  ...
  public final void push(final Byte val)
  {
    push((byte)val);
  }
  abstract void pushtailHelper(Node oldtail,byte val);
  ...
  abstract void pushheadHelper(Node oldhead,byte val);
  ...
  public final Byte peekFirst()
  {
    return peek();
  }
  public final Byte pollFirst()
  {
    return poll();
  }
  ...
  {
    this.size=0;
    ((ByteDblLnkSeq)this).privateInit(null);
  }
  @Override
  public boolean contains(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return ByteDblLnkSeq.uncheckedcontains(head,tail,TypeUtil.castToByte(val));
    }
    return false;
  }
  @Override
  public boolean contains(final int val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val==(byte)val)
      {
        return ByteDblLnkSeq.uncheckedcontains(head,tail,(val));
      }
    }
    return false;
  }
  ...
  public boolean contains(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(byte)val))
      {
        return ByteDblLnkSeq.uncheckedcontains(head,tail,v);
      }
    }
    return false;
  }
  ...
  public int indexOf(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return ByteDblLnkSeq.uncheckedindexOf(head,tail,TypeUtil.castToByte(val));
    }
    return -1;
  }
  @Override
  public int indexOf(final int val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val==(byte)val)
      {
        return ByteDblLnkSeq.uncheckedindexOf(head,tail,(val));
      }
    }
    return -1;
  }
  ...
  public int indexOf(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(byte)val))
      {
        return ByteDblLnkSeq.uncheckedindexOf(head,tail,v);
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final boolean val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      return ByteDblLnkSeq.uncheckedlastIndexOf(tail,size,TypeUtil.castToByte(val));
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final int val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val==(byte)val)
      {
        return ByteDblLnkSeq.uncheckedlastIndexOf(tail,size,(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final long val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      ...
      if(val==(v=(byte)val))
      {
        return ByteDblLnkSeq.uncheckedlastIndexOf(tail,size,v);
      }
    }
    return -1;
  }
  ...
  public int search(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return ByteDblLnkSeq.uncheckedsearch(head,TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int search(final int val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val==(byte)val)
      {
        return ByteDblLnkSeq.uncheckedsearch(head,(val));
      }
    }
    return -1;
  }
  public int search(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(byte)val))
      {
        return ByteDblLnkSeq.uncheckedsearch(head,v);
      }
    }
    return -1;
  }
  ...
  public boolean contains(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return ByteDblLnkSeq.uncheckedcontains(head,tail,(byte)(val));
      }
    }
    return false;
  }
  ...
  public int indexOf(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Byte)
      {
        return ByteDblLnkSeq.uncheckedindexOf(head,tail,(byte)(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final Object val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val instanceof Byte)
      {
        return ByteDblLnkSeq.uncheckedlastIndexOf(tail,size,(byte)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Byte)
      {
        return ByteDblLnkSeq.uncheckedsearch(head,(byte)(val));
      }
    }
    return -1;
  }
  ...
  public void forEach(final Consumer<? super Byte> action)
  {
    ...
    if((head=this.head)!=null)
    {
      head.uncheckedForEachForward(this.tail,(ByteConsumer)action::accept);
    }
  }
  @Override
  ...
  abstract void initHelper(byte val);
  @Override
  public int hashCode()
  {
    final Node head;
  ...
  private void uncheckedAddHelper(int headDist,int newSize,byte val)
  {
    this.size=newSize;
    if(headDist==0)
    {
  ...
  private void collapsehead(Node head,Node tail,BytePredicate filter)
  {
    int numRemoved;
    ...
    ((ByteDblLnkSeq)this).privatesethead(head);
    this.size-=numRemoved;
  }
   void collapsetail(Node head,Node tail,BytePredicate filter)
  {
    int numRemoved;
    ...
    ((ByteDblLnkSeq)this).privatesettail(tail);
    this.size-=numRemoved;
  }
  boolean collapseBody(Node head,Node tail,BytePredicate filter)
  {
    Node prev;
  ...
  void findNewHead(Node head,BytePredicate filter)
  {
    final Node tail;
  ...
  public static class Checked extends ByteDblLnkSeq implements OmniDeque.OfByte
  {
    ...
    private OmniList.OfByte getDefaultSubList(int headDist,int subListSize,int tailDist)
    {
    ...
    private OmniList.OfByte getEmptySubList(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
    ...
    private OmniList.OfByte getSubList1(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
      ...
      return new SubList.BodyList(this,null,((ByteDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
    }
    @Override
    void initHelper(byte val)
    {
      ++this.modCount;
      this.size=1;
    ...
    @Override
    void pushheadHelper(Node oldhead,byte val)
    {
      ++this.modCount;
      ++this.size;
      this.head=new Node(val,this.head);
    ...
    @Override
    void pushtailHelper(Node oldtail,byte val)
    {
      ++this.modCount;
      ++this.size;
      this.tail=new Node(this.tail,val);
    ...
    public byte popByte()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node head;
        ((ByteDblLnkSeq)this).privatechophead(head=this.head);
        return head.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public byte removeLastByte()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node tail;
        ((ByteDblLnkSeq)this).privatechoptail(tail=this.tail);
        return tail.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public byte pollByte()
    {
      ...
      if((head=this.head)!=null)
      {
        ++this.modCount;
        --this.size;
        ((ByteDblLnkSeq)this).privatechophead(head);
        return (byte)(head.val);
      }
      return Byte.MIN_VALUE;
    }
    ...
    public byte pollLastByte()
    {
      ...
      if((tail=this.tail)!=null)
      {
        ++this.modCount;
        --this.size;
        ((ByteDblLnkSeq)this).privatechoptail(tail);
        return (byte)(tail.val);
      }
      return Byte.MIN_VALUE;
    }
    ...
    private boolean uncheckedremoveVal(Node head,int val)
    {
      if(val!=(head.val))
      {
        ...
        if(head==tail)
        {
          ((ByteDblLnkSeq)this).privatesettail(lastVisited);
        }
        else
        {
    ...
    private boolean uncheckedremoveLastOccurrence(Node tail,int val)
    {
      if(val!=(tail.val))
      {
        ...
        if(tail==head)
        {
          ((ByteDblLnkSeq)this).privatesethead(lastVisited);
        }
        else
        {
    ...
    public boolean removeLastOccurrence(final boolean val)
    {
      ...
      if((tail=this.tail)!=null)
      {
        return this.uncheckedremoveLastOccurrence(tail,TypeUtil.castToByte(val));
      }
      return false;
    }
    @Override
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tail,BytePredicate filter)
    {
    ...
    private void collapsehead(int modCount,Node head,Node tail,BytePredicate filter)
    {
    ...
    private void collapsetail(int modCount,Node tail,Node head,BytePredicate filter)
    {
      int oldSize,numConsumed;
    ...
    private static class SubList extends ByteDblLnkSeq
    {
      private static class AscendingItr extends AbstractByteItr implements OmniIterator.OfByte
      {
        ...
        public void forEachRemaining(Consumer<? super Byte> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            ...
            try
            {
              cursor.uncheckedForEachForward(cursor=parent.tail,(ByteConsumer)action::accept);
            }
            finally
            {
              CheckedCollection.checkModCount(modCount,parent.root.modCount);
      ...
      public boolean removeVal(final char val)
      {
        ...
        return false;
            ...
            void findNewHead(int modCount,Node curr,BytePredicate filter)
            {
              ...
              ((ByteDblLnkSeq)root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      private void collapseHeadAndTail(int modCount,Node head,Node tail,BytePredicate filter)
      {
        ...
        for(;;)
        {
          ...
          if(!filter.test((head=head.next).val))
          {
            ...
            ((ByteDblLnkSeq)root).privatesethead(head);
            ((ByteDblLnkSeq)root).privatesettail(tail);
            break;
          }
        }
        root.modCount=modCount+1;
      ...
      private void prefixCollapsetail(int modCount,Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsetail(int modCount,Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void suffixCollapsehead(int modCount,Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(int modCount,Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      public void add(int index,byte val)
      {
        ...
        {
          Node newNode;
          ((ByteDblLnkSeq)root).privateInit(newNode=new Node(val));
      ...
      public byte removeByteAt(int index)
      {
        ...
        if(--size!=0)
        {
          ...
          {
            Node newHead;
            ((ByteDblLnkSeq)root).privatesethead(newHead=(node=this.head).next);
          ...
          else
          {
            ...
            {
              Node newTail;
              ((ByteDblLnkSeq)root).privatesettail(newTail=(node=this.tail).prev);
      ...
      private OmniList.OfByte getSubList1(Checked root,int headDist,int tailDist)
      {
        ...
        return new SubList.BodyList(root,this,((ByteDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
      }
      @Override
      public OmniIterator.OfByte iterator()
      {
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
          ++curr.modCount;curr.size=0;((ByteDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void bubbleUpclearBody(Node oldhead,Node oldtail,int numRemoved)
      {
        ...
        for(;;)
        {
          ++curr.modCount;
          curr.size=0;
          ((ByteDblLnkSeq)curr).privateInit(null);
          if((curr=curr.parent)==null)
          {
            return;
          }
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
          ++curr.modCount;curr.size=1;((ByteDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void clearPrefix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((ByteDblLnkSeq)root).privatesethead(newhead);
      ...
      private void clearSuffix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((ByteDblLnkSeq)root).privatesettail(newtail);
      ...
      private void uncheckedItrRemove(Node lastRet)
      {
        if(lastRet==tail)
        {
          ...
          else
          {
            ...
            ((ByteDblLnkSeq)root).privatesettail(lastRet);
          }
        }
        else
        {
          if(lastRet==head)
          {
            ...
            ((ByteDblLnkSeq)root).privatesethead(lastRet);
          }
          else
          {
            ((SubList)this).bubbleUpdecrementSize();
      ...
      void removeFirstHelper(int modCount,Node curr)
      {
        ...
        else
        {
          ...
          ((ByteDblLnkSeq)root).privatesethead(curr);
        }
        --root.size;
      }
      ...
      void initHelper(Checked root,byte val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
          ((ByteDblLnkSeq)curr).privateInit(newNode);
          if((curr=curr.parent)==null)
          {
            ((ByteDblLnkSeq)root).privateInit(newNode);
            return;
          }
        }
      }
      void prependHelper(byte val)
      {
        ++this.modCount;
        Node newNode;
      ...
      private void insertHelper(Node before,byte val,Node after)
      {
        ++this.modCount;
        new Node(before,val,after);
        SubList parent;
      ...
      private static class SuffixList extends SubList
      {
        ...
        void findNewHead(int modCount,Node curr,BytePredicate filter)
        {
          ...
          ((ByteDblLnkSeq)root).privatesettail(curr);
        }
      ...
      private static class BodyList extends PrefixList
      {
        ...
        {
          final Node newNode;
          ((ByteDblLnkSeq)this).privateInit(newNode=new Node(val));
          SubList parent,curr;
          ...
          ((ByteDblLnkSeq)root).subSeqInsertHelper(newNode,curr.getParentOffset());
        }
        private void bubbleUppushhead(Node oldhead,Node newNode)
        {
          SubList curr=this;
    ...
    private static class AscendingItr extends AbstractByteItr implements OmniIterator.OfByte
    {
      ...
      public void forEachRemaining(Consumer<? super Byte> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor=uncheckedForEach(cursor,root,(ByteConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((ByteDblLnkSeq)root).privatesethead(cursor);
        }
        else if(lastRet==root.tail)
        {
          ((ByteDblLnkSeq)root).privatechoptail(lastRet);
        }
        else
        {
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((ByteDblLnkSeq)root).privatechophead(lastRet);
        }
        else if(lastRet==root.tail)
        {
          ((ByteDblLnkSeq)root).privatesettail(cursor);
        }
        else
        {
    ...
    private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfByte
    {
      ...
      public void add(byte val)
      {
        ...
        {
          ((ByteDblLnkSeq)root).privateInit(new Node(val));
        }
        ++nextIndex;
        lastRet=null;
      }
      ...
      public void forEachRemaining(Consumer<? super Byte> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor.uncheckedForEachForward(cursor=root.tail,(ByteConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
  ...
  static class Node
  {
    ...
    private int collapseBodyHelper(Checked.ModCountChecker modCountChecker,int numLeft,Node next,BytePredicate filter)
    {
      int numRemoved=0;
    ...
    private int collapseBodyHelper(Node next,BytePredicate filter)
    {
      int numRemoved=0;
    ...
    private void uncheckedForEachForward(Node end,ByteConsumer action)
    {
    ...
    private void uncheckedForEachReverse(ByteConsumer action)
    {
      for(var curr=this;;)
      {
        action.accept(curr.val);
    ...
    private void uncheckedReplaceAll(Node end,ByteUnaryOperator operator)
    {
      for(var curr=this;;curr=curr.next)
      {
        curr.val=operator.applyAsByte(curr.val);
        if(curr==end)
        {
          return;
        }
    ...
    private void copyFromArray(byte[] src,int srcOffset,int length)
    {
      for(Node curr=this;;++srcOffset,curr=curr.next)
      {
        curr.val=(byte)src[srcOffset];
        if(--length==0)
        {
          return;
        }
    ...
    private void insertsort(Node end)
    {
      for(Node i=this,j=i;i!=end;j=(i=i.next))
      {
        final byte ai=i.next.val;
        byte aj;
        while(
        (ai)<(aj=j.val)
        )
    ...
    private void insertreverseSort(Node end)
    {
      for(Node i=this,j=i;i!=end;j=(i=i.next))
      {
        final byte ai=i.next.val;
    ...
    private void uncheckedcomparatorSort(int size,Node end,ByteComparator sorter)
    {
      byte[] tmpArr;
  ...
  public static class Unchecked extends ByteDblLnkSeq implements OmniDeque.OfByte
  {
    public Unchecked()
    {
      super();
    ...
    {
      this.size=1;
      ((ByteDblLnkSeq)this).privateInit(new Node(val));
    }
    @Override
    public void add(int index,byte val)
    {
    ...
    private static class AscendingItr extends AbstractByteItr implements OmniIterator.OfByte
    {
      ...
      public void forEachRemaining(Consumer<? super Byte> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachForward(root.tail,(ByteConsumer)action::accept);
          this.cursor=null;
        }
      }
      @Override
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      public void forEachRemaining(Consumer<? super Byte> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachReverse((ByteConsumer)action::accept);
          this.cursor=null;
        }
      }
    ...
    static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfByte
    {
      ...
      public void forEachRemaining(Consumer<? super Byte> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          Node bound;
          Unchecked root;
          cursor.uncheckedForEachForward(bound=(root=this.root).tail,(ByteConsumer)action::accept);
          this.cursor=null;
          lastRet=bound;
          nextIndex=root.size;
        }
    ...
    private static class SubList extends ByteDblLnkSeq
    {
      ...
      private static class AscendingItr extends AbstractByteItr implements OmniIterator.OfByte
      {
        ...
        public void forEachRemaining(Consumer<? super Byte> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            cursor.uncheckedForEachForward(parent.tail,(ByteConsumer)action::accept);
            this.cursor=null;
          }
        }
        @Override
      ...
      private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfByte
      {
        ...
        public void forEachRemaining(Consumer<? super Byte> action)
        {
          ...
          {
            SubList parent;
            cursor.uncheckedForEachForward(cursor=(parent=this.parent).tail,(ByteConsumer)action::accept);
            nextIndex=parent.size;
            this.cursor=null;
            lastRet=cursor;
          }
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
           curr.size=0;((ByteDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      private void bubbleUpincrementSize()
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
           curr.size=1;((ByteDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      @Override
      ...
      private OmniList.OfByte getDefaultSubList(Unchecked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfByte getEmptySubList(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfByte getSubList1(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private void suffixCollapsehead(Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(Node head,Node tail,BytePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void clearBody(int numRemoved)
      {
        ...
        bubbleUpclearBody(this.head,this.tail,numRemoved);
            ...
            void findNewHead(Node curr,BytePredicate filter)
            {
              final Node tail;
              if(curr!=(tail=this.tail))
              {
              ...
              final ByteDblLnkSeq root;(root=this.root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      void collapseTail(Node head,Node tail,BytePredicate filter)
      ...
      @Override
      boolean collapseBody(Node prev,Node next,BytePredicate filter)
      {
      ...
      void initHelper(Unchecked root,byte val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
      ...
      private static class PrefixList extends SubList
      {
        ...
        private OmniList.OfByte getEmptySubList(Unchecked root,int headDist)
        {
          if(headDist==0)
          {
            return new SubList.PrefixList(root,this);
      ...
      private static class BodyList extends PrefixList
      {
        ...
        private void collapseHeadAndTail(final Node head,final Node tail,final BytePredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
