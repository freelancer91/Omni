   ...
   ByteSubListDefault
{
  ...
  private static class CheckedSubList extends ByteDblLnkSeq{
    ...
    private static class SerializableSubList implements Serializable{
      ...
      private void readObject(ObjectInputStream ois) throws IOException
      {
        ...
        if(size!=0){
          ByteDblLnkNode curr;
          for(this.head=curr=new ByteDblLnkNode(ois.readByte());--size!=0;curr=curr.next=new ByteDblLnkNode(curr,ois.readByte())){}
          this.tail=curr;
        }
      }
  ...
  public static class UncheckedList extends ByteDblLnkSeq implements OmniDeque.OfByte,Externalizable{
    ...
    @Override public void readExternal(ObjectInput in) throws IOException
    {
      ...
      if(size!=0){
        ByteDblLnkNode curr;
        for(this.head=curr=new ByteDblLnkNode(in.readByte());--size!=0;curr=curr.next=new ByteDblLnkNode(curr,in.readByte())){}
        this.tail=curr;
      }
    }
    @Override public Object clone(){
