   ...
   ByteSubListDefault
{
  ...
  private ByteDblLnkNode getNode(int index,int size){
    ...
    if((tailDist=size-index)<index){
      ...
      return ByteDblLnkNode.iterateDescending(tail,tailDist-1);
    }else{
  ...
  private static class UncheckedSubList extends ByteDblLnkSeq{
    ...
    private void collapseHeadHelper(ByteDblLnkNode oldHead,ByteDblLnkNode tail,BytePredicate filter)
    {
      //TODO
    }
    private void collapseTailHelper(ByteDblLnkNode head,ByteDblLnkNode oldTail,BytePredicate filter)
    {
      //TODO
    }
    private void collapseHeadAndTailHelper(ByteDblLnkNode oldHead,ByteDblLnkNode oldTail,BytePredicate filter)
    {
      //TODO
    }
    private boolean collapseBodyHelper(ByteDblLnkNode head,ByteDblLnkNode tail,BytePredicate filter)
    {
      //TODO
      return false;
    }
    ...
    @Override public byte removeByteAt(int index){
      ...
      if((size=(--this.size)-index)<=index){
        ...
        if(index==0){
          ...
          ret=(after=( head=ByteDblLnkNode.iterateAscending(head,index)).next).val;
  ...
  private static class CheckedSubList extends ByteDblLnkSeq{
      ...
      implements OmniListIterator.OfByte
    {
      ...
      BidirectionalItr(CheckedSubList parent,ByteDblLnkNode curr,int currIndex){
        this.parent=parent;
        this.modCount=parent.modCount;
        this.curr=curr;
        this.currIndex=currIndex;
