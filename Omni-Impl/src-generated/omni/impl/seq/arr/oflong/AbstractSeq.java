...
abstract class AbstractSeq extends AbstractLongList
{
  ...
  public boolean contains(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Long)
      {
        return ArrSeqUtil.uncheckedcontains(arr,0,size,(long)(val));
      }
    }
    return false;
  }
  public int indexOf(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Long)
      {
        return ArrSeqUtil.uncheckedindexOf(arr,size,(long)(val));
      }
    }
    return -1;
  }
  public int search(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Long)
      {
        return ArrSeqUtil.uncheckedsearch(arr,size,(long)(val));
      }
    }
    return -1;
  }
  public boolean contains(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedcontains(arr,0,size,TypeUtil.castToLong(val));
    }
    return false;
  }
  ...
  public int indexOf(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedindexOf(arr,size,TypeUtil.castToLong(val));
    }
    return -1;
  }
  public int search(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedsearch(arr,size,TypeUtil.castToLong(val));
    }
    return -1;
  }
  @Override
