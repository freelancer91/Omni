...
abstract class AbstractSeq extends AbstractIntList
{
  ...
  public boolean contains(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return ArrSeqUtil.uncheckedcontains(arr,0,size,(int)(val));
      }
    }
    return false;
  }
  public int indexOf(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return ArrSeqUtil.uncheckedindexOf(arr,size,(int)(val));
      }
    }
    return -1;
  }
  public int search(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Integer)
      {
        return ArrSeqUtil.uncheckedsearch(arr,size,(int)(val));
      }
    }
    return -1;
  }
  public boolean contains(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedcontains(arr,0,size,(int)TypeUtil.castToByte(val));
    }
    return false;
  }
  ...
  public int indexOf(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedindexOf(arr,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int search(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedsearch(arr,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  @Override
  ...
  static abstract class Checked extends AbstractSeq
  {
    ...
    static abstract class AbstractSubList extends AbstractIntList
    {
