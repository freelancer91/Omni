...
abstract class AbstractSeq extends AbstractCharList
{
  ...
  public boolean contains(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return ArrSeqUtil.uncheckedcontains(arr,0,size,(char)(val));
      }
    }
    return false;
  }
  public int indexOf(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return ArrSeqUtil.uncheckedindexOf(arr,size,(char)(val));
      }
    }
    return -1;
  }
  public int search(Object val)
  {
    ...
    if((size=this.size)!=0)
    {
      if(val instanceof Character)
      {
        return ArrSeqUtil.uncheckedsearch(arr,size,(char)(val));
      }
    }
    return -1;
  }
  public boolean contains(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedcontains(arr,0,size,TypeUtil.castToChar(val));
    }
    return false;
  }
  ...
  public int indexOf(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedindexOf(arr,size,TypeUtil.castToChar(val));
    }
    return -1;
  }
  public int search(boolean val)
  {
    ...
    if((size=this.size)!=0)
    {
      return ArrSeqUtil.uncheckedsearch(arr,size,TypeUtil.castToChar(val));
    }
    return -1;
  }
  ...
  static abstract class Checked extends AbstractSeq
  {
    ...
    static abstract class AbstractSubList extends AbstractCharList
    {
