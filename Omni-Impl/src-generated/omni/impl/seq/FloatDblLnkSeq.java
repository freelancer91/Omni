   ...
   FloatSubListDefault
{
  ...
  private static class CheckedSubList extends FloatDblLnkSeq{
    ...
    private static  void pullSurvivorsDown(FloatDblLnkNode prev,FloatDblLnkNode next,long[] survivorSet,int numSurvivors,int numRemoved){
      int wordOffset;
    ...
    private static  void pullSurvivorsDown(FloatDblLnkNode prev,FloatDblLnkNode next,long word,int numSurvivors,int numRemoved){
