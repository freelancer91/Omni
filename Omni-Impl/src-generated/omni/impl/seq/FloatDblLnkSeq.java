   ...
   FloatSubListDefault
{
  ...
  private static class CheckedSubList extends FloatDblLnkSeq{
    ...
    private static  void pullSurvivorsDown(FloatDblLnkNode prev,long[] survivorSet,int numSurvivors,int numRemoved){
      int wordOffset;
    ...
    private static  void pullSurvivorsDown(FloatDblLnkNode prev,long word,int numSurvivors,int numRemoved){
    ...
    private static  int collapseBodyHelper(FloatDblLnkNode newHead,int numLeft,FloatPredicate filter,CheckedList.ModCountChecker modCountChecker)
    {
      if(numLeft!=0){
        int numSurvivors;
        if(numLeft>64){
