  ...
  public static class CheckedList extends UncheckedList{
    ...
    private boolean isEqualTo(int size,OmniList.OfInt list){
      if(list instanceof IntDblLnkSeq){
        ...
        return size==(that=(IntArrSeq.UncheckedList)list).size && SequenceEqualityUtil.isEqualTo(that.arr,0,size,this.head);
    ...
    private boolean isEqualTo(Node thisHead,int size,OmniList.OfInt list){
      if(list instanceof IntDblLnkSeq){
        ...
        final IntArrSeq.UncheckedSubList subList;
        final int thatOffset;
        return size==(subList=(IntArrSeq.UncheckedSubList)list).size && SequenceEqualityUtil.isEqualTo(subList.root.arr,thatOffset=subList.rootOffset,thatOffset+size,thisHead);
      }
    }
    @Override public boolean equals(Object val){
      if(val==this){
