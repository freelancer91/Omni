...
public abstract class IntDblLnkSeq extends AbstractIntList implements OmniList.OfInt
{
  ...
  private IntDblLnkSeq(Node onlyNode)
  {
    super(1);
  ...
  @Override
  public final boolean add(final int val)
  {
    addLast((int)val);
    return true;
  }
  public final void addFirst(final int val)
  {
    push((int)val);
  }
  public final boolean offer(final int val)
  {
    addLast((int)val);
    return true;
  }
  public final boolean offerLast(final int val)
  {
    addLast((int)val);
    return true;
  }
  public final boolean offerFirst(final int val)
  {
    push((int)val);
    return true;
  }
  public final void addFirst(final Integer val)
  {
    push((int)val);
  }
  public final void addLast(final Integer val)
  {
    addLast((int)val);
  }
  public final boolean offer(final Integer val)
  {
    addLast((int)val);
    return true;
  }
  public final boolean offerLast(final Integer val)
  {
    addLast((int)val);
    return true;
  }
  public final boolean offerFirst(final Integer val)
  {
    push((int)val);
    return true;
  }
  public final void push(final Integer val)
  {
    push((int)val);
  }
  abstract void pushtailHelper(Node oldtail,int val);
  ...
  abstract void pushheadHelper(Node oldhead,int val);
  ...
  {
    this.size=0;
    ((IntDblLnkSeq)this).privateInit(null);
  }
  @Override
  public boolean contains(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return IntDblLnkSeq.uncheckedcontains(head,tail,(int)TypeUtil.castToByte(val));
    }
    return false;
  }
  @Override
  public boolean contains(final int val)
  {
    ...
    {
      {
        return IntDblLnkSeq.uncheckedcontains(head,tail,(val));
      }
    }
    return false;
  }
  ...
  public boolean contains(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntDblLnkSeq.uncheckedcontains(head,tail,v);
      }
    }
    return false;
  }
  ...
  public int indexOf(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return IntDblLnkSeq.uncheckedindexOf(head,tail,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  @Override
  public int indexOf(final int val)
  {
    ...
    {
      {
        return IntDblLnkSeq.uncheckedindexOf(head,tail,(val));
      }
    }
    return -1;
  }
  ...
  public int indexOf(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntDblLnkSeq.uncheckedindexOf(head,tail,v);
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final boolean val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      return IntDblLnkSeq.uncheckedlastIndexOf(tail,size,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final int val)
  {
    ...
    {
      {
        return IntDblLnkSeq.uncheckedlastIndexOf(tail,size,(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final long val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntDblLnkSeq.uncheckedlastIndexOf(tail,size,v);
      }
    }
    return -1;
  }
  ...
  public int search(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return IntDblLnkSeq.uncheckedsearch(head,(int)TypeUtil.castToByte(val));
    }
    return -1;
  }
  public int search(final int val)
  {
    ...
    {
      {
        return IntDblLnkSeq.uncheckedsearch(head,(val));
      }
    }
    return -1;
  }
  public int search(final long val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(val==(v=(int)val))
      {
        return IntDblLnkSeq.uncheckedsearch(head,v);
      }
    }
    return -1;
  }
  ...
  public boolean contains(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return IntDblLnkSeq.uncheckedcontains(head,tail,(int)(val));
      }
    }
    return false;
  }
  ...
  public int indexOf(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Integer)
      {
        return IntDblLnkSeq.uncheckedindexOf(head,tail,(int)(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final Object val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val instanceof Integer)
      {
        return IntDblLnkSeq.uncheckedlastIndexOf(tail,size,(int)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Integer)
      {
        return IntDblLnkSeq.uncheckedsearch(head,(int)(val));
      }
    }
    return -1;
  }
  ...
  public void forEach(final Consumer<? super Integer> action)
  {
    ...
    if((head=this.head)!=null)
    {
      head.uncheckedForEachForward(this.tail,(IntConsumer)action::accept);
    }
  }
  @Override
  ...
  abstract void initHelper(int val);
  @Override
  public int hashCode()
  {
    final Node head;
  ...
  public int set(final int index,final int val)
  {
    ...
    public Integer[] toArray()
    {
      ...
      {
        final Integer[] dst;
        head.uncheckedCopyForward(dst=new Integer[size],0,size);
        return dst;
      }
  ...
  private void uncheckedAddHelper(int headDist,int newSize,int val)
  {
    this.size=newSize;
    if(headDist==0)
    {
  ...
  private void collapsehead(Node head,Node tail,IntPredicate filter)
  {
    int numRemoved;
    ...
    ((IntDblLnkSeq)this).privatesethead(head);
    this.size-=numRemoved;
  }
   void collapsetail(Node head,Node tail,IntPredicate filter)
  {
    int numRemoved;
    ...
    ((IntDblLnkSeq)this).privatesettail(tail);
    this.size-=numRemoved;
  }
  boolean collapseBody(Node head,Node tail,IntPredicate filter)
  {
    Node prev;
  ...
  void findNewHead(Node head,IntPredicate filter)
  {
    final Node tail;
  ...
  public static class Checked extends IntDblLnkSeq implements OmniDeque.OfInt
  {
    ...
    private OmniList.OfInt getDefaultSubList(int headDist,int subListSize,int tailDist)
    {
    ...
    private OmniList.OfInt getEmptySubList(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
    ...
    private OmniList.OfInt getSubList1(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
      ...
      return new SubList.BodyList(this,null,((IntDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
    }
    @Override
    void initHelper(int val)
    {
      ++this.modCount;
      this.size=1;
    ...
    @Override
    void pushheadHelper(Node oldhead,int val)
    {
      ++this.modCount;
      ++this.size;
      this.head=new Node(val,this.head);
    ...
    @Override
    void pushtailHelper(Node oldtail,int val)
    {
      ++this.modCount;
      ++this.size;
      this.tail=new Node(this.tail,val);
    ...
    public int popInt()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node head;
        ((IntDblLnkSeq)this).privatechophead(head=this.head);
        return head.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public int removeLastInt()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node tail;
        ((IntDblLnkSeq)this).privatechoptail(tail=this.tail);
        return tail.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public int pollInt()
    {
      ...
      if((head=this.head)!=null)
      {
        ++this.modCount;
        --this.size;
        ((IntDblLnkSeq)this).privatechophead(head);
        return (int)(head.val);
      }
      return Integer.MIN_VALUE;
    }
    ...
    public int pollLastInt()
    {
      ...
      if((tail=this.tail)!=null)
      {
        ++this.modCount;
        --this.size;
        ((IntDblLnkSeq)this).privatechoptail(tail);
        return (int)(tail.val);
      }
      return Integer.MIN_VALUE;
    }
    ...
    public boolean remove(Object val)
    {
      ...
      if((head=this.head)!=null)
      {
        if(val instanceof Integer)
        {
          return uncheckedremoveVal(head,(int)(val));
        }
      }
      return false;
    }
    private boolean uncheckedremoveVal(Node head,int val)
    {
      if(val!=(head.val))
      {
        ...
        if(head==tail)
        {
          ((IntDblLnkSeq)this).privatesettail(lastVisited);
        }
        else
        {
    ...
    public boolean removeVal(final boolean val)
    {
      ...
      if((head=this.head)!=null)
      {
        return this.uncheckedremoveVal(head,(int)TypeUtil.castToByte(val));
      }
      return false;
    }
    @Override
    ...
    private boolean uncheckedremoveLastOccurrence(Node tail,int val)
    {
      if(val!=(tail.val))
      {
        ...
        if(tail==head)
        {
          ((IntDblLnkSeq)this).privatesethead(lastVisited);
        }
        else
        {
    ...
    public boolean removeLastOccurrence(final boolean val)
    {
      ...
      if((tail=this.tail)!=null)
      {
        return this.uncheckedremoveLastOccurrence(tail,(int)TypeUtil.castToByte(val));
      }
      return false;
    }
    @Override
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tail,IntPredicate filter)
    {
    ...
    private void collapsehead(int modCount,Node head,Node tail,IntPredicate filter)
    {
    ...
    private void collapsetail(int modCount,Node tail,Node head,IntPredicate filter)
    {
      int oldSize,numConsumed;
    ...
    private static class SubList extends IntDblLnkSeq
    {
      private static class AscendingItr extends AbstractIntItr implements OmniIterator.OfInt
      {
        ...
        public void forEachRemaining(Consumer<? super Integer> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            ...
            try
            {
              cursor.uncheckedForEachForward(cursor=parent.tail,(IntConsumer)action::accept);
            }
            finally
            {
              CheckedCollection.checkModCount(modCount,parent.root.modCount);
      ...
      public boolean removeVal(final double val)
      {
        ...
        return false;
            ...
            void findNewHead(int modCount,Node curr,IntPredicate filter)
            {
              final Node tail;
              ...
              ((IntDblLnkSeq)root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      private void collapseHeadAndTail(int modCount,Node head,Node tail,IntPredicate filter)
      {
        ...
        for(;;)
        {
          ...
          if(!filter.test((head=head.next).val))
          {
            ...
            ((IntDblLnkSeq)root).privatesethead(head);
            ((IntDblLnkSeq)root).privatesettail(tail);
            break;
          }
        }
        root.modCount=modCount+1;
      ...
      boolean removeIfHelper(int modCount,Node curr,IntPredicate filter)
      {
        final Node tail;
        if(curr!=(tail=this.tail))
        {
      ...
      private void prefixCollapsetail(int modCount,Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsetail(int modCount,Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void suffixCollapsehead(int modCount,Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(int modCount,Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      public void add(int index,int val)
      {
        ...
        {
          Node newNode;
          ((IntDblLnkSeq)root).privateInit(newNode=new Node(val));
      ...
      public int removeIntAt(int index)
      {
        ...
        if(--size!=0)
        {
          ...
          {
            Node newHead;
            ((IntDblLnkSeq)root).privatesethead(newHead=(node=this.head).next);
          ...
          else
          {
            ...
            {
              Node newTail;
              ((IntDblLnkSeq)root).privatesettail(newTail=(node=this.tail).prev);
      ...
      public void forEach(Consumer<? super Integer> action)
      {
        ...
        try
        {
          super.forEach((IntConsumer)action::accept);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      private OmniList.OfInt getDefaultSubList(Checked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfInt getEmptySubList(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfInt getSubList1(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
        ...
        return new SubList.BodyList(root,this,((IntDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
      }
      @Override
      public OmniIterator.OfInt iterator()
      {
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
          ++curr.modCount;curr.size=0;((IntDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void bubbleUpclearBody(Node oldhead,Node oldtail,int numRemoved)
      {
        ...
        for(;;)
        {
          ++curr.modCount;
          curr.size=0;
          ((IntDblLnkSeq)curr).privateInit(null);
          if((curr=curr.parent)==null)
          {
            return;
          }
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
          ++curr.modCount;curr.size=1;((IntDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void clearPrefix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((IntDblLnkSeq)root).privatesethead(newhead);
      ...
      private void clearSuffix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((IntDblLnkSeq)root).privatesettail(newtail);
      ...
      private void uncheckedItrRemove(Node lastRet)
      {
        if(lastRet==tail)
        {
          ...
          else
          {
            ...
            ((IntDblLnkSeq)root).privatesettail(lastRet);
          }
        }
        else
        {
          if(lastRet==head)
          {
            ...
            ((IntDblLnkSeq)root).privatesethead(lastRet);
          }
          else
          {
            ((SubList)this).bubbleUpdecrementSize();
      ...
      void removeFirstHelper(int modCount,Node curr)
      {
        ...
        else
        {
          ...
          ((IntDblLnkSeq)root).privatesethead(curr);
        }
        --root.size;
      }
      ...
      void initHelper(Checked root,int val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
          ((IntDblLnkSeq)curr).privateInit(newNode);
          if((curr=curr.parent)==null)
          {
            ((IntDblLnkSeq)root).privateInit(newNode);
            return;
          }
        }
      }
      void prependHelper(int val)
      {
        ++this.modCount;
        Node newNode;
      ...
      private void insertHelper(Node before,int val,Node after)
      {
        ++this.modCount;
        new Node(before,val,after);
        SubList parent;
      ...
      private static class SuffixList extends SubList
      {
        ...
        void findNewHead(int modCount,Node curr,IntPredicate filter)
        {
          ...
          ((IntDblLnkSeq)root).privatesettail(curr);
        }
      ...
      private static class BodyList extends PrefixList
      {
        ...
        {
          final Node newNode;
          ((IntDblLnkSeq)this).privateInit(newNode=new Node(val));
          SubList parent,curr;
          ...
          ((IntDblLnkSeq)root).subSeqInsertHelper(newNode,curr.getParentOffset());
        }
        private void bubbleUppushhead(Node oldhead,Node newNode)
        {
          SubList curr=this;
        ...
        private void collapseHeadAndTail(int modCount,final Node head,final Node tail,final IntPredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
    ...
    private static class AscendingItr extends AbstractIntItr implements OmniIterator.OfInt
    {
      ...
      public void forEachRemaining(Consumer<? super Integer> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor=uncheckedForEach(cursor,root,(IntConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((IntDblLnkSeq)root).privatesethead(cursor);
        }
        else if(lastRet==root.tail)
        {
          ((IntDblLnkSeq)root).privatechoptail(lastRet);
        }
        else
        {
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((IntDblLnkSeq)root).privatechophead(lastRet);
        }
        else if(lastRet==root.tail)
        {
          ((IntDblLnkSeq)root).privatesettail(cursor);
        }
        else
        {
    ...
    private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfInt
    {
      ...
      public void add(int val)
      {
        ...
        {
          ((IntDblLnkSeq)root).privateInit(new Node(val));
        }
        ++nextIndex;
        lastRet=null;
      }
      ...
      public void forEachRemaining(Consumer<? super Integer> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor.uncheckedForEachForward(cursor=root.tail,(IntConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
  ...
  static class Node
  {
    ...
    private int collapseBodyHelper(Checked.ModCountChecker modCountChecker,int numLeft,Node next,IntPredicate filter)
    {
      int numRemoved=0;
    ...
    private int markSurvivors(int numLeft,long[] survivorSet,IntPredicate filter)
    {
      long survivorWord;
      var begin=this;
    ...
    private int collapseBodyHelper(Node next,IntPredicate filter)
    {
      int numRemoved=0;
    ...
    private void uncheckedForEachForward(Node end,IntConsumer action)
    {
    ...
    private void uncheckedForEachReverse(IntConsumer action)
    {
      for(var curr=this;;)
      {
        action.accept(curr.val);
    ...
    private void uncheckedReplaceAll(Node end,IntUnaryOperator operator)
    {
      for(var curr=this;;curr=curr.next)
      {
        curr.val=operator.applyAsInt(curr.val);
        if(curr==end)
        {
          return;
        }
    ...
    private void copyFromArray(int[] src,int srcOffset,int length)
    {
      for(Node curr=this;;++srcOffset,curr=curr.next)
      {
        curr.val=(int)src[srcOffset];
        if(--length==0)
        {
          return;
        }
    ...
    private void uncheckedCopyForward(Integer[] dst,int dstOffset,int length)
    {
      for(var src=this;;++dstOffset,src=src.next)
      {
        dst[dstOffset]=(Integer)(src.val);
        if(--length==0)
        {
          return;
        }
  ...
  public static class Unchecked extends IntDblLnkSeq implements OmniDeque.OfInt
  {
    public Unchecked()
    {
      super();
    ...
    {
      this.size=1;
      ((IntDblLnkSeq)this).privateInit(new Node(val));
    }
    @Override
    public void add(int index,int val)
    {
    ...
    private static class AscendingItr extends AbstractIntItr implements OmniIterator.OfInt
    {
      ...
      public void forEachRemaining(Consumer<? super Integer> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachForward(root.tail,(IntConsumer)action::accept);
          this.cursor=null;
        }
      }
      @Override
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      public void forEachRemaining(Consumer<? super Integer> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachReverse((IntConsumer)action::accept);
          this.cursor=null;
        }
      }
    ...
    static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfInt
    {
      ...
      public void forEachRemaining(Consumer<? super Integer> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          Node bound;
          Unchecked root;
          cursor.uncheckedForEachForward(bound=(root=this.root).tail,(IntConsumer)action::accept);
          this.cursor=null;
          lastRet=bound;
          nextIndex=root.size;
        }
    ...
    private static class SubList extends IntDblLnkSeq
    {
      ...
      private static class AscendingItr extends AbstractIntItr implements OmniIterator.OfInt
      {
        ...
        public void forEachRemaining(Consumer<? super Integer> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            cursor.uncheckedForEachForward(parent.tail,(IntConsumer)action::accept);
            this.cursor=null;
          }
        }
        @Override
      ...
      private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfInt
      {
        ...
        public void forEachRemaining(Consumer<? super Integer> action)
        {
          ...
          {
            SubList parent;
            cursor.uncheckedForEachForward(cursor=(parent=this.parent).tail,(IntConsumer)action::accept);
            nextIndex=parent.size;
            this.cursor=null;
            lastRet=cursor;
          }
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
           curr.size=0;((IntDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      private void bubbleUpincrementSize()
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
           curr.size=1;((IntDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      @Override
      ...
      private OmniList.OfInt getDefaultSubList(Unchecked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfInt getEmptySubList(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfInt getSubList1(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private void suffixCollapsehead(Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(Node head,Node tail,IntPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void clearBody(int numRemoved)
      {
        ...
        bubbleUpclearBody(this.head,this.tail,numRemoved);
            ...
            void findNewHead(Node curr,IntPredicate filter)
            {
              final Node tail;
              if(curr!=(tail=this.tail))
              {
              ...
              final IntDblLnkSeq root;(root=this.root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      void collapseTail(Node head,Node tail,IntPredicate filter)
      ...
      @Override
      boolean collapseBody(Node prev,Node next,IntPredicate filter)
      {
      ...
      void initHelper(Unchecked root,int val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
      ...
      private static class PrefixList extends SubList
      {
        ...
        private OmniList.OfInt getEmptySubList(Unchecked root,int headDist)
        {
          if(headDist==0)
          {
            return new SubList.PrefixList(root,this);
      ...
      private static class BodyList extends PrefixList
      {
        ...
        private void collapseHeadAndTail(final Node head,final Node tail,final IntPredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
