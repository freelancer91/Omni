...
public class CharArrDeq implements OmniDeque.OfChar,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends CharArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void nonfragmentedPullSurvivorsUp(char[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void nonfragmentedPullSurvivorsDown(char[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void fragmentedPullSurvivorsDownToNonFragmented(char[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void fragmentedPullSurvivorsDown(char[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    ...
    private static abstract class CollapseData{
      ...
      abstract void nonfragmentedPullSurvivorsUp(char[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void nonfragmentedPullSurvivorsDown(char[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDownToNonFragmented(char[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDown(char[] arr,int dstOffset,int numToSkip,int dstBound);
    }
