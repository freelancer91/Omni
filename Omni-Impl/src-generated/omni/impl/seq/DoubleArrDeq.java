...
public class DoubleArrDeq implements OmniDeque.OfDouble,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends DoubleArrDeq{
    ...
    private static abstract class CollapseData{
      ...
      abstract void pullDownMarkRangeSpansSplit(double[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound);
      abstract void pullDownMarkRangeSpansSplitDstBoundGoesBeyondSplit(double[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound);
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      BigCollapseData(Checked deq,int srcOffset,int numLeft,DoublePredicate filter,int arrBound){
        super(deq,numLeft);
        assert srcOffset>0;
        assert numLeft>1;
        assert numLeft>64;
      ...
      @Override void pullDownMarkRangeSpansSplit(double[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void pullDownMarkRangeSpansSplitDstBoundGoesBeyondSplit(double[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    private static class SmallCollapseData extends CollapseData{
      ...
      private void finalizePullDown(double[] arr,int srcOffset,int dstOffset,long word){
      ...
      private void pullDownFromTailSpanToHeadSpan(double[] arr,int srcOffset,int dstOffset,long word){
      ...
      @Override void arrSeqPullDown(double[] arr,int srcOffset,int dstOffset,int dstBound){
        ...
        DoubleArrSeq.pullSurvivorsDown(arr,srcOffset,dstOffset,survivorWord);
      }
      @Override void pullSurvivorsDown(double[] arr,int dstOffset,int survivorIndex,int dstBound){
        assert dstOffset>=0;
        assert dstOffset<dstBound;
        assert dstBound<arr.length;
        DoubleArrSeq.pullSurvivorsDown(arr,dstOffset+1,dstOffset,this.survivorWord>>>survivorIndex);
      }
      ...
      SmallCollapseData(Checked deq,int srcOffset,int numLeft,DoublePredicate filter,int arrBound){
        super(deq,numLeft);
        assert srcOffset>0;
        assert numLeft>1;
        assert numLeft<=64;
    ...
    private CollapseData getNonfragmentedCollapseData(int srcOffset,int numLeft,DoublePredicate filter){
      return numLeft>64?new BigCollapseData(this,srcOffset,numLeft,filter):new SmallCollapseData(this,srcOffset,numLeft,filter);
    }
    private CollapseData getFragmentedCollapseData(int srcOffset,int numLeft,DoublePredicate filter,int arrBound){
