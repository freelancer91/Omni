...
public class DoubleArrDeq implements OmniDeque.OfDouble,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends DoubleArrDeq{
    ...
    private void pullUpAcrossSplit(double[] arr,int head,int gapBegin,int gapEnd){
    ...
    private static abstract class CollapseData{
      ...
      abstract void pullDownAcrossSplit(double[] arr,int srcOffset,int dstOffset,int dstBound);
    ...
    private static class BigCollapseData extends CollapseData{
          ...
          do{
            ...
            if(++srcOffset==arrBound){
              for(currentRunLength=0;;){
                while((marker<<=1)!=0L){
                  if(filter.test((double)arr[srcOffset-arrBound])){
                    currentRunLength=0;
                  }else{
                    word|=marker;
                    if(currentRunLength==0){
      ...
      @Override void pullDownAcrossSplit(double[] arr,int srcOffset,int dstOffset,int dstBound){
        //TODO
