...
public class DoubleArrDeq implements OmniDeque.OfDouble,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends DoubleArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void nonfragmentedPullSurvivorsUp(double[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void nonfragmentedPullSurvivorsDown(double[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void fragmentedPullSurvivorsDown(double[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    ...
    private static abstract class CollapseData{
      ...
      abstract void nonfragmentedPullSurvivorsUp(double[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void nonfragmentedPullSurvivorsDown(double[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDownToNonFragmented(double[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDown(double[] arr,int dstOffset,int numToSkip,int dstBound);
    }
