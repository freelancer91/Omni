...
public abstract class LongDblLnkSeq extends AbstractLongList implements OmniList.OfLong
{
  ...
  private static  int uncheckedindexOf(Node begin,Node end,long val)
  {
    int index=0;
    while(val!=(begin.val))
    {
  ...
  private static  int uncheckedlastIndexOf(Node end,int size,long val)
  {
  ...
  private static  int uncheckedsearch(Node begin,long val)
  {
    int index=1;
    while(val!=(begin.val))
    {
  ...
  private LongDblLnkSeq(Node onlyNode)
  {
    super(1);
  ...
  @Override
  public final boolean add(final long val)
  {
    addLast((long)val);
    return true;
  }
  public final void addFirst(final long val)
  {
    push((long)val);
  }
  public final boolean offer(final long val)
  {
    addLast((long)val);
    return true;
  }
  public final boolean offerLast(final long val)
  {
    addLast((long)val);
    return true;
  }
  public final boolean offerFirst(final long val)
  {
    push((long)val);
    return true;
  }
  ...
  public final void addLast(final Long val)
  {
    addLast((long)val);
  }
  public final boolean offer(final Long val)
  ...
  abstract void pushtailHelper(Node oldtail,long val);
  ...
  abstract void pushheadHelper(Node oldhead,long val);
  ...
  {
    this.size=0;
    ((LongDblLnkSeq)this).privateInit(null);
  }
  @Override
  public boolean contains(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return LongDblLnkSeq.uncheckedcontains(head,tail,TypeUtil.castToLong(val));
    }
    return false;
  }
  @Override
  public boolean contains(final int val)
  {
    ...
    {
      {
        return LongDblLnkSeq.uncheckedcontains(head,tail,(val));
      }
    }
    return false;
  }
  ...
  public boolean contains(final float val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return LongDblLnkSeq.uncheckedcontains(head,tail,v);
      }
    }
    return false;
  }
  ...
  public int indexOf(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return LongDblLnkSeq.uncheckedindexOf(head,tail,TypeUtil.castToLong(val));
    }
    return -1;
  }
  @Override
  public int indexOf(final int val)
  {
    ...
    {
      {
        return LongDblLnkSeq.uncheckedindexOf(head,tail,(val));
      }
    }
    return -1;
  }
  ...
  public int indexOf(final float val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(TypeUtil.floatEquals(val,v=(long)val))
      {
        return LongDblLnkSeq.uncheckedindexOf(head,tail,v);
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final boolean val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      return LongDblLnkSeq.uncheckedlastIndexOf(tail,size,TypeUtil.castToLong(val));
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final int val)
  {
    ...
    {
      {
        return LongDblLnkSeq.uncheckedlastIndexOf(tail,size,(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final float val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      ...
      if(TypeUtil.floatEquals(val,v=(long)val))
      {
        return LongDblLnkSeq.uncheckedlastIndexOf(tail,size,v);
      }
    }
    return -1;
  }
  ...
  public int search(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      return LongDblLnkSeq.uncheckedsearch(head,TypeUtil.castToLong(val));
    }
    return -1;
  }
  public int search(final int val)
  {
    ...
    {
      {
        return LongDblLnkSeq.uncheckedsearch(head,(val));
      }
    }
    return -1;
  }
  ...
  public int search(final float val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      if(TypeUtil.floatEquals(val,v=(long)val))
      {
        return LongDblLnkSeq.uncheckedsearch(head,v);
      }
    }
    return -1;
  }
  ...
  public boolean contains(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return LongDblLnkSeq.uncheckedcontains(head,tail,(long)(val));
      }
    }
    return false;
  }
  ...
  public int indexOf(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Long)
      {
        return LongDblLnkSeq.uncheckedindexOf(head,tail,(long)(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final Object val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val instanceof Long)
      {
        return LongDblLnkSeq.uncheckedlastIndexOf(tail,size,(long)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Long)
      {
        return LongDblLnkSeq.uncheckedsearch(head,(long)(val));
      }
    }
    return -1;
  }
  ...
  public void forEach(final Consumer<? super Long> action)
  {
    ...
    if((head=this.head)!=null)
    {
      head.uncheckedForEachForward(this.tail,(LongConsumer)action::accept);
    }
  }
  @Override
  ...
  abstract void initHelper(long val);
  @Override
  public int hashCode()
  {
    final Node head;
  ...
  private void uncheckedAddHelper(int headDist,int newSize,long val)
  {
    this.size=newSize;
    if(headDist==0)
    {
  ...
  private void collapsehead(Node head,Node tail,LongPredicate filter)
  {
    int numRemoved;
    ...
    ((LongDblLnkSeq)this).privatesethead(head);
    this.size-=numRemoved;
  }
   void collapsetail(Node head,Node tail,LongPredicate filter)
  {
    int numRemoved;
    ...
    ((LongDblLnkSeq)this).privatesettail(tail);
    this.size-=numRemoved;
  }
  boolean collapseBody(Node head,Node tail,LongPredicate filter)
  {
    Node prev;
  ...
  void findNewHead(Node head,LongPredicate filter)
  {
    final Node tail;
  ...
  public static class Checked extends LongDblLnkSeq implements OmniDeque.OfLong
  {
    ...
    private OmniList.OfLong getDefaultSubList(int headDist,int subListSize,int tailDist)
    {
    ...
    private OmniList.OfLong getEmptySubList(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
    ...
    private OmniList.OfLong getSubList1(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
      ...
      return new SubList.BodyList(this,null,((LongDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
    }
    @Override
    void initHelper(long val)
    {
      ++this.modCount;
      this.size=1;
    ...
    @Override
    void pushheadHelper(Node oldhead,long val)
    {
      ++this.modCount;
      ++this.size;
      this.head=new Node(val,this.head);
    ...
    @Override
    void pushtailHelper(Node oldtail,long val)
    {
      ++this.modCount;
      ++this.size;
      this.tail=new Node(this.tail,val);
    ...
    public long popLong()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node head;
        ((LongDblLnkSeq)this).privatechophead(head=this.head);
        return head.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public long removeLastLong()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node tail;
        ((LongDblLnkSeq)this).privatechoptail(tail=this.tail);
        return tail.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public long pollLong()
    {
      ...
      if((head=this.head)!=null)
      {
        ++this.modCount;
        --this.size;
        ((LongDblLnkSeq)this).privatechophead(head);
        return (long)(head.val);
      }
      return Long.MIN_VALUE;
    }
    ...
    public long pollLastLong()
    {
      ...
      if((tail=this.tail)!=null)
      {
        ++this.modCount;
        --this.size;
        ((LongDblLnkSeq)this).privatechoptail(tail);
        return (long)(tail.val);
      }
      return Long.MIN_VALUE;
    }
    ...
    public boolean remove(Object val)
    {
      ...
      if((head=this.head)!=null)
      {
        if(val instanceof Long)
        {
          return uncheckedremoveVal(head,(long)(val));
        }
      }
      return false;
    }
    private boolean uncheckedremoveVal(Node head,long val)
    {
      if(val!=(head.val))
      {
        Node lastVisited;
        ...
        if(head==tail)
        {
          ((LongDblLnkSeq)this).privatesettail(lastVisited);
        }
        else
        {
    ...
    public boolean removeVal(final boolean val)
    {
      ...
      if((head=this.head)!=null)
      {
        return this.uncheckedremoveVal(head,TypeUtil.castToLong(val));
      }
      return false;
    }
    @Override
    ...
    private boolean uncheckedremoveLastOccurrence(Node tail,long val)
    {
      if(val!=(tail.val))
      {
        Node lastVisited;
        ...
        if(tail==head)
        {
          ((LongDblLnkSeq)this).privatesethead(lastVisited);
        }
        else
        {
    ...
    public boolean removeLastOccurrence(final boolean val)
    {
      ...
      if((tail=this.tail)!=null)
      {
        return this.uncheckedremoveLastOccurrence(tail,TypeUtil.castToLong(val));
      }
      return false;
    }
    @Override
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tail,LongPredicate filter)
    {
    ...
    private void collapsehead(int modCount,Node head,Node tail,LongPredicate filter)
    {
    ...
    private void collapsetail(int modCount,Node tail,Node head,LongPredicate filter)
    {
      int oldSize,numConsumed;
    ...
    private static class SubList extends LongDblLnkSeq
    {
      private static class AscendingItr extends AbstractLongItr implements OmniIterator.OfLong
      {
        ...
        public void forEachRemaining(Consumer<? super Long> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            ...
            try
            {
              cursor.uncheckedForEachForward(cursor=parent.tail,(LongConsumer)action::accept);
            }
            finally
            {
              CheckedCollection.checkModCount(modCount,parent.root.modCount);
      ...
      public boolean removeVal(final double val)
      {
        ...
        return false;
            ...
            void findNewHead(int modCount,Node curr,LongPredicate filter)
            {
              final Node tail;
              ...
              ((LongDblLnkSeq)root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      private void collapseHeadAndTail(int modCount,Node head,Node tail,LongPredicate filter)
      {
        ...
        for(;;)
        {
          ...
          if(!filter.test((head=head.next).val))
          {
            ...
            ((LongDblLnkSeq)root).privatesethead(head);
            ((LongDblLnkSeq)root).privatesettail(tail);
            break;
          }
        }
        root.modCount=modCount+1;
      ...
      boolean removeIfHelper(int modCount,Node curr,LongPredicate filter)
      {
        final Node tail;
        if(curr!=(tail=this.tail))
        {
      ...
      private void prefixCollapsetail(int modCount,Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsetail(int modCount,Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void suffixCollapsehead(int modCount,Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(int modCount,Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      public void add(int index,long val)
      {
        ...
        {
          Node newNode;
          ((LongDblLnkSeq)root).privateInit(newNode=new Node(val));
      ...
      public long removeLongAt(int index)
      {
        ...
        if(--size!=0)
        {
          ...
          {
            Node newHead;
            ((LongDblLnkSeq)root).privatesethead(newHead=(node=this.head).next);
          ...
          else
          {
            ...
            {
              Node newTail;
              ((LongDblLnkSeq)root).privatesettail(newTail=(node=this.tail).prev);
      ...
      public void forEach(Consumer<? super Long> action)
      {
        ...
        try
        {
          super.forEach((LongConsumer)action::accept);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      private OmniList.OfLong getDefaultSubList(Checked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfLong getEmptySubList(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfLong getSubList1(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
        ...
        return new SubList.BodyList(root,this,((LongDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
      }
      @Override
      public OmniIterator.OfLong iterator()
      {
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
          ++curr.modCount;curr.size=0;((LongDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void bubbleUpclearBody(Node oldhead,Node oldtail,int numRemoved)
      {
        ...
        for(;;)
        {
          ++curr.modCount;
          curr.size=0;
          ((LongDblLnkSeq)curr).privateInit(null);
          if((curr=curr.parent)==null)
          {
            return;
          }
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
          ++curr.modCount;curr.size=1;((LongDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void clearPrefix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((LongDblLnkSeq)root).privatesethead(newhead);
      ...
      private void clearSuffix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((LongDblLnkSeq)root).privatesettail(newtail);
      ...
      private void uncheckedItrRemove(Node lastRet)
      {
        if(lastRet==tail)
        {
          ...
          else
          {
            ...
            ((LongDblLnkSeq)root).privatesettail(lastRet);
          }
        }
        else
        {
          if(lastRet==head)
          {
            ...
            ((LongDblLnkSeq)root).privatesethead(lastRet);
          }
          else
          {
            ((SubList)this).bubbleUpdecrementSize();
      ...
      void removeFirstHelper(int modCount,Node curr)
      {
        ...
        else
        {
          ...
          ((LongDblLnkSeq)root).privatesethead(curr);
        }
        --root.size;
      }
      boolean uncheckedremoveValHelper(int modCount,Node curr,long val)
      {
        final var root=this.root;
        final var tail=this.tail;
        Node prev;
      ...
      void initHelper(Checked root,long val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
          ((LongDblLnkSeq)curr).privateInit(newNode);
          if((curr=curr.parent)==null)
          {
            ((LongDblLnkSeq)root).privateInit(newNode);
            return;
          }
        }
      }
      void prependHelper(long val)
      {
        ++this.modCount;
        Node newNode;
      ...
      private void insertHelper(Node before,long val,Node after)
      {
        ++this.modCount;
        new Node(before,val,after);
        SubList parent;
      ...
      private static class SuffixList extends SubList
      {
        ...
        void findNewHead(int modCount,Node curr,LongPredicate filter)
        {
          ...
          ((LongDblLnkSeq)root).privatesettail(curr);
        }
      ...
      private static class BodyList extends PrefixList
      {
        ...
        {
          final Node newNode;
          ((LongDblLnkSeq)this).privateInit(newNode=new Node(val));
          SubList parent,curr;
          ...
          ((LongDblLnkSeq)root).subSeqInsertHelper(newNode,curr.getParentOffset());
        }
        private void bubbleUppushhead(Node oldhead,Node newNode)
        {
          SubList curr=this;
        ...
        private void collapseHeadAndTail(int modCount,final Node head,final Node tail,final LongPredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
    ...
    private static class AscendingItr extends AbstractLongItr implements OmniIterator.OfLong
    {
      ...
      public void forEachRemaining(Consumer<? super Long> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor=uncheckedForEach(cursor,root,(LongConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((LongDblLnkSeq)root).privatesethead(cursor);
        }
        else if(lastRet==root.tail)
        {
          ((LongDblLnkSeq)root).privatechoptail(lastRet);
        }
        else
        {
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((LongDblLnkSeq)root).privatechophead(lastRet);
        }
        else if(lastRet==root.tail)
        {
          ((LongDblLnkSeq)root).privatesettail(cursor);
        }
        else
        {
    ...
    private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfLong
    {
      ...
      public void add(long val)
      {
        ...
        {
          ((LongDblLnkSeq)root).privateInit(new Node(val));
        }
        ++nextIndex;
        lastRet=null;
      }
      ...
      public void forEachRemaining(Consumer<? super Long> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor.uncheckedForEachForward(cursor=root.tail,(LongConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
  ...
  static class Node
  {
    ...
    private int collapseBodyHelper(Checked.ModCountChecker modCountChecker,int numLeft,Node next,LongPredicate filter)
    {
      int numRemoved=0;
    ...
    private int markSurvivors(int numLeft,long[] survivorSet,LongPredicate filter)
    {
      long survivorWord;
      var begin=this;
    ...
    private int collapseBodyHelper(Node next,LongPredicate filter)
    {
      int numRemoved=0;
    ...
    private void uncheckedForEachForward(Node end,LongConsumer action)
    {
    ...
    private void uncheckedForEachReverse(LongConsumer action)
    {
      for(var curr=this;;)
      {
        action.accept(curr.val);
    ...
    {
      int hash=31+Long.hashCode(this.val);
      for(var curr=this;curr!=end;hash=hash*31+Long.hashCode((curr=curr.next).val))
      {  
      }
      return hash;
    }
    ...
    private void uncheckedReplaceAll(Node end,LongUnaryOperator operator)
    {
      for(var curr=this;;curr=curr.next)
      {
        curr.val=operator.applyAsLong(curr.val);
        if(curr==end)
        {
          return;
        }
    ...
    private void copyFromArray(long[] src,int srcOffset,int length)
    {
      for(Node curr=this;;++srcOffset,curr=curr.next)
      {
        curr.val=(long)src[srcOffset];
        if(--length==0)
        {
          return;
        }
  ...
  public static class Unchecked extends LongDblLnkSeq implements OmniDeque.OfLong
  {
    public Unchecked()
    {
      super();
    ...
    {
      this.size=1;
      ((LongDblLnkSeq)this).privateInit(new Node(val));
    }
    @Override
    public void add(int index,long val)
    {
    ...
    private static class AscendingItr extends AbstractLongItr implements OmniIterator.OfLong
    {
      ...
      public void forEachRemaining(Consumer<? super Long> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachForward(root.tail,(LongConsumer)action::accept);
          this.cursor=null;
        }
      }
      @Override
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      public void forEachRemaining(Consumer<? super Long> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachReverse((LongConsumer)action::accept);
          this.cursor=null;
        }
      }
    ...
    static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfLong
    {
      ...
      public void forEachRemaining(Consumer<? super Long> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          Node bound;
          Unchecked root;
          cursor.uncheckedForEachForward(bound=(root=this.root).tail,(LongConsumer)action::accept);
          this.cursor=null;
          lastRet=bound;
          nextIndex=root.size;
        }
    ...
    private static class SubList extends LongDblLnkSeq
    {
      ...
      private static class AscendingItr extends AbstractLongItr implements OmniIterator.OfLong
      {
        ...
        public void forEachRemaining(Consumer<? super Long> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            cursor.uncheckedForEachForward(parent.tail,(LongConsumer)action::accept);
            this.cursor=null;
          }
        }
        @Override
      ...
      private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfLong
      {
        ...
        public void forEachRemaining(Consumer<? super Long> action)
        {
          ...
          {
            SubList parent;
            cursor.uncheckedForEachForward(cursor=(parent=this.parent).tail,(LongConsumer)action::accept);
            nextIndex=parent.size;
            this.cursor=null;
            lastRet=cursor;
          }
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
           curr.size=0;((LongDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      private void bubbleUpincrementSize()
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
           curr.size=1;((LongDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      @Override
      ...
      boolean uncheckedremoveValHelper(Node curr,long val)
      {
        final var root=this.root;
        final var tail=this.tail;
        Node prev;
      ...
      private OmniList.OfLong getDefaultSubList(Unchecked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfLong getEmptySubList(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfLong getSubList1(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private void suffixCollapsehead(Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(Node head,Node tail,LongPredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void clearBody(int numRemoved)
      {
        ...
        bubbleUpclearBody(this.head,this.tail,numRemoved);
            ...
            void findNewHead(Node curr,LongPredicate filter)
            {
              final Node tail;
              if(curr!=(tail=this.tail))
              {
              ...
              final LongDblLnkSeq root;(root=this.root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      void collapseTail(Node head,Node tail,LongPredicate filter)
      ...
      @Override
      boolean collapseBody(Node prev,Node next,LongPredicate filter)
      {
      ...
      void initHelper(Unchecked root,long val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
      ...
      private static class PrefixList extends SubList
      {
        ...
        private OmniList.OfLong getEmptySubList(Unchecked root,int headDist)
        {
          if(headDist==0)
          {
            return new SubList.PrefixList(root,this);
      ...
      private static class BodyList extends PrefixList
      {
        ...
        private void collapseHeadAndTail(final Node head,final Node tail,final LongPredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
