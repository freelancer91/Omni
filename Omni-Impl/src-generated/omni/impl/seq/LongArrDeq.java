...
public class LongArrDeq implements OmniDeque.OfLong,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends LongArrDeq{
    ...
    private static abstract class CollapseData{
      ...
      abstract void pullDownMarkRangeSpansSplit(long[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound);
      abstract void pullDownMarkRangeSpansSplitDstBoundGoesBeyondSplit(long[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound);
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void pullDownMarkRangeSpansSplit(long[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void pullDownMarkRangeSpansSplitDstBoundGoesBeyondSplit(long[] arr,int srcOffset,int dstOffset,int survivorIndex,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    private static class SmallCollapseData extends CollapseData{
      ...
      private void finalizePullDown(long[] arr,int srcOffset,int dstOffset,long word){
      ...
      private void pullDownFromTailSpanToHeadSpan(long[] arr,int srcOffset,int dstOffset,long word){
