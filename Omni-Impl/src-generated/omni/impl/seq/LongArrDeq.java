...
public class LongArrDeq implements OmniDeque.OfLong,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends LongArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      private void fragmentedPullSurvivorsUpToNonFragmented(long[] arr,int dstOffset,int numToSkip,int dstBound){
      ...
      private void fragmentedPullSurvivorsUp(long[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset,s;
        long[] survivorSet;
        long word=(survivorSet=this.survivorSet)[wordOffset=numToSkip>>6]<<(-(numToSkip+1));
        int srcOffset=(s=dstOffset-1)-(((numToSkip)&63)+1);
    ...
    private static class AscendingItr extends AbstractDeqItr{
      ...
      @Override void uncheckedForEachRemaining(final int expectedCursor,LongConsumer action){
        int modCount=this.modCount;
        final Checked root;
