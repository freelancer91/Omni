...
public class LongArrDeq implements OmniDeque.OfLong,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends LongArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void nonfragmentedPullSurvivorsUp(long[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void nonfragmentedPullSurvivorsDown(long[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void fragmentedPullSurvivorsDownToNonFragmented(long[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void fragmentedPullSurvivorsDown(long[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    ...
    private static abstract class CollapseData{
      ...
      abstract void nonfragmentedPullSurvivorsUp(long[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void nonfragmentedPullSurvivorsDown(long[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDownToNonFragmented(long[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDown(long[] arr,int dstOffset,int numToSkip,int dstBound);
    }
