...
public abstract class IntSnglLnkSeq 
extends AbstractSeq.OfSignedIntegralPrimitive
implements OmniCollection.OfInt
{
  transient Node head;
  ...
  private IntSnglLnkSeq(Node onlyNode)
  {
    super(1);
    this.head=onlyNode;
  }
  ...
  public boolean contains(Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return head.uncheckedcontains((int)(val));
      }
    }
    return false;
  }
  public int search(Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Integer)
      {
        return head.uncheckedsearch((int)(val));
      }
    }
    return -1;
  }
  ...
  public Integer[] toArray()
  {
    ...
    {
      final Integer[] dst;
      head.uncheckedCopyForward(dst=new Integer[size],0);
      return dst;
    }
  ...
  public static class Stack extends IntSnglLnkSeq implements OmniStack.OfInt
  {
    public Stack()
    {
      super();
    ...
    private void uncheckedRemoveIfHelper(Node prev,Node curr,IntPredicate filter)
    {
      int numRemoved=1;
    ...
    @Override
    boolean uncheckedRemoveIf(Node curr,IntPredicate filter)
    {
      if(filter.test(curr.val))
      {
        while((curr=curr.next)!=null)
    ...
    public static class Checked extends Stack
    {
      ...
      private void uncheckedRemoveIfHelper(int modCount,int numLeft,Node prev,Node curr,IntPredicate filter)
      {
        int numRemoved=1;
        for(;;)
        {
  ...
  public static class Queue extends IntSnglLnkSeq implements OmniQueue.OfInt
  {
    transient Node tail;
    public Queue()
    {
    ...
    private int uncheckedRemoveIfHelper(Node curr,IntPredicate filter)
    {
      int numSurvivors=1;
    ...
    public static class Checked extends Queue
    {
      ...
      private int uncheckedRemoveIfHelper(int modCount,int numLeft,Node curr,IntPredicate filter)
      {
        int numSurvivors=1;
  ...
  static class Node
  {
    private int countNumRemainingNodes(CheckedCollection.AbstractModCountChecker modCountChecker,int numLeft,IntPredicate filter)
    {
      int numSurvivors=1;
    ...
    private int countNumRemovedNodes(CheckedCollection.AbstractModCountChecker modCountChecker,int numLeft,IntPredicate filter)
    {
    ...
    private int countNumRemovedNodes(IntPredicate filter)
    {
      int numRemoved=0;
    ...
    private int countNumRemainingNodes(IntPredicate filter)
    {
      int numLeft=1;
    ...
    private void uncheckedForEachForward(IntConsumer action)
    {
      var curr=this;
      do
      {
    ...
    private void uncheckedCopyForward(Integer[] dst,int dstOffset)
    {
      for(var src=this;;++dstOffset)
      {
