...
public abstract class DoubleDblLnkSeq extends AbstractDoubleList implements OmniList.OfDouble
{
  ...
  private static  boolean uncheckedcontainsBits(Node begin,Node end,long bits)
  {
    while(bits!=Double.doubleToRawLongBits(begin.val))
    {
      if(begin==end)
      {
        return false;
  ...
  private static  int uncheckedindexOfBits(Node begin,Node end,long bits)
  {
    int index=0;
    while(bits!=Double.doubleToRawLongBits(begin.val))
    {
  ...
  private static  int uncheckedlastIndexOfBits(Node end,int size,long bits)
  {
    while(bits!=Double.doubleToRawLongBits(end.val) && --size!=0)
    {
      end=end.prev;
    }
    return size-1;
  ...
  {
    while(!Double.isNaN(end.val) && --size!=0)
    {
      end=end.prev;
    }
    return size-1;
  ...
  private static  int uncheckedsearchBits(Node begin,long bits)
  {
    int index=1;
    while(bits!=Double.doubleToRawLongBits(begin.val))
    {
  ...
  private static boolean uncheckedcontains(Node head,Node tail,double val)
  {
    if(val==(val))
    {
      return DoubleDblLnkSeq.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(val));
    }
    return DoubleDblLnkSeq.uncheckedcontainsNaN(head,tail);
  }
  private static int uncheckedindexOf(Node head,Node tail,double val)
  {
    if(val==(val))
    {
      return DoubleDblLnkSeq.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(val));
    }
    return DoubleDblLnkSeq.uncheckedindexOfNaN(head,tail);
  }
  private static int uncheckedlastIndexOf(Node head,int size,double val)
  {
    if(val==(val))
    {
      return DoubleDblLnkSeq.uncheckedlastIndexOfBits(head,size,Double.doubleToRawLongBits(val));
    }
    return DoubleDblLnkSeq.uncheckedlastIndexOfNaN(head,size);
  }
  private static int uncheckedsearch(Node head,double val)
  {
    if(val==(val))
    {
      return DoubleDblLnkSeq.uncheckedsearchBits(head,Double.doubleToRawLongBits(val));
    }
    return DoubleDblLnkSeq.uncheckedsearchNaN(head);
  }
  transient Node head;
  transient Node tail;
  ...
  private DoubleDblLnkSeq(Node onlyNode)
  {
    super(1);
    privateInit(onlyNode);
  }
  private DoubleDblLnkSeq(Node head,int size,Node tail)
  {
    super(size);
    this.head=head;
    this.tail=tail;
  ...
  @Override
  public final boolean add(final double val)
  {
    addLast((double)val);
    return true;
  }
  public final void addFirst(final double val)
  {
    push((double)val);
  }
  public final boolean offer(final double val)
  {
    addLast((double)val);
    return true;
  }
  public final boolean offerLast(final double val)
  {
    addLast((double)val);
    return true;
  }
  public final boolean offerFirst(final double val)
  {
    push((double)val);
    return true;
  }
  ...
  public final void addLast(final Double val)
  {
    addLast((double)val);
  }
  public final boolean offer(final Double val)
  ...
  public final void push(final Double val)
  {
    push((double)val);
  }
  abstract void pushtailHelper(Node oldtail,double val);
  ...
  abstract void pushheadHelper(Node oldhead,double val);
  ...
  {
    this.size=0;
    ((DoubleDblLnkSeq)this).privateInit(null);
  }
  @Override
  public boolean contains(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val)
      {
        return DoubleDblLnkSeq.uncheckedcontainsBits(head,tail,TypeUtil.DBL_TRUE_BITS);
      }
      return DoubleDblLnkSeq.uncheckedcontains0(head,tail);
    }
    return false;
  }
  @Override
  ...
  public boolean contains(final double val)
  {
    ...
    if((head=this.head)!=null)
    {
      return DoubleDblLnkSeq.uncheckedcontains(head,tail,(val));
    }
    return false;
  }
  @Override
  public int indexOf(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val)
      {
        return DoubleDblLnkSeq.uncheckedindexOfBits(head,tail,TypeUtil.DBL_TRUE_BITS);
      }
      return DoubleDblLnkSeq.uncheckedindexOf0(head,tail);
    }
    return -1;
  }
  @Override
  ...
  public int indexOf(final double val)
  {
    ...
    if((head=this.head)!=null)
    {
      return DoubleDblLnkSeq.uncheckedindexOf(head,tail,(val));
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final boolean val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val)
      {
        return DoubleDblLnkSeq.uncheckedlastIndexOfBits(tail,size,TypeUtil.DBL_TRUE_BITS);
      }
      return DoubleDblLnkSeq.uncheckedlastIndexOf0(tail,size);
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final int val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      ...
      {
        {
          return DoubleDblLnkSeq.uncheckedlastIndexOfBits(tail,size,Double.doubleToRawLongBits(val));
        }
      }
      else
      {
  ...
  public int lastIndexOf(final float val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      ...
      return DoubleDblLnkSeq.uncheckedlastIndexOfNaN(tail,size);
    }
    return -1;
  }
  @Override
  public int lastIndexOf(final double val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      return DoubleDblLnkSeq.uncheckedlastIndexOf(tail,size,(val));
    }
    return -1;
  }
  public int search(final boolean val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val)
      {
        return DoubleDblLnkSeq.uncheckedsearchBits(head,TypeUtil.DBL_TRUE_BITS);
      }
      return DoubleDblLnkSeq.uncheckedsearch0(head);
    }
    return -1;
  }
  ...
  public int search(final double val)
  {
    ...
    if((head=this.head)!=null)
    {
      return DoubleDblLnkSeq.uncheckedsearch(head,(val));
    }
    return -1;
  }
  @Override
  public boolean contains(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return DoubleDblLnkSeq.uncheckedcontains(head,tail,(double)(val));
      }
    }
    return false;
  }
  ...
  public int indexOf(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Double)
      {
        return DoubleDblLnkSeq.uncheckedindexOf(head,tail,(double)(val));
      }
    }
    return -1;
  }
  ...
  public int lastIndexOf(final Object val)
  {
    ...
    if((tail=this.tail)!=null)
    {
      if(val instanceof Double)
      {
        return DoubleDblLnkSeq.uncheckedlastIndexOf(tail,size,(double)(val));
      }
    }
    return -1;
  }
  public int search(final Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Double)
      {
        return DoubleDblLnkSeq.uncheckedsearch(head,(double)(val));
      }
    }
    return -1;
  }
  ...
  public void forEach(final Consumer<? super Double> action)
  {
    ...
    if((head=this.head)!=null)
    {
      head.uncheckedForEachForward(this.tail,(DoubleConsumer)action::accept);
    }
  }
  @Override
  ...
  abstract void initHelper(double val);
  @Override
  public int hashCode()
  {
    final Node head;
  ...
  private void uncheckedAddHelper(int headDist,int newSize,double val)
  {
    this.size=newSize;
    if(headDist==0)
    {
  ...
  private void collapsehead(Node head,Node tail,DoublePredicate filter)
  {
    int numRemoved;
    ...
    ((DoubleDblLnkSeq)this).privatesethead(head);
    this.size-=numRemoved;
  }
   void collapsetail(Node head,Node tail,DoublePredicate filter)
  {
    int numRemoved;
    ...
    ((DoubleDblLnkSeq)this).privatesettail(tail);
    this.size-=numRemoved;
  }
  boolean collapseBody(Node head,Node tail,DoublePredicate filter)
  {
    Node prev;
  ...
  void findNewHead(Node head,DoublePredicate filter)
  {
    final Node tail;
  ...
  public static class Checked extends DoubleDblLnkSeq implements OmniDeque.OfDouble
  {
    ...
    private OmniList.OfDouble getDefaultSubList(int headDist,int subListSize,int tailDist)
    {
    ...
    private OmniList.OfDouble getEmptySubList(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
    ...
    private OmniList.OfDouble getSubList1(int headDist,int tailDist)
    {
      if(tailDist==0)
      {
        if(headDist==0)
      ...
      return new SubList.BodyList(this,null,((DoubleDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
    }
    @Override
    void initHelper(double val)
    {
      ++this.modCount;
      this.size=1;
    ...
    @Override
    void pushheadHelper(Node oldhead,double val)
    {
      ++this.modCount;
      ++this.size;
      this.head=new Node(val,this.head);
    ...
    @Override
    void pushtailHelper(Node oldtail,double val)
    {
      ++this.modCount;
      ++this.size;
      this.tail=new Node(this.tail,val);
    ...
    public double popDouble()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node head;
        ((DoubleDblLnkSeq)this).privatechophead(head=this.head);
        return head.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public double removeLastDouble()
    {
      ...
      if((size=this.size)!=0)
      {
        ...
        ++this.modCount;
        Node tail;
        ((DoubleDblLnkSeq)this).privatechoptail(tail=this.tail);
        return tail.val;
      }
      throw new NoSuchElementException();
    }
    ...
    public double pollDouble()
    {
      ...
      if((head=this.head)!=null)
      {
        ++this.modCount;
        --this.size;
        ((DoubleDblLnkSeq)this).privatechophead(head);
        return (double)(head.val);
      }
      return Double.NaN;
    }
    ...
    public double pollLastDouble()
    {
      ...
      if((tail=this.tail)!=null)
      {
        ++this.modCount;
        --this.size;
        ((DoubleDblLnkSeq)this).privatechoptail(tail);
        return (double)(tail.val);
      }
      return Double.NaN;
    }
    ...
    private boolean uncheckedremoveValBits(Node head,long bits)
    {
      if(bits!=Double.doubleToRawLongBits(head.val))
      {
        ...
        if(head==tail)
        {
          ((DoubleDblLnkSeq)this).privatesettail(lastVisited);
        }
        else
        {
    ...
    private boolean uncheckedremoveLastOccurrenceBits(Node tail,long bits)
    {
      if(bits!=Double.doubleToRawLongBits(tail.val))
      {
        ...
        while(bits!=Double.doubleToRawLongBits(tail.val));
        --this.size;
        if(tail==head)
        {
          ((DoubleDblLnkSeq)this).privatesethead(lastVisited);
        }
        else
        {
    ...
    public boolean removeLastOccurrence(final boolean val)
    {
      ...
      if((tail=this.tail)!=null)
      {
        if(val)
        {
          return this.uncheckedremoveLastOccurrenceBits(tail,TypeUtil.DBL_TRUE_BITS);
        }
    ...
    public boolean removeLastOccurrence(final int val)
    {
      ...
      if((tail=this.tail)!=null)
      {
        ...
        {
          {
            return this.uncheckedremoveLastOccurrenceBits(tail,Double.doubleToRawLongBits(val));
          }
        }
        else
        {
    ...
    private boolean uncheckedremoveLastOccurrence(Node tail,double val)
    {
      if(val==val)
      {
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tail,DoublePredicate filter)
    {
    ...
    private void collapsehead(int modCount,Node head,Node tail,DoublePredicate filter)
    {
    ...
    private void collapsetail(int modCount,Node tail,Node head,DoublePredicate filter)
    {
      int oldSize,numConsumed;
    ...
    private static class SubList extends DoubleDblLnkSeq
    {
      private static class AscendingItr extends AbstractDoubleItr implements OmniIterator.OfDouble
      {
        ...
        public void forEachRemaining(Consumer<? super Double> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            ...
            try
            {
              cursor.uncheckedForEachForward(cursor=parent.tail,(DoubleConsumer)action::accept);
            }
            finally
            {
              CheckedCollection.checkModCount(modCount,parent.root.modCount);
      ...
      public boolean removeVal(final double val)
      {
        ...
        return false;
            ...
            void findNewHead(int modCount,Node curr,DoublePredicate filter)
            {
              final Node tail;
              ...
              ((DoubleDblLnkSeq)root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      private void collapseHeadAndTail(int modCount,Node head,Node tail,DoublePredicate filter)
      {
        ...
        for(;;)
        {
          ...
          if(!filter.test((head=head.next).val))
          {
            ...
            ((DoubleDblLnkSeq)root).privatesethead(head);
            ((DoubleDblLnkSeq)root).privatesettail(tail);
            break;
          }
        }
        root.modCount=modCount+1;
      ...
      boolean removeIfHelper(int modCount,Node curr,DoublePredicate filter)
      {
        final Node tail;
        if(curr!=(tail=this.tail))
        {
      ...
      private void prefixCollapsetail(int modCount,Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsetail(int modCount,Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void suffixCollapsehead(int modCount,Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(int modCount,Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      public void add(int index,double val)
      {
        ...
        {
          Node newNode;
          ((DoubleDblLnkSeq)root).privateInit(newNode=new Node(val));
      ...
      public double removeDoubleAt(int index)
      {
        ...
        if(--size!=0)
        {
          ...
          {
            Node newHead;
            ((DoubleDblLnkSeq)root).privatesethead(newHead=(node=this.head).next);
          ...
          else
          {
            ...
            {
              Node newTail;
              ((DoubleDblLnkSeq)root).privatesettail(newTail=(node=this.tail).prev);
      ...
      public void forEach(Consumer<? super Double> action)
      {
        ...
        try
        {
          super.forEach((DoubleConsumer)action::accept);
        }
        finally
        {
          CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      private OmniList.OfDouble getDefaultSubList(Checked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfDouble getEmptySubList(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfDouble getSubList1(Checked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
        ...
        return new SubList.BodyList(root,this,((DoubleDblLnkSeq)this).privateGetNode(headDist,tailDist),headDist);
      }
      @Override
      public OmniIterator.OfDouble iterator()
      {
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
          ++curr.modCount;curr.size=0;((DoubleDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void bubbleUpclearBody(Node oldhead,Node oldtail,int numRemoved)
      {
        ...
        for(;;)
        {
          ++curr.modCount;
          curr.size=0;
          ((DoubleDblLnkSeq)curr).privateInit(null);
          if((curr=curr.parent)==null)
          {
            return;
          }
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
          ++curr.modCount;curr.size=1;((DoubleDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      ...
      private void clearPrefix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((DoubleDblLnkSeq)root).privatesethead(newhead);
      ...
      private void clearSuffix(int numRemoved)
      {
        ...
        ++(root=this.root).modCount;
        root.size-=numRemoved;
        ((DoubleDblLnkSeq)root).privatesettail(newtail);
      ...
      private void uncheckedItrRemove(Node lastRet)
      {
        if(lastRet==tail)
        {
          ...
          else
          {
            ...
            ((DoubleDblLnkSeq)root).privatesettail(lastRet);
          }
        }
        else
        {
          if(lastRet==head)
          {
            ...
            ((DoubleDblLnkSeq)root).privatesethead(lastRet);
          }
          else
          {
            ((SubList)this).bubbleUpdecrementSize();
      ...
      void removeFirstHelper(int modCount,Node curr)
      {
        ...
        else
        {
          ...
          ((DoubleDblLnkSeq)root).privatesethead(curr);
        }
        --root.size;
      }
      boolean uncheckedremoveValBitsHelper(int modCount,Node curr,long bits)
      {
        final var root=this.root;
        final var tail=this.tail;
        Node prev;
        ...
        while(bits!=Double.doubleToRawLongBits((curr=(prev=curr).next).val));
        CheckedCollection.checkModCount(modCount,root.modCount);
        root.modCount=modCount+1;
        --root.size;
        if(curr==tail)
      ...
      void initHelper(Checked root,double val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
          ((DoubleDblLnkSeq)curr).privateInit(newNode);
          if((curr=curr.parent)==null)
          {
            ((DoubleDblLnkSeq)root).privateInit(newNode);
            return;
          }
        }
      }
      void prependHelper(double val)
      {
        ++this.modCount;
        Node newNode;
      ...
      private void insertHelper(Node before,double val,Node after)
      {
        ++this.modCount;
        new Node(before,val,after);
        SubList parent;
      ...
      private static class SuffixList extends SubList
      {
        ...
        void findNewHead(int modCount,Node curr,DoublePredicate filter)
        {
          ...
          ((DoubleDblLnkSeq)root).privatesettail(curr);
        }
      ...
      private static class BodyList extends PrefixList
      {
        ...
        {
          final Node newNode;
          ((DoubleDblLnkSeq)this).privateInit(newNode=new Node(val));
          SubList parent,curr;
          ...
          ((DoubleDblLnkSeq)root).subSeqInsertHelper(newNode,curr.getParentOffset());
        }
        private void bubbleUppushhead(Node oldhead,Node newNode)
        {
          SubList curr=this;
        ...
        private void collapseHeadAndTail(int modCount,final Node head,final Node tail,final DoublePredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
    ...
    private static class AscendingItr extends AbstractDoubleItr implements OmniIterator.OfDouble
    {
      ...
      public void forEachRemaining(Consumer<? super Double> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor=uncheckedForEach(cursor,root,(DoubleConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((DoubleDblLnkSeq)root).privatesethead(cursor);
        }
        else if(lastRet==root.tail)
        {
          ((DoubleDblLnkSeq)root).privatechoptail(lastRet);
        }
        else
        {
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      void uncheckedRemove(Node lastRet,Checked root)
      {
        ...
        {
          ((DoubleDblLnkSeq)root).privatechophead(lastRet);
        }
        else if(lastRet==root.tail)
        {
          ((DoubleDblLnkSeq)root).privatesettail(cursor);
        }
        else
        {
    ...
    private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfDouble
    {
      ...
      public void add(double val)
      {
        ...
        {
          ((DoubleDblLnkSeq)root).privateInit(new Node(val));
        }
        ++nextIndex;
        lastRet=null;
      }
      ...
      public void forEachRemaining(Consumer<? super Double> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          ...
          try
          {
            cursor.uncheckedForEachForward(cursor=root.tail,(DoubleConsumer)action::accept);
          }
          finally
          {
            CheckedCollection.checkModCount(modCount,root.modCount);
  ...
  static class Node
  {
    ...
    private int collapseBodyHelper(Checked.ModCountChecker modCountChecker,int numLeft,Node next,DoublePredicate filter)
    {
      int numRemoved=0;
    ...
    private int collapseBodyHelper(Node next,DoublePredicate filter)
    {
      int numRemoved=0;
    ...
    private void uncheckedForEachForward(Node end,DoubleConsumer action)
    {
    ...
    private void uncheckedForEachReverse(DoubleConsumer action)
    {
      for(var curr=this;;)
      {
        action.accept(curr.val);
    ...
    private void uncheckedReplaceAll(Node end,DoubleUnaryOperator operator)
    {
      for(var curr=this;;curr=curr.next)
      {
        curr.val=operator.applyAsDouble(curr.val);
        if(curr==end)
        {
          return;
        }
    ...
    private void copyFromArray(double[] src,int srcOffset,int length)
    {
      for(Node curr=this;;++srcOffset,curr=curr.next)
      {
        curr.val=(double)src[srcOffset];
        if(--length==0)
        {
          return;
        }
  ...
  public static class Unchecked extends DoubleDblLnkSeq implements OmniDeque.OfDouble
  {
    public Unchecked()
    {
      super();
    ...
    {
      this.size=1;
      ((DoubleDblLnkSeq)this).privateInit(new Node(val));
    }
    @Override
    public void add(int index,double val)
    {
    ...
    private static class AscendingItr extends AbstractDoubleItr implements OmniIterator.OfDouble
    {
      ...
      public void forEachRemaining(Consumer<? super Double> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachForward(root.tail,(DoubleConsumer)action::accept);
          this.cursor=null;
        }
      }
      @Override
    ...
    private static class DescendingItr extends AscendingItr
    {
      ...
      public void forEachRemaining(Consumer<? super Double> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          cursor.uncheckedForEachReverse((DoubleConsumer)action::accept);
          this.cursor=null;
        }
      }
    ...
    static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfDouble
    {
      ...
      public void forEachRemaining(Consumer<? super Double> action)
      {
        ...
        if((cursor=this.cursor)!=null)
        {
          Node bound;
          Unchecked root;
          cursor.uncheckedForEachForward(bound=(root=this.root).tail,(DoubleConsumer)action::accept);
          this.cursor=null;
          lastRet=bound;
          nextIndex=root.size;
        }
    ...
    private static class SubList extends DoubleDblLnkSeq
    {
      ...
      private static class AscendingItr extends AbstractDoubleItr implements OmniIterator.OfDouble
      {
        ...
        public void forEachRemaining(Consumer<? super Double> action)
        {
          ...
          if((cursor=this.cursor)!=null)
          {
            cursor.uncheckedForEachForward(parent.tail,(DoubleConsumer)action::accept);
            this.cursor=null;
          }
        }
        @Override
      ...
      private static class BidirectionalItr extends AscendingItr implements OmniListIterator.OfDouble
      {
        ...
        public void forEachRemaining(Consumer<? super Double> action)
        {
          ...
          {
            SubList parent;
            cursor.uncheckedForEachForward(cursor=(parent=this.parent).tail,(DoubleConsumer)action::accept);
            nextIndex=parent.size;
            this.cursor=null;
            lastRet=cursor;
          }
      ...
      private void bubbleUpclearRoot()
      {
        ...
        do
        {
           curr.size=0;((DoubleDblLnkSeq)curr).privateInit(null);
        }
        while((curr=curr.parent)!=null);
      }
      private void bubbleUpincrementSize()
      ...
      private void bubbleUpinit(Node newNode)
      {
        ...
        do
        {
           curr.size=1;((DoubleDblLnkSeq)curr).privateInit(newNode);
        }
        while((curr=curr.parent)!=null);
      }
      @Override
      ...
      boolean uncheckedremoveValBitsHelper(Node curr,long bits)
      {
        final var root=this.root;
        final var tail=this.tail;
        Node prev;
      ...
      private OmniList.OfDouble getDefaultSubList(Unchecked root,int headDist,int subListSize,int tailDist)
      {
        final Node subListHead=head;
        Node subListTail=tail;
        if(tailDist==0)
      ...
      private OmniList.OfDouble getEmptySubList(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private OmniList.OfDouble getSubList1(Unchecked root,int headDist,int tailDist)
      {
        if(tailDist==0)
        {
          if(headDist==0)
      ...
      private void suffixCollapsehead(Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void rootCollapsehead(Node head,Node tail,DoublePredicate filter)
      {
        final int oldSize=this.size;
        int numConsumed=2;
        final var root=this.root;
      ...
      private void clearBody(int numRemoved)
      {
        ...
        bubbleUpclearBody(this.head,this.tail,numRemoved);
            ...
            void findNewHead(Node curr,DoublePredicate filter)
            {
              final Node tail;
              if(curr!=(tail=this.tail))
              {
              ...
              final DoubleDblLnkSeq root;(root=this.root).privateInit(null);
              root.size=0;
              bubbleUpclearRoot();
            }
      void collapseTail(Node head,Node tail,DoublePredicate filter)
      ...
      @Override
      boolean collapseBody(Node prev,Node next,DoublePredicate filter)
      {
      ...
      void initHelper(Unchecked root,double val)
      {
        final var newNode=new Node(val);
        for(var curr=this;;curr.size=1)
        {
      ...
      private static class PrefixList extends SubList
      {
        ...
        private OmniList.OfDouble getEmptySubList(Unchecked root,int headDist)
        {
          if(headDist==0)
          {
            return new SubList.PrefixList(root,this);
      ...
      private static class BodyList extends PrefixList
      {
        ...
        private void collapseHeadAndTail(final Node head,final Node tail,final DoublePredicate filter)
        {
          final int oldSize=this.size;
          int numConsumed=2;
          var headCandidate=head;
