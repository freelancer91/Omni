   ...
   DoubleSubListDefault
{
  ...
  private static class CheckedSubList extends DoubleDblLnkSeq{
    ...
    private static  void pullSurvivorsDown(DoubleDblLnkNode prev,DoubleDblLnkNode next,long[] survivorSet,int numSurvivors,int numRemoved){
      int wordOffset;
    ...
    private static  void pullSurvivorsDown(DoubleDblLnkNode prev,DoubleDblLnkNode next,long word,int numSurvivors,int numRemoved){
