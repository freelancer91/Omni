   ...
   DoubleSubListDefault
{
  static final class Node{
    ...
    static  void uncheckedCopyFrom(double[] src,int length,Node dst){
      for(;;dst=dst.prev)
      {
    ...
    static  void uncheckedToString(Node curr,Node tail,StringBuilder builder){
    ...
    static  void uncheckedForEachAscending(Node node,int size,DoubleConsumer action){
      for(;;node=node.next){
    ...
    static  void uncheckedReplaceAll(Node node,int size,DoubleUnaryOperator operator){
      for(;;node=node.next){
    ...
    static  void uncheckedForEachAscending(Node node,DoubleConsumer action){
      for(;;){
        action.accept(node.val);
    ...
    static  void uncheckedForEachAscending(Node node,Node tail,DoubleConsumer action){
      for(;;node=node.next){
        action.accept(node.val);
        if(node==tail){
          return;
    ...
    static  void uncheckedReplaceAll(Node node,Node tail,DoubleUnaryOperator operator){
      for(;;node=node.next){
        node.val=operator.applyAsDouble(node.val);
        if(node==tail){
          return;
    ...
    static  void uncheckedForEachDescending(Node node,DoubleConsumer action){
      for(;;){
        action.accept(node.val);
    ...
    static  void uncheckedForEachDescending(Node node,int size,DoubleConsumer action){
      for(;;node=node.prev){
        action.accept(node.val);
        if(--size==0){
          return;
  ...
  private static  int markSurvivors(Node curr,int numLeft,DoublePredicate filter,long[] survivorSet){
  ...
  private static  long markSurvivors(Node curr,int numLeft,DoublePredicate filter){
  ...
  @Override public void sort(DoubleComparator sorter){
    ...
    if((size=this.size)>1){
      final double[] tmp;
      final Node tail;
      Node.uncheckedCopyInto(tmp=new double[size],tail=this.tail,size);
      if(sorter==null){
    ...
    {
      {
        ...
        {
          if(val){
            return Node.uncheckedcontainsBits(head,tail,TypeUtil.DBL_TRUE_BITS);
          }
    ...
    {
      {
        ...
        if((head=this.head)!=null)
        {
          if(val!=0){
            {
              return Node.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(val));
            }
          }else{
            return Node.uncheckedcontains0(head,tail);
          }
        ...
        if((head=this.head)!=null)
        {
          ...
          returnFalse:for(;;){
            if(val instanceof Double){
              final double d;
              if((d=(double)val)==d){
                 return Node.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(d));
              }
              return Node.uncheckedcontainsNaN(head,tail);
            }else if(val instanceof Float){
              final float f;
              if((f=(float)val)==f){
                 return Node.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(f));
              }
              return Node.uncheckedcontainsNaN(head,tail);
            }else if(val instanceof Integer|| val instanceof Short||val instanceof Byte){
              final int i;
              if((i=((Number)val).intValue())!=0){
                return Node.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(i));
              }
              return Node.uncheckedcontains0(head,tail);
              ...
              if((l=(long)val)!=0){
                ...
                return Node.uncheckedcontainsBits(head,tail,Double.doubleToRawLongBits(l));
              }
              return Node.uncheckedcontains0(head,tail);
    ...
    {
      {
        ...
        {
          if(val){
            return Node.uncheckedindexOfBits(head,tail,TypeUtil.DBL_TRUE_BITS);
          }
    ...
    {
      {
        ...
        if((head=this.head)!=null)
        {
          if(val!=0){
            {
              return Node.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(val));
            }
          }else{
            return Node.uncheckedindexOf0(head,tail);
          }
        ...
        if((head=this.head)!=null)
        {
          ...
          returnFalse:for(;;){
            if(val instanceof Double){
              final double d;
              if((d=(double)val)==d){
                 return Node.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(d));
              }
              return Node.uncheckedindexOfNaN(head,tail);
            }else if(val instanceof Float){
              final float f;
              if((f=(float)val)==f){
                 return Node.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(f));
              }
              return Node.uncheckedindexOfNaN(head,tail);
            }else if(val instanceof Integer|| val instanceof Short||val instanceof Byte){
              final int i;
              if((i=((Number)val).intValue())!=0){
                return Node.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(i));
              }
              return Node.uncheckedindexOf0(head,tail);
            }else if(val instanceof Long){
              final long l;
              if((l=(long)val)!=0){
                ...
                return Node.uncheckedindexOfBits(head,tail,Double.doubleToRawLongBits(l));
              }
              return Node.uncheckedindexOf0(head,tail);
            }else if(val instanceof Character){
              final int i;
    ...
    {
      {
        ...
        {
          if(val){
            return Node.uncheckedlastIndexOfBits(size,tail,TypeUtil.DBL_TRUE_BITS);
          }
    ...
    {
      {
        ...
        if((tail=this.tail)!=null)
        {
          if(val!=0){
            {
              return Node.uncheckedlastIndexOfBits(size,tail,Double.doubleToRawLongBits(val));
            }
          }else{
            return Node.uncheckedlastIndexOf0(size,tail);
          }
        ...
        if((tail=this.tail)!=null)
        {
          ...
          returnFalse:for(;;){
            if(val instanceof Double){
              final double d;
              if((d=(double)val)==d){
                 return Node.uncheckedlastIndexOfBits(size,tail,Double.doubleToRawLongBits(d));
              }
              return Node.uncheckedlastIndexOfNaN(size,tail);
            }else if(val instanceof Float){
              final float f;
              if((f=(float)val)==f){
                 return Node.uncheckedlastIndexOfBits(size,tail,Double.doubleToRawLongBits(f));
              }
              return Node.uncheckedlastIndexOfNaN(size,tail);
            }else if(val instanceof Integer|| val instanceof Short||val instanceof Byte){
              final int i;
              if((i=((Number)val).intValue())!=0){
                return Node.uncheckedlastIndexOfBits(size,tail,Double.doubleToRawLongBits(i));
              }
              return Node.uncheckedlastIndexOf0(size,tail);
            }else if(val instanceof Long){
              final long l;
              if((l=(long)val)!=0){
                ...
                return Node.uncheckedlastIndexOfBits(size,tail,Double.doubleToRawLongBits(l));
              }
              return Node.uncheckedlastIndexOf0(size,tail);
            }else if(val instanceof Character){
              final int i;
  ...
  private static  int collapseBodyHelper(Node newHead,Node newTail,DoublePredicate filter){
    int numRemoved=0;
  ...
  static class UncheckedSubList extends DoubleDblLnkSeq{
    ...
    private void collapsehead(Node oldhead,Node tail,DoublePredicate filter
    ){
      int numRemoved=1;
      Node newhead;
      outer:
    ...
    private void collapsetail(Node oldtail,Node head,DoublePredicate filter
    ){
      int numRemoved=1;
      Node newtail;
      outer:
    ...
    private boolean collapseBody(Node head,Node tail,DoublePredicate filter
    ){
  ...
  static class CheckedSubList extends DoubleDblLnkSeq{
    ...
    private static class SerializableSubList implements Serializable{
      ...
      private void readObject(ObjectInputStream ois) throws IOException
      {
        ...
        if(size!=0){
          Node curr;
          for(this.head=curr=new Node((double)ois.readDouble());--size!=0;curr=curr.next=new Node(curr,(double)ois.readDouble())){}
          this.tail=curr;
        }
      }
    ...
    private static  int collapseBodyHelper(Node newHead,Node newTail,int numLeft,DoublePredicate filter,CheckedList.ModCountChecker modCountChecker)
    {
      if(numLeft!=0){
        int numSurvivors;
        if(numLeft>64){
  ...
  public static class CheckedList extends UncheckedList{
    ...
    private boolean isEqualTo(Node thisHead,int size,OmniList.OfDouble list){
      if(list instanceof DoubleDblLnkSeq){
        final DoubleDblLnkSeq dls;
        if((dls=(DoubleDblLnkSeq)list) instanceof DoubleDblLnkSeq.CheckedSubList){
          final DoubleDblLnkSeq.CheckedSubList subList;
  ...
  public static class UncheckedList extends DoubleDblLnkSeq implements OmniDeque.OfDouble,Externalizable{
    ...
    @Override public void readExternal(ObjectInput in) throws IOException
    {
      ...
      if(size!=0){
        Node curr;
        for(this.head=curr=new Node((double)in.readDouble());--size!=0;curr=curr.next=new Node(curr,(double)in.readDouble())){}
        this.tail=curr;
      }
    }
    @Override public Object clone(){
    ...
    boolean uncheckedRemoveIf(Node head,DoublePredicate filter){
      if(filter.test(head.val)){
    ...
    private static class DescendingItr extends AscendingItr{
      ...
      @Override void uncheckedForEachRemaining(Node curr,DoubleConsumer action){
      ...
      extends AbstractDoubleItr
    {
      ...
      void uncheckedForEachRemaining(Node curr,DoubleConsumer action){
