...
public class ShortArrDeq implements OmniDeque.OfShort,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends ShortArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void nonfragmentedPullSurvivorsUp(short[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void nonfragmentedPullSurvivorsDown(short[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
      ...
      @Override void fragmentedPullSurvivorsDownToNonFragmented(short[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
      @Override void fragmentedPullSurvivorsDown(short[] arr,int dstOffset,int numToSkip,int dstBound){
        //TODO
        throw new UnsupportedOperationException();
      }
    }
    ...
    private static abstract class CollapseData{
      ...
      abstract void nonfragmentedPullSurvivorsUp(short[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void nonfragmentedPullSurvivorsDown(short[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDownToNonFragmented(short[] arr,int dstOffset,int numToSkip,int dstBound);
      abstract void fragmentedPullSurvivorsDown(short[] arr,int dstOffset,int numToSkip,int dstBound);
    }
