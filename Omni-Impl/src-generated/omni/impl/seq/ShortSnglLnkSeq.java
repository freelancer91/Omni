...
public abstract class ShortSnglLnkSeq 
extends AbstractSeq.Of16BitPrimitive
implements OmniCollection.OfShort
{
  transient Node head;
  ...
  private ShortSnglLnkSeq(Node onlyNode)
  {
    super(1);
    this.head=onlyNode;
  }
  ...
  public boolean contains(Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      ...
      {
        return head.uncheckedcontains((short)(val));
      }
    }
    return false;
  }
  public int search(Object val)
  {
    ...
    if((head=this.head)!=null)
    {
      if(val instanceof Short)
      {
        return head.uncheckedsearch((short)(val));
      }
    }
    return -1;
  }
  ...
  public static class Stack extends ShortSnglLnkSeq implements OmniStack.OfShort
  {
    public Stack()
    {
      super();
    ...
    private void uncheckedRemoveIfHelper(Node prev,Node curr,ShortPredicate filter)
    {
      int numRemoved=1;
    ...
    @Override
    boolean uncheckedRemoveIf(Node curr,ShortPredicate filter)
    {
      if(filter.test(curr.val))
      {
        while((curr=curr.next)!=null)
    ...
    public static class Checked extends Stack
    {
      ...
      private void uncheckedRemoveIfHelper(int modCount,int numLeft,Node prev,Node curr,ShortPredicate filter)
      {
        int numRemoved=1;
        for(;;)
        {
  ...
  public static class Queue extends ShortSnglLnkSeq implements OmniQueue.OfShort
  {
    transient Node tail;
    public Queue()
    {
    ...
    private int uncheckedRemoveIfHelper(Node curr,ShortPredicate filter)
    {
      int numSurvivors=1;
    ...
    public static class Checked extends Queue
    {
      ...
      private int uncheckedRemoveIfHelper(int modCount,int numLeft,Node curr,ShortPredicate filter)
      {
        int numSurvivors=1;
  ...
  static class Node
  {
    private int countNumRemainingNodes(CheckedCollection.AbstractModCountChecker modCountChecker,int numLeft,ShortPredicate filter)
    {
      int numSurvivors=1;
    ...
    private int countNumRemovedNodes(CheckedCollection.AbstractModCountChecker modCountChecker,int numLeft,ShortPredicate filter)
    {
    ...
    private int countNumRemovedNodes(ShortPredicate filter)
    {
      int numRemoved=0;
    ...
    private int countNumRemainingNodes(ShortPredicate filter)
    {
      int numLeft=1;
    ...
    private void uncheckedForEachForward(ShortConsumer action)
    {
      var curr=this;
      do
      {
