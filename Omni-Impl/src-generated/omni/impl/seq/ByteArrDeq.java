...
public class ByteArrDeq implements OmniDeque.OfByte,Externalizable,Cloneable,RandomAccess{
  ...
  public static class Checked extends ByteArrDeq{
    ...
    private static class BigCollapseData extends CollapseData{
      ...
      @Override void fragmentedCollapseBiggestRunInHead(int head,ByteArrDeq deq,int tail){
        int overflow;
        int biggestRunEnd;
        int arrLength;
        int biggestRunBegin;
      ...
      @Override void fragmentedCollapseBiggestRunInTail(int head,ByteArrDeq deq,int tail){
        int biggestRunBegin;
      ...
      private void fragmentedPullSurvivorsUpToNonFragmented(byte[] arr,int dstOffset,int numToSkip,int dstBound){
      ...
      private void fragmentedPullSurvivorsUp(byte[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset,s;
        long[] survivorSet;
        long word=(survivorSet=this.survivorSet)[wordOffset=numToSkip>>6]<<(-(numToSkip+1));
        int srcOffset=(s=dstOffset-1)-(((numToSkip)&63)+1);
      ...
      private void fragmentedPullSurvivorsDown(byte[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset,s;
        long[] survivorSet;
      ...
      private void fragmentedPullSurvivorsDownToNonFragmented(byte[] arr,int dstOffset,int numToSkip,int dstBound){
      ...
      private void nonfragmentedPullSurvivorsUp(byte[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
        long word=(survivorSet=this.survivorSet)[wordOffset=numToSkip>>6]<<(-(numToSkip+1));
      ...
      private void nonfragmentedPullSurvivorsDown(byte[] arr,int dstOffset,int numToSkip,int dstBound){
        int wordOffset;
        long[] survivorSet;
        long word=(survivorSet=this.survivorSet)[wordOffset=numToSkip>>6]>>>numToSkip;
      ...
      @Override void nonfragmentedCollapse(int head,ByteArrDeq deq,int tail){
    ...
    private static class SmallCollapseData extends CollapseData{
      private static void fragmentedPullSurvivorsDownHelper(byte[] arr,int dstOffset,int srcOffset,long word){
      ...
      private static void fragmentedPullSurvivorsUpHelper(byte[] arr,int dstOffset,int srcOffset,long word)
      {
        for(;;)
        {
      ...
      private static void fragmentedPullSurvivorsDown(byte[] arr,int dstOffset,long word)
      {
        int numToSkip;
      ...
      private static void fragmentedPullSurvivorsUp(byte[] arr,int dstOffset,long word)
      {
        int lead0s;
      ...
      private static void fragmentedPullSurvivorsDownToNonFragmented(byte[] arr,int dstOffset,long word){
      ...
      private static void fragmentedPullSurvivorsUpToNonFragmented(byte[] arr,int dstOffset,long word)
      {
      ...
      private static void finalizeNonfragmentedPullUp(byte[] arr,int dstOffset,int srcOffset,long word){
        for(;;){
          int lead0s;
      ...
      private static void finalizeNonfragmentedPullDown(byte[] arr,int dstOffset,int srcOffset,long word){
        for(;;){
          int numToRetain;
      ...
      private static void finalizeFragmentedPullUp(byte[] arr,int dstOffset,int srcOffset,long word)
      {
        for(;;)
        {
          int lead0s;
      ...
      private static void nonfragmentedPullSurvivorsDown(byte[] arr,int dstOffset,long word){
        int numToSkip;
      ...
      private static void nonfragmentedPullSurvivorsUp(byte[] arr,int dstOffset,long word)
      {
        int lead0s;
        for(int srcOffset=dstOffset-1-(lead0s=Long.numberOfLeadingZeros(word));;)
        {
      ...
      @Override void fragmentedCollapseBiggestRunInHead(int head,final ByteArrDeq deq,int tail){
        int overflow;
        int biggestRunEnd;
        int arrLength;
        int biggestRunBegin;
    ...
    private static abstract class CollapseData{
      ...
      abstract void fragmentedCollapseBiggestRunInHead(int head,ByteArrDeq deq,int tail);
      abstract void fragmentedCollapseBiggestRunInTail(int head,ByteArrDeq deq,int tail);
      abstract void nonfragmentedCollapse(int head,ByteArrDeq deq,int tail);
    ...
    private static class AscendingItr extends AbstractDeqItr{
      ...
      @Override void uncheckedForEachRemaining(final int expectedCursor,ByteConsumer action){
        int modCount=this.modCount;
        final Checked root;
