...
public class BooleanSetImpl implements OmniSet.OfBoolean,Cloneable,Externalizable{
  ...
  @Override public boolean equals(Object val){
    ...
    if(val instanceof Set){
      //TODO optimize
      final Set<?> set;
      if((set=(Set<?>)val) instanceof BooleanSetImpl){
        return ((BooleanSetImpl)set).state==this.state;
      }else if(set instanceof RefOpenAddressHashSet){
        var refOpenAddressHashSet=(RefOpenAddressHashSet<?>)set;
        switch(state){
        case 0b00:
          return refOpenAddressHashSet.size==0;
        case 0b01:
          return refOpenAddressHashSet.size==1 && refOpenAddressHashSet.tableContains(Boolean.FALSE,1237);
        case 0b10:
          return refOpenAddressHashSet.size==1 && refOpenAddressHashSet.tableContains(Boolean.TRUE,1231);
        default:
          return refOpenAddressHashSet.size==2 && refOpenAddressHashSet.tableContains(Boolean.FALSE,1237) && refOpenAddressHashSet.tableContains(Boolean.TRUE,1231);
        }
      }else{
        switch(state){
        case 0b00:
