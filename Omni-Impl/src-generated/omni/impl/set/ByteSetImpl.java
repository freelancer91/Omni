...
public abstract class ByteSetImpl extends AbstractByteSet.ComparatorlessImpl implements Cloneable{
  ...
  public abstract static class Unchecked extends ByteSetImpl implements Serializable{
    ...
    private void uncheckedForEachAscending(int inclLo,int inclHi,ByteConsumer action){
      switch(inclLo>>6){
        case -2:
          switch(inclHi>>6){
          case -2:
            Ascending.uncheckedWordForEach(this.word0,inclLo,inclHi+1,action);
            break;
          case -1:
            Ascending.uncheckedWordForEach(this.word0,inclLo,-64,action);
            Ascending.uncheckedWordForEach(this.word1,-64,inclHi+1,action);
            break;
          case 0:
            Ascending.uncheckedWordForEach(this.word0,inclLo,-64,action);
            Ascending.uncheckedWordForEach(this.word1,-64,0,action);
            Ascending.uncheckedWordForEach(this.word2,0,inclHi+1,action);
            break;
          default:
            Ascending.uncheckedWordForEach(this.word0,inclLo,-64,action);
            Ascending.uncheckedWordForEach(this.word1,-64,0,action);
            Ascending.uncheckedWordForEach(this.word2,0,64,action);
            Ascending.uncheckedWordForEach(this.word3,64,inclHi+1,action);
          }
          break;
        case -1:
          switch(inclHi>>6){
          case -1:
            Ascending.uncheckedWordForEach(this.word1,inclLo,inclHi+1,action);
            break;
          case 0:
            Ascending.uncheckedWordForEach(this.word1,inclLo,0,action);
            Ascending.uncheckedWordForEach(this.word2,0,inclHi+1,action);
            break;
          default:
            Ascending.uncheckedWordForEach(this.word1,inclLo,0,action);
        ...
        case 0:
          if(inclHi>>6==0){
            Ascending.uncheckedWordForEach(this.word2,inclLo,inclHi+1,action);
          }else{
            Ascending.uncheckedWordForEach(this.word2,inclLo,64,action);
            Ascending.uncheckedWordForEach(this.word3,64,inclHi+1,action);
          }
          break;
        default:
          Ascending.uncheckedWordForEach(this.word3,inclLo,inclHi+1,action);
      }
    }
    ...
    private void uncheckedForEachDescending(int inclLo,int inclHi,ByteConsumer action){
      switch(inclHi>>6){
        case 1:
          switch(inclLo>>6){
          case 1:
            Descending.uncheckedWordForEach(this.word3,inclHi,inclLo-1,action);
            break;
          case 0:
            Descending.uncheckedWordForEach(this.word3,inclHi,63,action);
            Descending.uncheckedWordForEach(this.word2,63,inclLo-1,action);
            break;
          case -1:
            Descending.uncheckedWordForEach(this.word3,inclHi,63,action);
            Descending.uncheckedWordForEach(this.word2,63,-1,action);
            Descending.uncheckedWordForEach(this.word1,-1,inclLo-1,action);
            break;
          default:
            Descending.uncheckedWordForEach(this.word3,inclHi,63,action);
            Descending.uncheckedWordForEach(this.word2,63,-1,action);
            Descending.uncheckedWordForEach(this.word1,-1,-65,action);
            Descending.uncheckedWordForEach(this.word0,-65,inclLo-1,action);
          }
          break;
        case 0:
          switch(inclLo>>6){
          case 0:
            Descending.uncheckedWordForEach(this.word2,inclHi,inclLo-1,action);
            break;
          case -1:
            Descending.uncheckedWordForEach(this.word2,inclHi,-1,action);
            Descending.uncheckedWordForEach(this.word1,-1,inclLo-1,action);
            break;
          default:
            Descending.uncheckedWordForEach(this.word2,inclHi,-1,action);
        ...
        case -1:
          if(inclLo>>6==-1){
            Descending.uncheckedWordForEach(this.word1,inclHi,inclLo-1,action);
          }else{
            Descending.uncheckedWordForEach(this.word1,inclLo,-65,action);
            Descending.uncheckedWordForEach(this.word0,-65,inclLo-1,action);
          }
          break;
        default:
          Descending.uncheckedWordForEach(this.word0,inclHi,inclLo-1,action);
      }
    }
  ...
  private int getLowestIndex(){
    int currIndex;
    if((currIndex=Long.numberOfTrailingZeros(this.word0))==64){
      if((currIndex+=Long.numberOfTrailingZeros(this.word1))==128){
        if((currIndex+=Long.numberOfTrailingZeros(this.word2))==192){
          currIndex+=Long.numberOfTrailingZeros(this.word3);
        }
      }
    }
    return Byte.MIN_VALUE+currIndex;
  }
  private int getHighestIndex(){
    int currIndex;
    if((currIndex=Long.numberOfLeadingZeros(this.word3))==64){
      if((currIndex+=Long.numberOfLeadingZeros(this.word2))==128){
        if((currIndex+=Long.numberOfLeadingZeros(this.word1))==192){
          currIndex+=Long.numberOfLeadingZeros(this.word0);
        }
      }
    }
    return Byte.MAX_VALUE-currIndex;
  }
  private int getLowestIndex(int inclLo){
    int index;
    goToWord3:for(;;){
      goToWord2:for(;;){
        switch(inclLo>>6){
          default:
            return 64+Long.numberOfTrailingZeros(this.word3&(-1L<<inclLo));
          case 0:
            if((index=Long.numberOfTrailingZeros(this.word2&(-1L<<inclLo)))!=64){
              return index;
            }
            break goToWord3;
           case -1:
            if((index=-64+Long.numberOfTrailingZeros(this.word1&(-1L<<inclLo)))!=0){
              return index;
            }
            break goToWord2;
          case -2:
            if((index=Byte.MIN_VALUE+Long.numberOfTrailingZeros(this.word0&(-1L<<inclLo)))!=-64){
              return index;
            }
        }
        index+=Long.numberOfTrailingZeros(this.word1);
        break;
      }
      index+=Long.numberOfTrailingZeros(this.word2);
      break;
    }
    return index+Long.numberOfTrailingZeros(this.word3);
  }
  private int getHighestIndex(int inclHi){
    int index;
    goToWord0:for(;;){
      goToWord1:for(;;){
        switch(inclHi>>6){
          default:
            return -65-Long.numberOfLeadingZeros(this.word0&(-1L>>>(-inclHi-1)));
          case -1:
            if((index=-Long.numberOfLeadingZeros(this.word1&(-1L>>>(-inclHi-1))))!=-65){
              return index;
            }
            break goToWord0;
          case 0:
            if((index=63-Long.numberOfLeadingZeros(this.word2&(-1L>>>(-inclHi-1))))!=-1){
              return index;
            }
            break goToWord1;
          case 1:
            if((index=Byte.MAX_VALUE-Long.numberOfLeadingZeros(this.word3&(-1L>>>(-inclHi-1))))!=63){
              return index;
            }
        }
        index-=Long.numberOfLeadingZeros(this.word2);
        break;
      }
      index-=Long.numberOfLeadingZeros(this.word1);
      break;
    }
    return index-Long.numberOfLeadingZeros(this.word0);
  }
  private static class UncheckedAscendingSubItr extends AbstractByteItr{
    transient final UncheckedSubSet parent;
    transient final int inclBound;
    transient int currIndex;
    private UncheckedAscendingSubItr(UncheckedSubSet parent,int inclBound,int currIndex){
      this.parent=parent;
      this.inclBound=inclBound;
      this.currIndex=currIndex;
    }
    @Override public Object clone(){
      return new UncheckedAscendingSubItr(parent,inclBound,currIndex);
    }
    @Override public boolean hasNext(){
      return currIndex<=inclBound;
    }
    @Override public byte nextByte(){
      final int ret;
      this.currIndex=((ByteSetImpl)parent.root).getLowestIndex((ret=this.currIndex)+1);
      return (byte)ret;
    }
    @Override public void forEachRemaining(ByteConsumer action){
      final int currIndex,inclBound;
      if((currIndex=this.currIndex)<=(inclBound=this.inclBound)){
        parent.root.uncheckedForEachAscending(currIndex,inclBound,action);
        this.currIndex=inclBound+1;
      }
    }
    @Override public void forEachRemaining(Consumer<? super Byte> action){
      final int currIndex,inclBound;
      if((currIndex=this.currIndex)<=(inclBound=this.inclBound)){
        parent.root.uncheckedForEachAscending(currIndex,inclBound,action::accept);
        this.currIndex=inclBound+1;
      }
    }
    @Override public void remove(){
      final UncheckedSubSet parent;
  ...
  private static class UncheckedDescendingSubItr extends AbstractByteItr{
    transient final UncheckedSubSet parent;
    transient final int inclBound;
    transient int currIndex;
    private UncheckedDescendingSubItr(UncheckedSubSet parent,int inclBound,int currIndex){
      this.parent=parent;
      this.inclBound=inclBound;
      this.currIndex=currIndex;
    }
    @Override public Object clone(){
      return new UncheckedDescendingSubItr(parent,inclBound,currIndex);
    }
    @Override public boolean hasNext(){
      return currIndex>=inclBound;
    }
    @Override public byte nextByte(){
      final int ret;
      this.currIndex=((ByteSetImpl)parent.root).getHighestIndex((ret=this.currIndex)-1);
      return (byte)ret;
    }
    @Override public void forEachRemaining(ByteConsumer action){
      final int currIndex,inclBound;
      if((currIndex=this.currIndex)>=(inclBound=this.inclBound)){
        parent.root.uncheckedForEachDescending(inclBound,currIndex,action);
        this.currIndex=inclBound-1;
      }
    }
    @Override public void forEachRemaining(Consumer<? super Byte> action){
      final int currIndex,inclBound;
      if((currIndex=this.currIndex)>=(inclBound=this.inclBound)){
        parent.root.uncheckedForEachDescending(inclBound,currIndex,action::accept);
        this.currIndex=inclBound-1;
      }
    }
    @Override public void remove(){
  ...
  private static class UncheckedAscendingItr extends AbstractByteItr{
    ...
    private UncheckedAscendingItr(ByteSetImpl.Unchecked root){
      this.root=root;
      this.currIndex=((ByteSetImpl)root).getLowestIndex();
    }
  ...
  private static class UncheckedDescendingItr extends AbstractByteItr{
    ...
    private UncheckedDescendingItr(ByteSetImpl.Unchecked root){
      this.root=root;
      this.currIndex=((ByteSetImpl)root).getHighestIndex();
    }
  ...
  private static class CheckedAscendingItr extends AbstractByteItr{
    ...
    private CheckedAscendingItr(ByteSetImpl.Checked root){
      this.root=root;
      final int modCountAndSize;
      this.currIndexAndNumLeft=(((ByteSetImpl)root).getLowestIndex()<<9)|((modCountAndSize=root.modCountAndSize)&(0x1ff));
      this.modCountAndLastRet=modCountAndSize|0x1ff;
    }
  ...
  private static class CheckedDescendingItr extends AbstractByteItr{
    ...
    private CheckedDescendingItr(ByteSetImpl.Checked root){
      this.root=root;
      final int modCountAndSize;
      this.currIndexAndNumLeft=(((ByteSetImpl)root).getHighestIndex()<<9)|((modCountAndSize=root.modCountAndSize)&(0x1ff));
      this.modCountAndLastRet=modCountAndSize|0x1ff;
    }
    ...
    private static abstract class HeadSet extends UncheckedSubSet{
      ...
      private static class Ascending extends HeadSet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          return new UncheckedDescendingSubItr(this,0,((ByteSetImpl)root).getHighestIndex(this.boundInfo));
        }
        @Override public OmniIterator.OfByte iterator(){
          if(size==0){
            return AbstractByteSet.EmptyView.EMPTY_ITR;
          }
          return new UncheckedAscendingSubItr(this,this.boundInfo,((ByteSetImpl)root).getLowestIndex());
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
    ...
    private static abstract class TailSet extends UncheckedSubSet{
      ...
      private static class Ascending extends TailSet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          return new UncheckedDescendingSubItr(this,this.boundInfo,((ByteSetImpl)root).getHighestIndex());
        }
        @Override public OmniIterator.OfByte iterator(){
          if(size==0){
            return AbstractByteSet.EmptyView.EMPTY_ITR;
          }
          return new UncheckedAscendingSubItr(this,0,((ByteSetImpl)root).getLowestIndex(this.boundInfo));
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
    ...
    private static abstract class BodySet extends UncheckedSubSet{
      ...
      private static class Ascending extends BodySet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          final int boundInfo;
          return new UncheckedDescendingSubItr(this,(byte)(boundInfo=this.boundInfo),((ByteSetImpl)root).getHighestIndex(boundInfo>>8));
        }
        @Override public OmniIterator.OfByte iterator(){
          if(size==0){
            return AbstractByteSet.EmptyView.EMPTY_ITR;
          ...
          final int boundInfo;
          return new UncheckedAscendingSubItr(this,(boundInfo=this.boundInfo)>>8,((ByteSetImpl)root).getLowestIndex((byte)boundInfo));
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
    ...
    private static abstract class HeadSet extends CheckedSubSet{
      ...
      private static class Ascending extends HeadSet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          return new CheckedDescendingSubItr(this,(((ByteSetImpl)root).getHighestIndex(this.boundInfo)<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniIterator.OfByte iterator(){
          final ByteSetImpl.Checked root;
          final int modCountAndSize;
          ...
          return new CheckedAscendingSubItr(this,(((ByteSetImpl)root).getLowestIndex()<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
          final int modCountAndSize;
    ...
    private static abstract class TailSet extends CheckedSubSet{
      ...
      private static class Ascending extends TailSet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          return new CheckedDescendingSubItr(this,(((ByteSetImpl)root).getHighestIndex()<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniIterator.OfByte iterator(){
          final ByteSetImpl.Checked root;
          final int modCountAndSize;
          ...
          return new CheckedAscendingSubItr(this,(((ByteSetImpl)root).getLowestIndex(this.boundInfo)<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
          final int modCountAndSize;
          CheckedCollection.checkModCount((modCountAndSize=this.modCountAndSize)&(~0x1ff),root.modCountAndSize&(~0x1ff));
    ...
    private static abstract class BodySet extends CheckedSubSet{
      ...
      private static class Ascending extends BodySet{
        ...
        @Override public OmniIterator.OfByte descendingIterator(){
          ...
          return new CheckedDescendingSubItr(this,(((ByteSetImpl)root).getHighestIndex(this.boundInfo>>8)<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniIterator.OfByte iterator(){
          final ByteSetImpl.Checked root;
          final int modCountAndSize;
          ...
          return new CheckedAscendingSubItr(this,(((ByteSetImpl)root).getLowestIndex((byte)this.boundInfo)<<9)|numLeft,modCountAndSize|0x1ff);
        }
        @Override public OmniNavigableSet.OfByte descendingSet(){
          final int modCountAndSize;
          CheckedCollection.checkModCount((modCountAndSize=this.modCountAndSize)&(~0x1ff),root.modCountAndSize&(~0x1ff));
