...
abstract class RefUntetheredArrSeq<E> implements OmniCollection<E>,Externalizable
{
  ...
  @SuppressWarnings("unchecked")
  boolean fragmentedInsertHi(Object[] arr,int head,int tail,E key,ToIntFunction<E> sorter){
    int lo=1;
    int hi=tail;
    while(lo<=hi)
    {
  ...
  @SuppressWarnings("unchecked")
  boolean fragmentedInsertLo(Object[] arr,int head,int tail,E key,ToIntFunction<E> sorter){
    int arrBound;
    int hi=(arrBound=arr.length)-1;
    int lo=head;
    do
  ...
  @SuppressWarnings("unchecked")
  boolean nonfragmentedInsertLo(Object[] arr,int head,int hi,E key,ToIntFunction<E> sorter){
    int lo=head;
    while(lo<=hi)
    {
      final int mid;
  ...
  @SuppressWarnings("unchecked")
  boolean nonfragmentedInsertHi(Object[] arr,int lo,int tail,E key,ToIntFunction<E> sorter){
    int hi=tail;
    while(lo<=hi)
    {
      final int mid;
