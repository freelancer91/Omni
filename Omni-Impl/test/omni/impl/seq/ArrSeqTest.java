...
public class ArrSeqTest{
    ...
    private static class ArrListMonitor<SEQ extends AbstractSeq<E>&OmniList<E>&Externalizable,E>
        ...
        public static class ArrSubListMonitor<SUBLIST extends AbstractSeq<E>&OmniList<E>,SEQ extends AbstractSeq<E>&OmniList<E>&Externalizable,E>
                implements
                                ...
                                for(final var illegalMod:initParams.structType.validPreMods){
                                    ...
                                    TestExecutorService.submitTest(()->{
                                        if(size == 0 || objGen.expectedException == null){
                                            ...
                                            final var monitor=SequenceInitialization.Ascending
                                                    .initializeWithMonitoredObj(getMonitoredSequence(initParams,size),
