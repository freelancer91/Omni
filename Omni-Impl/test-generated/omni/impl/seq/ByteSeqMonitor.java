...
interface ByteSeqMonitor
{
  interface ItrMonitor
  {
    ...
    ByteSeqMonitor getSeqMonitor();
    void verifyNext(int expectedVal,ByteOutputTestArgType outputType);
    default void verifyPrevious(int expectedVal,ByteOutputTestArgType outputType){
      throw new UnsupportedOperationException();
    }
    void verifyIteratorState();
    default void set(int v,ByteInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
    default void set(int v){
      set(v,ByteInputTestArgType.ARRAY_TYPE);
    }
    default void add(int v,ByteInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyNaturalAscending(ByteInputTestArgType inputArgType,int length){
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(ByteInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(ByteInputTestArgType inputArgType,final int length){
      int v=0;
  ...
  default void add(int index,int val,ByteInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void push(int val,ByteInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void put(int index,int val,ByteInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void removeAt(int expectedVal,ByteOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  default void get(int expectedVal,ByteOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  void clear();
  default void pop(int expectedVal,ByteOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
  default void poll(int expectedVal,ByteOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
