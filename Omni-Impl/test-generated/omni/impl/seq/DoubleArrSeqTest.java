...
public class DoubleArrSeqTest
{
  ...
  public void testConstructorsUncheckedStack()
  {
    ...
    @Test
    public void testListAddDoubleUncheckedList()
    {
      var seq=new UncheckedList();
      for(int i=100;--i>=0;)
      {
        //test add at beginning
        seq.add(0,(Double)TypeConversionUtil.convertTodouble(i));
      }
      for(int i=0;i<100;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTodouble(i)),seq.getDouble(i));
      }
      ...
      {
        //add at end
        seq.add(seq.size(),(Double)TypeConversionUtil.convertTodouble(i));
      }
      for(int i=100;i<200;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTodouble(i+100)),seq.getDouble(i));
      }
      currSize=seq.size();
      ...
      {
        //add in middle
        seq.add(100,(Double)TypeConversionUtil.convertTodouble(i));
      }
      for(int i=100;i<200;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTodouble(i)),seq.getDouble(i));
  ...
  public void testConstructorsCheckedStack()
  {
    ...
    @Test
    public void testListAddDoubleCheckedList()
    {
      ...
      Assertions.assertThrows(IndexOutOfBoundsException.class,()->seq.add(seq.size()+1,TypeConversionUtil.convertTodouble(0)));
  ...
  public void testConstructorsCheckedList()
  {
    ...
    @Test
    public void testListAddDoubleUncheckedSubList()
    {
  ...
  public void testConstructorsUncheckedSubList()
  {
    ...
    @Test
    public void testListAddDoubleCheckedSubList()
    {
