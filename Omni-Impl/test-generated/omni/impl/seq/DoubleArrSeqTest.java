...
public class DoubleArrSeqTest
{
  ...
  //TODO TestRemoveIfMethods<DEFAULT>(Double,)
  //TODO TestRemoveIfMethods<NULL>(Double,)
  //TODO TestRemoveIfMethods<50>(Double,)
  @Test
  ...
  static class MonitoredConsumer extends ArrayList implements DoubleConsumer
    ,Consumer<Object>
  {
    private static final long serialVersionUID=1L;
    @Override public void accept(double val)
  ...
  private static abstract class AbstractMonitoredPredicate implements DoublePredicate
    ,Predicate<Object>
  {
    int callCounter;
