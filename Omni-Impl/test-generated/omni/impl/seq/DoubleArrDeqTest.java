...
public class DoubleArrDeqTest{
  ...
  public void testpeek_void(){
    runOutputTests(false,true,DoubleArrDeqTest::testpeek_voidHelper);
  }
  private static void testpeek_voidHelper(CheckedType checkedType,int head,int initialSize,DoubleOutputTestArgType outputArgType)
  {
  ...
  public void testpeekFirst_void(){
    runOutputTests(false,true,DoubleArrDeqTest::testpeekFirst_voidHelper);
  }
  private static void testpeekFirst_voidHelper(CheckedType checkedType,int head,int initialSize,DoubleOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
  ...
  public void testpeekLast_void(){
    runOutputTests(false,true,DoubleArrDeqTest::testpeekLast_voidHelper);
  }
  private static void testpeekLast_voidHelper(CheckedType checkedType,int head,int initialSize,DoubleOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
    ...
    for(var checkedType:CheckedType.values()){
      for(var preModScenario:PreModScenario.values()){
        if(preModScenario.expectedException==null || (preModScenario==PreModScenario.ModSeq && checkedType.checked)){
          for(var itrType:new ItrType[]{ItrType.Itr,ItrType.DescendingItr}){
            Stream.of(DoubleOutputTestArgType.values())
  ...
  public void testtoArray_void(){
    runOutputTests(false,true,DoubleArrDeqTest::testtoArray_voidHelper);
  }
  private static void testtoArray_voidHelper(CheckedType checkedType,int head,int initialSize,DoubleOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
  ...
  public void testConstructor_void(){
    {
      var deq=new DoubleArrDeq.Checked();
  ...
  public void testConstructor_int(){
    ...
    {
      {
        var deq=new DoubleArrDeq.Checked(initialCapacity);
        Assertions.assertEquals(0,deq.modCount);
        Assertions.assertEquals(-1,deq.tail);
        Assertions.assertEquals(0,deq.head);
  ...
  interface OutputTester{
    void runTest(CheckedType checkedType,int head,int initialSize,DoubleOutputTestArgType inputType);
  }
  static void runOutputTests(boolean parallel,boolean allowEmpty,OutputTester outputTest){
    for(final var checkedType:CheckedType.values()){
      ...
      seqSizeStream.forEach(seqSize->{
        var outputArgTypeStream=Stream.of(DoubleOutputTestArgType.values());
        if(parallel){
  ...
  static void runInputTests(boolean parallel,InputTester inputTester)
  {
    for(var checkedType:CheckedType.values()){
      ...
      capacityStream.forEach(capacity->{
        ...
        seqSizeStream.forEach(seqSize->{
          var inputArgTypeStream=Stream.of(DoubleInputTestArgType.values());
          if(parallel)
          {
