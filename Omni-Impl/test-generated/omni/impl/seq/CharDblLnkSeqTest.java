  ...
  private static class SeqMonitor extends AbstractCharSeqMonitor<CharDblLnkSeq>{
    ...
    private static class DblLnkSeqVerificationItr extends SequenceVerificationItr{
      ...
      @Override SequenceVerificationItr getOffset(int i){
        return new DblLnkSeqVerificationItr(i<0?CharDblLnkNode.uncheckedIterateDescending(this.curr,i):CharDblLnkNode.iterateAscending(this.curr,i),seqMonitor);
      }
      @Override SequenceVerificationItr skip(int i){
        CharDblLnkNode curr;
        this.curr=i<0?CharDblLnkNode.uncheckedIterateDescending(this.curr,i):CharDblLnkNode.iterateAscending(this.curr,i);
        return this;
      }
