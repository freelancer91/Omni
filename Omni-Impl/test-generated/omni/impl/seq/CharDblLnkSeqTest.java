...
@FunctionalInterface
  ...
  private static class SeqMonitor extends AbstractCharSeqMonitor<CharDblLnkSeq>{
    ...
    private void verifyEmptyUncheckedSubList(int parentIndex){
      ...
      for(CharDblLnkSeq currList=(parents=this.parents)[parentIndex],root=parents[parents.length-1];;){
        Assertions.assertNull(currList.head);
        Assertions.assertNull(currList.tail);
        Assertions.assertEquals(0,currList.size);
        if(parentIndex==0){
          Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parent(currList=this.seq));
          Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.root(currList));
          Assertions.assertEquals(0,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parentOffset(currList));
          Assertions.assertNull(currList.head);
          Assertions.assertNull(currList.tail);
          Assertions.assertEquals(0,currList.size);
          return;
        }
        Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parent(currList=parents[--parentIndex]));
        Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.root(currList));
        Assertions.assertEquals(0,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parentOffset(currList));
      }
    }
    private void verifyEmptyCheckedSubList(int parentIndex){
      ...
      for(CharDblLnkSeq currList=(parents=this.parents)[parentIndex],root=parents[parents.length-1];;){
        if(root!=currList){
          Assertions.assertEquals(expectedParentModCounts[parentIndex],FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.modCount(currList));
        }
        Assertions.assertNull(currList.head);
        Assertions.assertNull(currList.tail);
        Assertions.assertEquals(0,currList.size);
        if(parentIndex==0){
          Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parent(currList=this.seq));
          Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.root(currList));
          Assertions.assertEquals(0,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parentOffset(currList));
          Assertions.assertNull(currList.head);
          Assertions.assertNull(currList.tail);
          Assertions.assertEquals(0,currList.size);
          return;
        }
        Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parent(currList=parents[--parentIndex]));
        Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.root(currList));
        Assertions.assertEquals(0,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parentOffset(currList));
      }
    }
    ...
    /*
      Assertions.assertEquals(expectedParentModCounts[parents.length-1],FieldAndMethodAccessor.CharDblLnkSeq.CheckedList.modCount(parents[parents.length-1]));
      ...
      if((currSize=(expectedParentSizes=this.expectedParentSizes)[parentIndex=expectedParentSizes.length-1])!=0){
        ...
        for(;;){
          ...
          if(parentIndex==0){
            Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parent(currList=seq));
            Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.root(currList));
          ...
          Assertions.assertSame(parentIndex==parents.length-1?null:currList,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parent(currList=parents[--parentIndex]));
          Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.root(currList));
          Assertions.assertEquals(preAlloc,FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.parentOffset(currList));
          Assertions.assertEquals(expectedParentModCounts[parentIndex],FieldAndMethodAccessor.CharDblLnkSeq.CheckedSubList.modCount(currList));
    ...
    /*
      ...
      if((currSize=(expectedParentSizes=this.expectedParentSizes)[parentIndex=expectedParentSizes.length-1])!=0){
        ...
        for(;;){
          ...
          if(parentIndex==0){
            Assertions.assertSame(currList,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parent(currList=seq));
            Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.root(currList));
          ...
          Assertions.assertSame(parentIndex==parents.length-1?null:currList,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parent(currList=parents[--parentIndex]));
          Assertions.assertSame(root,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.root(currList));
          Assertions.assertEquals(preAlloc,FieldAndMethodAccessor.CharDblLnkSeq.UncheckedSubList.parentOffset(currList));
          if((currSize=expectedParentSizes[parentIndex])==0){
            if(head!=tail){
