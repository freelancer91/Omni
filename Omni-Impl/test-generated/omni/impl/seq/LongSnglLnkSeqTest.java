...
public class LongSnglLnkSeqTest{
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new LongSnglLnkNode[numBatches];
    ...
    for(var nestedType:NestedType.values()){
      for(var checkedType:CheckedType.values()){
        ...
        TestExecutorService.completeAllTests("LongSnglLnkSeqTest.testMASSIVEtoString_void checkedType="+checkedType+"; nestedType="+nestedType);
                ...
                switch(nestedType){
                  case QUEUE:{
                    if(checkedType.checked){
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.parent(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.curr(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.prev(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.next(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.next(itrClone));
                      Assertions.assertEquals(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.modCount(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedQueue.Itr.modCount(itrClone));
                    }else{
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.parent(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.curr(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.prev(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.next(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedQueue.Itr.next(itrClone));
                    }
                    break;
                  }
                  case STACK:{
                    if(checkedType.checked){
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.parent(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.curr(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.prev(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.next(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.next(itrClone));
                      Assertions.assertEquals(FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.modCount(itr),FieldAndMethodAccessor.LongSnglLnkSeq.CheckedStack.Itr.modCount(itrClone));
                    }else{
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.parent(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.curr(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.prev(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.next(itr),FieldAndMethodAccessor.LongSnglLnkSeq.UncheckedStack.Itr.next(itrClone));
                    }
                    break;
                  }
                  default:
