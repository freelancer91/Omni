...
public class ByteArrDeqTest{
  ...
  public void testelement_void(){
    runOutputTests(true,true,ByteArrDeqTest::testelement_voidHelper);
  }
  ...
  public void testgetFirst_void(){
    runOutputTests(true,true,ByteArrDeqTest::testgetFirst_voidHelper);
  }
  ...
  public void testgetLast_void(){
    runOutputTests(true,true,ByteArrDeqTest::testgetLast_voidHelper);
  }
  ...
  public void testremoveLast_void(){
    runOutputTests(true,true,ByteArrDeqTest::testremoveLast_voidHelper);
  }
  ...
  public void testremoveFirst_void(){
    runOutputTests(true,true,ByteArrDeqTest::testremoveFirst_voidHelper);
  }
  ...
  public void testremove_void(){
    runOutputTests(true,true,ByteArrDeqTest::testremove_voidHelper);
  }
  ...
  public void testpop_void(){
    runOutputTests(true,true,ByteArrDeqTest::testpop_voidHelper);
  }
  ...
  public void testpoll_void(){
    runOutputTests(true,true,ByteArrDeqTest::testpoll_voidHelper);
  }
  ...
  public void testpollFirst_void(){
    runOutputTests(true,true,ByteArrDeqTest::testpollFirst_voidHelper);
  }
  ...
  public void testpollLast_void(){
    runOutputTests(true,true,ByteArrDeqTest::testpollLast_voidHelper);
  }
  ...
  public void testadd_val(){
    runInputTests(true,ByteArrDeqTest::testadd_valHelper);
  }
  ...
  public void testaddLast_val(){
    runInputTests(true,ByteArrDeqTest::testaddLast_valHelper);
  }
  ...
  public void testpush_val(){
    runInputTests(true,ByteArrDeqTest::testpush_valHelper);
  }
  ...
  public void testaddFirst_val(){
    runInputTests(true,ByteArrDeqTest::testaddFirst_valHelper);
  }
  ...
  public void testofferFirst_val(){
    runInputTests(true,ByteArrDeqTest::testofferFirst_valHelper);
  }
  ...
  public void testoffer_val(){
    runInputTests(true,ByteArrDeqTest::testoffer_valHelper);
  }
  ...
  public void tesetofferLast_val(){
    runInputTests(true,ByteArrDeqTest::tesetofferLast_valHelper);
  }
  private static void tesetofferLast_valHelper(CheckedType checkedType,int initialCapacity,int head,int initialSize,ByteInputTestArgType inputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialCapacity,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<100;++i)
