...
interface IntSeqMonitor
{
  interface ItrMonitor
  {
    ...
    IntSeqMonitor getSeqMonitor();
    void verifyNext(int expectedVal,IntOutputTestArgType outputType);
    default void verifyPrevious(int expectedVal,IntOutputTestArgType outputType){
      throw new UnsupportedOperationException();
    }
    void verifyIteratorState();
    default void set(int v,IntInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
    default void set(int v){
      set(v,IntInputTestArgType.ARRAY_TYPE);
    }
    default void add(int v,IntInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyNaturalAscending(IntInputTestArgType inputArgType,int length){
    ...
    public SequenceVerificationItr verifyDescending(int v,IntInputTestArgType inputArgType,int length)
    {
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(IntInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(IntInputTestArgType inputArgType,final int length){
      int v=0;
  ...
  default void add(int index,int val,IntInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void push(int val,IntInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void put(int index,int val,IntInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void removeAt(int expectedVal,IntOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  default void get(int expectedVal,IntOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  void clear();
  default void pop(int expectedVal,IntOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
  default void poll(int expectedVal,IntOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
