...
class FloatArrSeqMonitor implements FloatSeqMonitor{
  ...
  FloatArrSeqMonitor(final CheckedType checkedType,final int rootPreAlloc,final int parentPreAlloc,final int parentPostAlloc,final int rootPostAlloc){
  ...
  abstract class AbstractItrMonitor implements ItrMonitor{
    ...
    AbstractItrMonitor(OmniIterator.OfFloat itr,int expectedCursor){
      this.itr=itr;
