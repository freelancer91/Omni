  ...
  private static class SeqMonitor extends AbstractRefSeqMonitor<RefDblLnkSeq>{
    ...
    private static class DblLnkSeqVerificationItr extends SequenceVerificationItr{
      ...
      @Override void reverseAndVerifyIndex(MonitoredObject monitoredObject){
        Object v;
        Assertions.assertEquals(monitoredObject.compareVal,(v=(curr=curr.prev).val) instanceof MonitoredObject?((MonitoredObject)v).compareVal:(Object)v);
      }
      ...
      @Override SequenceVerificationItr getOffset(int i){
        return new DblLnkSeqVerificationItr(i<0?RefDblLnkNode.uncheckedIterateDescending(this.curr,i):RefDblLnkNode.iterateAscending(this.curr,i),seqMonitor);
      }
      @Override SequenceVerificationItr skip(int i){
        RefDblLnkNode curr;
        this.curr=i<0?RefDblLnkNode.uncheckedIterateDescending(this.curr,i):RefDblLnkNode.iterateAscending(this.curr,i);
        return this;
      }
