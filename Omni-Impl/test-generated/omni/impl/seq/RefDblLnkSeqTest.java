...
public class RefDblLnkSeqTest{
  ...
  private static void testListItradd_valHelper(SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,SequenceLocation seqLocation,RefInputTestArgType inputArgType){
  ...
  private static void testListadd_int_valHelper(SeqMonitor seqMonitor,RefInputTestArgType inputArgType,SequenceLocation seqLocation,PreModScenario preModScenario,int numToAdd){
    if(preModScenario.expectedException!=null || seqLocation.expectedException!=null){
      for(int i=0;i<numToAdd;++i){
        seqMonitor.add(i);
      }
          ...
          if(numToAdd!=0){
            if(monitoredObjectGen!=null){
              ...
              switch(monitoredObjectGen){
                ...
                case ThrowModRoot:
                  numExpectedCalls=1;
                  verifyItr.verifyPostAlloc().verifyIllegalAdd();
                  break;
                default:
                  throw new Error("Unknown monitoredObjectGen "+monitoredObjectGen);
              }
        ...
        TestExecutorService.submitTest(()->{
          ...
          if(numToAdd!=0){
            if(monitoredObjectGen!=null){
              ...
              switch(seqLocation){
                case BEGINNING:
                  numExpectedCalls=numToAdd-argType.initContainsBeginning(seqMonitor,monitoredObject,numToAdd,true)+1;
                  break;
                case NEARBEGINNING:
                  numExpectedCalls=numToAdd-argType.initContainsNearBeginning(seqMonitor,monitoredObject,numToAdd,true)+1;
                  break;
                case MIDDLE:
                  numExpectedCalls=numToAdd-argType.initContainsMiddle(seqMonitor,monitoredObject,numToAdd,true)+1;
                  break;
                case NEAREND:
                  numExpectedCalls=numToAdd-argType.initContainsNearEnd(seqMonitor,monitoredObject,numToAdd,true)+1;
                  break;
                case END:
                  numExpectedCalls=numToAdd-argType.initContainsEnd(seqMonitor,monitoredObject,numToAdd,true)+1;
                  break;
                case IOBHI:
                  argType.initDoesNotContain(seqMonitor,numToAdd);
                  numExpectedCalls=seqMonitor.expectedSeqSize;
  ...
  private static void testadd_valHelper(SeqMonitor seqMonitor,RefInputTestArgType inputArgType,PreModScenario preModScenario,int numToAdd){
    for(int i=0;i<numToAdd;++i){
      seqMonitor.add(i);
    }
    seqMonitor.illegalAdd(preModScenario);
  ...
  public void testConstructor_Node_int_Node(){
    final var head=new RefDblLnkNode(TypeConversionUtil.convertToObject(1));
    final var tail=new RefDblLnkNode(TypeConversionUtil.convertToObject(2));
    head.next=tail;
    tail.prev=head;
    final int seqSize=2;
    TestExecutorService.submitTest(()->{
                    ...
                    switch(itrType){
                        ...
                        switch(nestedType){
                          case LISTDEQUE:{
                            if(checkedType.checked){
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.currIndex(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.modCount(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.AscendingItr.modCount(itrClone));
                            }else{
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.AscendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.AscendingItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.AscendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.AscendingItr.curr(itrClone));
                            }
                            break;
                          }
                          case SUBLIST:{
                            if(checkedType.checked){
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.currIndex(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.modCount(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.AscendingItr.modCount(itrClone));
                            }else{
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.AscendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.AscendingItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.AscendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.AscendingItr.curr(itrClone));
                            }
                            break;
                          }
                          default:
                      ...
                      case ListItr:{
                        switch(nestedType){
                          case LISTDEQUE:{
                            if(checkedType.checked){
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.currIndex(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.modCount(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.BidirectionalItr.modCount(itrClone));
                            }else{
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.BidirectionalItr.currIndex(itrClone));
                            }
                            break;
                          }
                          case SUBLIST:{
                            if(checkedType.checked){
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.currIndex(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.modCount(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedSubList.BidirectionalItr.modCount(itrClone));
                            }else{
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.parent(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.curr(itrClone));
                              Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.lastRet(itrClone));
                              Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedSubList.BidirectionalItr.currIndex(itrClone));
                            }
                            break;
                          }
                          default:
                      ...
                      case DescendingItr:{
                        if(checkedType.checked){
                          Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.parent(itrClone));
                          Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.curr(itrClone));
                          Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.lastRet(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.lastRet(itrClone));
                          Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.currIndex(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.currIndex(itrClone));
                          Assertions.assertEquals(FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.modCount(itr),FieldAndMethodAccessor.RefDblLnkSeq.CheckedList.DescendingItr.modCount(itrClone));
                        }else{
                          Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.DescendingItr.parent(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.DescendingItr.parent(itrClone));
                          Assertions.assertSame(FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.DescendingItr.curr(itr),FieldAndMethodAccessor.RefDblLnkSeq.UncheckedList.DescendingItr.curr(itrClone));
                        }
                        break;
                      }
                      default:
                  ...
                  for(var argType:QueryTester.values()){
                    ...
                    if(argType==QueryTester.ObjectNonNull){
                      ...
                      for(var monitoredObjectGen:MonitoredObjectGen.values()){
                        if(monitoredObjectGen.expectedException!=null&&(!nestedType.rootType || monitoredObjectGen.appliesToRoot)){
  ...
  interface ListDequeInputTest{
    void runTest(SeqMonitor seqMonitor,RefInputTestArgType inputArgType);
    private void runTests(){
      for(var checkedType:CheckedType.values()){
        for(var inputArgType:RefInputTestArgType.values()){
                        ...
                        if(monitoredFunctionGen.expectedException==null){
                          ...
                          if(seqMonitor.nestedType.forwardIteration){
                            for(int i=0,v=initVal;i<numToAdd;++i,++v){
                              Assertions.assertEquals(TypeConversionUtil.convertToObject(v),itr.next());
                            }
                          }else{
                            for(int i=0,v=initVal;i<numToAdd;++i,++v){
                              Assertions.assertEquals(TypeConversionUtil.convertToObject(numToAdd+initVal-v-1),itr.next());
                            }
                          }
              ...
              for(int seqSize:AbstractRefSeqMonitor.FIB_SEQ){
                for(var monitoredObjectGen:MonitoredObjectGen.values()){
                  if(monitoredObjectGen.expectedException==null || (checkedType.checked && (!nestedType.rootType || monitoredObjectGen.appliesToRoot))){
                    TestExecutorService.submitTest(()->runTest(new SeqMonitor(nestedType,checkedType),preModScenario,seqSize,monitoredObjectGen));
                  }
                }
              }
            }
  ...
  private static void testListItrset_valHelper(SeqMonitor seqMonitor,ListItrSetScenario listItrSetScenario,RefInputTestArgType inputArgType){
    int numToAdd=100;
    for(int i=0;i<numToAdd;++i){
      seqMonitor.add(i);
    }
  ...
  private static void testListItrprevious_voidHelper(SeqMonitor seqMonitor,IterationScenario itrScenario,int numToAdd,RefOutputTestArgType outputType){
    for(int i=0;i<numToAdd;++i){
      seqMonitor.add(i);
    }
