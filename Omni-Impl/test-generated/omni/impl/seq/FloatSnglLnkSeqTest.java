...
import omni.impl.seq.FloatSnglLnkSeqMonitor.NestedType;
...
import omni.impl.seq.FloatSnglLnkSeqMonitor.QueryTester;
...
public class FloatSnglLnkSeqTest{
  ...
  public void testItrremove_void(){
    getItrremove_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testItrremove_voidHelper((FloatSnglLnkSeqMonitor)args[0],(ItrRemoveScenario)args[1],(PreModScenario)args[2],(SequenceContentsScenario)args[3],(SequenceLocation)args[4]);
    });
  }
