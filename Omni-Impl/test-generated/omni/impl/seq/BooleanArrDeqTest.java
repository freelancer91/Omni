...
public class BooleanArrDeqTest{
  ...
  public void testelement_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testelement_voidHelper);
  }
  ...
  public void testgetFirst_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testgetFirst_voidHelper);
  }
  ...
  public void testgetLast_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testgetLast_voidHelper);
  }
  ...
  public void testremoveLast_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testremoveLast_voidHelper);
  }
  ...
  public void testremoveFirst_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testremoveFirst_voidHelper);
  }
  ...
  public void testremove_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testremove_voidHelper);
  }
  ...
  public void testpop_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testpop_voidHelper);
  }
  ...
  public void testpoll_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testpoll_voidHelper);
  }
  ...
  public void testpollFirst_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testpollFirst_voidHelper);
  }
  ...
  public void testpollLast_void(){
    runOutputTests(true,true,BooleanArrDeqTest::testpollLast_voidHelper);
  }
  ...
  public void testadd_val(){
    runInputTests(true,BooleanArrDeqTest::testadd_valHelper);
  }
  ...
  public void testaddLast_val(){
    runInputTests(true,BooleanArrDeqTest::testaddLast_valHelper);
  }
  ...
  public void testpush_val(){
    runInputTests(true,BooleanArrDeqTest::testpush_valHelper);
  }
  ...
  public void testaddFirst_val(){
    runInputTests(true,BooleanArrDeqTest::testaddFirst_valHelper);
  }
  ...
  public void testofferFirst_val(){
    runInputTests(true,BooleanArrDeqTest::testofferFirst_valHelper);
  }
  ...
  public void testoffer_val(){
    runInputTests(true,BooleanArrDeqTest::testoffer_valHelper);
  }
  ...
  public void tesetofferLast_val(){
    runInputTests(true,BooleanArrDeqTest::tesetofferLast_valHelper);
  }
  private static void tesetofferLast_valHelper(CheckedType checkedType,int initialCapacity,int head,int initialSize,BooleanInputTestArgType inputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialCapacity,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<100;++i)
