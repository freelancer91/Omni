...
public class BooleanSnglLnkSeqTest{
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new BooleanSnglLnkNode[numBatches];
    ...
    for(var nestedType:NestedType.values()){
      for(var checkedType:CheckedType.values()){
        ...
        TestExecutorService.completeAllTests("BooleanSnglLnkSeqTest.testMASSIVEtoString_void checkedType="+checkedType+"; nestedType="+nestedType);
                ...
                for(long tmpRandSeed=0;tmpRandSeed<=randSeedBound;++tmpRandSeed){
                  ...
                  for(int tmpPeriod=1,inc=Math.max(1,seqSize/10);;tmpPeriod+=inc){
                    ...
                    for(int tmpInitVal=0;tmpInitVal<=1;++tmpInitVal){
                      ...
                      TestExecutorService.submitTest(()->testremoveIf_PredicateHelper(new SeqMonitor(nestedType,checkedType),monitoredRemoveIfPredicateGen,0.5,randSeed,functionCallType,seqSize,initVal,period));
                    }
                    if(period>=seqSize){
                      break;
                    }
        ...
        for(var monitoredFunctionGen:MonitoredFunctionGen.values()){
          if((checkedType.checked || monitoredFunctionGen.expectedException==null)&&(monitoredFunctionGen.appliesToRoot)){
            for(int seqSize:AbstractBooleanSeqMonitor.FIB_SEQ){
              ...
              if(seqSize!=0){
                TestExecutorService.submitTest(()->testreadAndwriteObjectHelper(new SeqMonitor(nestedType,checkedType),monitoredFunctionGen,seqSize,1));
              }
            }
          }
        }
                ...
                switch(nestedType){
                  case QUEUE:{
                    if(checkedType.checked){
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.parent(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.curr(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.prev(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.next(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.next(itrClone));
                      Assertions.assertEquals(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.modCount(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedQueue.Itr.modCount(itrClone));
                    }else{
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.parent(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.curr(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.prev(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.next(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedQueue.Itr.next(itrClone));
                    }
                    break;
                  }
                  case STACK:{
                    if(checkedType.checked){
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.parent(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.curr(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.prev(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.next(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.next(itrClone));
                      Assertions.assertEquals(FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.modCount(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.CheckedStack.Itr.modCount(itrClone));
                    }else{
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.parent(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.parent(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.curr(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.curr(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.prev(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.prev(itrClone));
                      Assertions.assertSame(FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.next(itr),FieldAndMethodAccessor.BooleanSnglLnkSeq.UncheckedStack.Itr.next(itrClone));
                    }
                    break;
                  }
                  default:
