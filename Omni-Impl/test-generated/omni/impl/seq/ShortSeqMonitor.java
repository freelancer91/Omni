...
interface ShortSeqMonitor
{
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(ShortInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(ShortInputTestArgType inputArgType,final int length){
      int v=0;
