...
class ShortSeqMonitor{
  ...
  ShortSeqMonitor(NestedType nestedType,CheckedType checkedType,int seqLength,short[] arr){
      ...
      case ARRSEQ:
        switch(nestedType){
          ...
          case SUBLIST:
            if(checkedType.checked)
            {
              FieldAccessor.ShortArrSeq.CheckedSubList.readObject(seq,ois);
            }
            else
            {
              FieldAccessor.ShortArrSeq.UncheckedSubList.readObject(seq,ois);
            }
            break;
          default:
            throw new Error("Unknown nestedType "+nestedType);
      ...
      case ARRSEQ:
        switch(nestedType){
          ...
          case SUBLIST:
            if(checkedType.checked)
            {
              FieldAccessor.ShortArrSeq.CheckedSubList.writeObject(seq,oos);
            }
            else
            {
              FieldAccessor.ShortArrSeq.UncheckedSubList.writeObject(seq,oos);
            }
            break;
          default:
            throw new Error("Unknown nestedType "+nestedType);
