...
interface FloatSeqMonitor
{
  interface ItrMonitor
  {
    ...
    FloatSeqMonitor getSeqMonitor();
    void verifyNext(int expectedVal,FloatOutputTestArgType outputType);
    default void verifyPrevious(int expectedVal,FloatOutputTestArgType outputType){
      throw new UnsupportedOperationException();
    }
    void verifyIteratorState();
    default void set(int v,FloatInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
    default void set(int v){
      set(v,FloatInputTestArgType.ARRAY_TYPE);
    }
    default void add(int v,FloatInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
  ...
  static enum MonitoredFunctionGen{
    NoThrow(null,true,true,true){
      ...
      @Override MonitoredObjectInputStream getMonitoredObjectInputStream(File file,FloatSeqMonitor seqMonitor) throws IOException{
        return new MonitoredObjectInputStream(file);
      }
      @Override MonitoredObjectOutputStream getMonitoredObjectOutputStream(File file,FloatSeqMonitor seqMonitor) throws IOException{
    ...
    MonitoredObjectInputStream getMonitoredObjectInputStream(File file,FloatSeqMonitor seqMonitor) throws IOException{
      throw new UnsupportedOperationException();
    }
    MonitoredObjectOutputStream getMonitoredObjectOutputStream(File file,FloatSeqMonitor seqMonitor) throws IOException{
      throw new UnsupportedOperationException();
    }
  }
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyNaturalAscending(FloatInputTestArgType inputArgType,int length){
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(FloatInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(FloatInputTestArgType inputArgType,final int length){
      int v=0;
  ...
  default void add(int index,int val,FloatInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void push(int val,FloatInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void put(int index,int val,FloatInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void removeAt(int expectedVal,FloatOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  default void get(int expectedVal,FloatOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  void clear();
  default void pop(int expectedVal,FloatOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
  default void poll(int expectedVal,FloatOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
