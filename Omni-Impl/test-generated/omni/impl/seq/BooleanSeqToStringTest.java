...
public class BooleanSeqToStringTest
{
  ...
  private static void testArrSeqToString(int length)
  {
    ...
    }
    {
      ...
      var expected=arrayList.toString();
      arrayList=null;
      EqualityUtil.parallelAssertStringsAreEqual(expected,new BooleanArrSeq.CheckedStack(length,arr).toString());
      EqualityUtil.parallelAssertStringsAreEqual(expected,new BooleanArrSeq.UncheckedStack(length,arr).toString());
    }
  }
  @Test
