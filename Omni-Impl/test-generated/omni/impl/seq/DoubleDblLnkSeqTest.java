          ...
          for(var preModScenario:PreModScenario.values()){
            ...
            for(var monitoredRemoveIfPredicateGen:MonitoredRemoveIfPredicateGen.values()){
              ...
              for(int seqSize:seqSizes){
                System.out.println("DoubleDblLnkSeq.testremoveIf_Predicate<"+nestedType+","+checkedType+","+functionCallType+","+preModScenario+","+monitoredRemoveIfPredicateGen+","+seqSize+">");
                double[] thresholdArr;
                long randSeedBound;
