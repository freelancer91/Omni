...
abstract class AbstractLongSeqMonitor<SEQ extends OmniCollection.OfLong>{
  ...
  void verifyRemoveIf(MonitoredRemoveIfPredicate pred,FunctionCallType functionCallType,int expectedNumRemoved,OmniCollection.OfLong clone,boolean forward){
    int seqSize=expectedSeqSize;
    boolean retVal;
    ...
    if(retVal){
      ...
      Object nextVal=null;
      if(itr.hasNext()){
        nextVal=itr.nextLong();
      }
      if(forward){
        for(int i=0;;){
          var currVal=TypeConversionUtil.convertTolong(i);
  ...
  void removeFirst(int expectedVal,LongOutputTestArgType outputType){
    outputType.verifyDequeRemoveFirst(seq,expectedVal);
    verifyRemoval();
  }
  void removeLast(int expectedVal,LongOutputTestArgType outputType){
  ...
  void pollFirst(int expectedVal,LongOutputTestArgType outputType){
    outputType.verifyDequePollFirst(seq,expectedSeqSize,expectedVal);
    if(expectedSeqSize!=0){
      verifyRemoval();
    }
  }
  void pollLast(int expectedVal,LongOutputTestArgType outputType){
  ...
  boolean offerFirst(int val,LongInputTestArgType inputArgType){
  ...
  {
    boolean ret=((OmniDeque.OfLong)seq).removeFirstOccurrence(obj);
    if(ret)
    {
      verifyRemoval();
    }
  ...
  {
    boolean ret=((OmniDeque.OfLong)seq).removeLastOccurrence(obj);
    if(ret)
    {
      verifyRemoval();
    }
  ...
  static enum MonitoredRemoveIfPredicateGen
  {
    RemoveFirst(null,true,false){
      @Override MonitoredRemoveIfPredicate getMonitoredRemoveIfPredicate(AbstractLongSeqMonitor seqMonitor,long randSeed,int numExpectedCalls,double threshold){
        return new MonitoredRemoveIfPredicate(){
          private final long matchVal=TypeConversionUtil.convertTolong(0);
    ...
    RemoveLast(null,true,false){
      @Override MonitoredRemoveIfPredicate getMonitoredRemoveIfPredicate(AbstractLongSeqMonitor seqMonitor,long randSeed,int numExpectedCalls,double threshold){
        return new MonitoredRemoveIfPredicate(){
          private final long matchVal=TypeConversionUtil.convertTolong(numExpectedCalls-1);
          @Override boolean testImpl(long val){
            return matchVal==val;
          }
        };
    ...
    RemoveFirstAndLast(null,true,false){
      @Override MonitoredRemoveIfPredicate getMonitoredRemoveIfPredicate(AbstractLongSeqMonitor seqMonitor,long randSeed,int numExpectedCalls,double threshold){
        return new MonitoredRemoveIfPredicate(){
          private final long matchVal1=TypeConversionUtil.convertTolong(0);
          private final long matchVal2=TypeConversionUtil.convertTolong(numExpectedCalls-1);
          @Override boolean testImpl(long val){
  ...
  {
    Booleannull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Boolean)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Boolean)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Boolean)(Boolean)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Boolean)(Boolean)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Boolean)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Boolean)(null));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        throw new UnsupportedOperationException();
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
      @Override void addEqualsVal(AbstractLongSeqMonitor seqMonitor){
        throw new UnsupportedOperationException();
      }
      @Override void addNotEqualsVal(AbstractLongSeqMonitor seqMonitor){
        seqMonitor.addVal((boolean)false);
      }
    },
    Bytenull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Byte)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Byte)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Byte)(Byte)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Byte)(Byte)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Byte)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Byte)(null));}
    ...
    Characternull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Character)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Character)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(Character)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(Character)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(null));}
    ...
    Shortnull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Short)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Short)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(Short)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(Short)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(null));}
    ...
    Integernull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Integer)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Integer)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(Integer)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(Integer)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(null));}
    ...
    Longnull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Long)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Long)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(Long)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(Long)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(null));}
    ...
    Floatnull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Float)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Float)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(Float)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(Float)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(null));}
    ...
    Doublenull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Double)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Double)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(Double)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(Double)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(null));}
    ...
    Objectnull(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Object)(null));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Object)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(Object)(null));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(Object)(null));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(null));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(null));}
    ...
    Booleanfalse(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(boolean)(false));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(boolean)(false));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Boolean)(boolean)(false));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Boolean)(boolean)(false));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((boolean)(false));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((boolean)(false));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)TypeUtil.castToLong(false));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)true);
      }
      @Override void addEqualsVal(AbstractLongSeqMonitor seqMonitor){
    ...
    Booleantrue(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(boolean)(true));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(boolean)(true));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Boolean)(boolean)(true));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Boolean)(boolean)(true));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((boolean)(true));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((boolean)(true));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)TypeUtil.castToLong(true));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    Byte0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(byte)(0));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(byte)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Byte)(byte)(0));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Byte)(byte)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((byte)(0));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((byte)(0));}
    ...
    Bytepos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(byte)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(byte)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Byte)(byte)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Byte)(byte)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((byte)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((byte)(1));}
    ...
    Bytepos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(byte)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(byte)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Byte)(byte)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Byte)(byte)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((byte)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((byte)(2));}
    ...
    Character0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(char)(0));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(char)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(char)(0));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(char)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((char)(0));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((char)(0));}
    ...
    Characterpos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(char)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(char)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(char)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(char)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((char)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((char)(1));}
    ...
    Characterpos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(char)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(char)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(char)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(char)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((char)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((char)(2));}
    ...
    CharacterMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(char)(((char)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(char)(((char)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(char)(((char)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(char)(((char)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((char)(((char)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((char)(((char)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((char)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    CharacterMAX_SHORT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(char)(((char)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(char)(((char)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Character)(char)(((char)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Character)(char)(((char)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((char)(((char)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((char)(((char)Short.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((char)Short.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    Short0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(short)(0));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(short)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(short)(0));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(short)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((short)(0));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((short)(0));}
    ...
    Shortpos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(short)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(short)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(short)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(short)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((short)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((short)(1));}
    ...
    Shortpos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(short)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(short)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(short)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(short)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((short)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((short)(2));}
    ...
    ShortMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(short)(((short)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(short)(((short)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(short)(((short)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(short)(((short)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((short)(((short)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((short)(((short)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((short)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    ShortMIN_BYTE_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(short)(((short)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(short)(((short)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Short)(short)(((short)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Short)(short)(((short)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((short)(((short)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((short)(((short)Byte.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((short)Byte.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    Integer0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(0));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(0));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(0));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(0));}
    ...
    Integerpos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(1));}
    ...
    Integerpos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(2));}
    ...
    IntegerMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(((int)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(((int)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(((int)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(((int)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(((int)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(((int)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((int)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMIN_BYTE_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(((int)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(((int)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(((int)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(((int)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(((int)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(((int)Byte.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((int)Byte.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMAX_SHORT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(((int)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(((int)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(((int)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(((int)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(((int)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(((int)Short.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((int)Short.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMIN_SHORT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(((int)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(((int)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(((int)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(((int)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(((int)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(((int)Short.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((int)Short.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMAX_CHAR_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(((int)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(((int)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(((int)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(((int)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(((int)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(((int)Character.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((int)Character.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMAX_SAFE_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(TypeUtil.MAX_SAFE_INT+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(TypeUtil.MAX_SAFE_INT+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(TypeUtil.MAX_SAFE_INT+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(TypeUtil.MAX_SAFE_INT+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(TypeUtil.MAX_SAFE_INT+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(TypeUtil.MAX_SAFE_INT+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(TypeUtil.MAX_SAFE_INT+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    IntegerMIN_SAFE_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(int)(TypeUtil.MIN_SAFE_INT-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(int)(TypeUtil.MIN_SAFE_INT-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Integer)(int)(TypeUtil.MIN_SAFE_INT-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Integer)(int)(TypeUtil.MIN_SAFE_INT-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((int)(TypeUtil.MIN_SAFE_INT-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((int)(TypeUtil.MIN_SAFE_INT-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(TypeUtil.MIN_SAFE_INT-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    Long0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(0));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(0));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(0));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(0));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(0));}
    ...
    Longpos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(1));}
    ...
    Longpos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(2));}
    ...
    LongMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMIN_BYTE_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Byte.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Byte.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMAX_SHORT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Short.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Short.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMIN_SHORT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Short.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Short.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMAX_CHAR_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Character.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Character.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMAX_SAFE_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)TypeUtil.MAX_SAFE_INT)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMIN_SAFE_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)TypeUtil.MIN_SAFE_INT)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMAX_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Integer.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Integer.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMIN_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)Integer.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)Integer.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMAX_SAFE_LONG_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)TypeUtil.MAX_SAFE_LONG)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)TypeUtil.MAX_SAFE_LONG)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    LongMIN_SAFE_LONG_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Long)(long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Long)(long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((long)(((long)TypeUtil.MIN_SAFE_LONG)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((long)TypeUtil.MIN_SAFE_LONG)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    Floatpos0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(0.0F));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(0.0F));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(0.0F));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(0.0F));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(0.0F));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(0.0F));}
    ...
    Floatpos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(1));}
    ...
    Floatpos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(2));}
    ...
    FloatMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMIN_BYTE_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Byte.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Byte.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMAX_SHORT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Short.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Short.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMIN_SHORT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Short.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Short.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMAX_CHAR_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Character.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Character.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMAX_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Integer.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Integer.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMIN_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Integer.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Integer.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMAX_LONG_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Long.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Long.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Long.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Long.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMIN_LONG_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(((float)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(((float)Long.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(((float)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(((float)Long.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(((float)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(((float)Long.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((float)Long.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMIN_FLOAT_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(Float.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(Float.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(Float.MIN_VALUE));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(Float.MIN_VALUE));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatMAX_FLOAT_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(Float.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(Float.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(Float.MAX_VALUE));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(Float.MAX_VALUE));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    FloatNaN(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(float)(Float.NaN));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(float)(Float.NaN));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Float)(float)(Float.NaN));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Float)(float)(Float.NaN));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((float)(Float.NaN));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((float)(Float.NaN));}
    ...
    Doublepos0(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(0.0D));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(0.0D));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(0.0D));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(0.0D));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(0.0D));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(0.0D));}
    ...
    Doublepos1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(1));}
    ...
    Doublepos2(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(2));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(2));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(2));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(2));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(2));}
    ...
    DoubleMAX_BYTE_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Byte.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Byte.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Byte.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Byte.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_BYTE_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Byte.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Byte.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Byte.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Byte.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_SHORT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Short.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Short.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Short.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Short.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_SHORT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Short.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Short.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Short.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Short.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_CHAR_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Character.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Character.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Character.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Character.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_SAFE_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)TypeUtil.MAX_SAFE_INT)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)TypeUtil.MAX_SAFE_INT)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_SAFE_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)TypeUtil.MIN_SAFE_INT)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)TypeUtil.MIN_SAFE_INT)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_INT_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Integer.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Integer.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Integer.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Integer.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_INT_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Integer.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Integer.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Integer.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Integer.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_LONG_PLUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Long.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Long.MAX_VALUE)+1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Long.MAX_VALUE)+1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Long.MAX_VALUE)+1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Long.MAX_VALUE)+1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_LONG_MINUS1(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(((double)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(((double)Long.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(((double)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(((double)Long.MIN_VALUE)-1));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(((double)Long.MIN_VALUE)-1));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(((double)Long.MIN_VALUE)-1));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(((double)Long.MIN_VALUE)-1));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMIN_FLOAT_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(Float.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(Float.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(Float.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(Float.MIN_VALUE));}
    ...
    DoubleMAX_FLOAT_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(Float.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(Float.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(Float.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(Float.MAX_VALUE));}
    ...
    DoubleMIN_DOUBLE_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(Double.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(Double.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(Double.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(Double.MIN_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(Double.MIN_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(Double.MIN_VALUE));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(Double.MIN_VALUE));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleMAX_DOUBLE_VALUE(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(Double.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(Double.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(Double.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(Double.MAX_VALUE));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(Double.MAX_VALUE));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(Double.MAX_VALUE));}
      ...
      @Override void setEqualsVal(long[] arr,int index){
        arr[index]=((long)(Double.MAX_VALUE));
      }
      @Override void setNotEqualsVal(long[] arr,int index){
        arr[index]=TypeUtil.castToLong((boolean)false);
      }
    ...
    DoubleNaN(false){
      @Override boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Object)(double)(Double.NaN));}
      @Override boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Object)(double)(Double.NaN));}
      ...
      @Override boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((Double)(double)(Double.NaN));}
      @Override boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((Double)(double)(Double.NaN));}
      ...
      @Override boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeFirstOccurrence((double)(Double.NaN));}
      @Override boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor){return seqMonitor.removeLastOccurrence((double)(Double.NaN));}
    ...
    ;
      ...
      boolean invokeremoveFirstOccurrence(AbstractLongSeqMonitor seqMonitor,QueryCastType queryCastType){
      ...
      boolean invokeremoveLastOccurrence(AbstractLongSeqMonitor seqMonitor,QueryCastType queryCastType){
        switch(queryCastType){
          case Unboxed:
      ...
      abstract boolean invokeremoveFirstOccurrenceObject(AbstractLongSeqMonitor seqMonitor);
      abstract boolean invokeremoveFirstOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor);
      abstract boolean invokeremoveFirstOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor);
      abstract boolean invokeremoveLastOccurrenceObject(AbstractLongSeqMonitor seqMonitor);
      abstract boolean invokeremoveLastOccurrenceBoxed(AbstractLongSeqMonitor seqMonitor);
      abstract boolean invokeremoveLastOccurrenceUnboxed(AbstractLongSeqMonitor seqMonitor);
      ...
      abstract void setEqualsVal(long[] arr,int index);
      abstract void setNotEqualsVal(long[] arr,int index);
