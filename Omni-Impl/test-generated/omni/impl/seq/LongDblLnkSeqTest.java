...
public class LongDblLnkSeqTest{
  ...
  public void testtoArray_void(){
    gettoArray_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testtoArray_voidHelper((SeqMonitor)args[0],(PreModScenario)args[1],(int)args[2],(LongOutputTestArgType)args[3]);
    });
  }
  ...
  public void testListget_int(){
    getListget_intArgs().parallel().map(Arguments::get).forEach(args->{
        testListget_intHelper((SeqMonitor)args[0],(PreModScenario)args[1],(int)args[2],(SequenceLocation)args[3],(LongOutputTestArgType)args[4]);
    });
  }
  private static void testListget_intHelper
  (SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,SequenceLocation seqLocation,LongOutputTestArgType outputArgType){
    for(int i=0;i<numToAdd;++i){
      seqMonitor.add(i);
    }
    seqMonitor.illegalAdd(preModScenario);
  ...
  public void testListput_int_val(){
    getListput_int_valArgs().parallel().map(Arguments::get).forEach(args->{
        testListput_int_valHelper((SeqMonitor)args[0],(LongInputTestArgType)args[1],(SequenceLocation)args[2],(PreModScenario)args[3],(int)args[4]);
    });
  }
  ...
  public void testQueueremove_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testQueueremove_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testpollLast_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testpollLast_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testpeekLast_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testpeekLast_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testpollFirst_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testpollFirst_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testpeekFirst_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testpeekFirst_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testaddFirst_val(){
    getStackpush_valArgs().parallel().map(Arguments::get).forEach(args->{
        testaddFirst_valHelper((SeqMonitor)args[0],(LongInputTestArgType)args[1]);
    });
  }
  ...
  public void testaddLast_val(){
    getStackpush_valArgs().parallel().map(Arguments::get).forEach(args->{
        testaddLast_valHelper((SeqMonitor)args[0],(LongInputTestArgType)args[1]);
    });
  }
  ...
  public void testofferFirst_val(){
    getStackpush_valArgs().parallel().map(Arguments::get).forEach(args->{
        testofferFirst_valHelper((SeqMonitor)args[0],(LongInputTestArgType)args[1]);
    });
  }
  ...
  public void testofferLast_val(){
    getStackpush_valArgs().parallel().map(Arguments::get).forEach(args->{
        testofferLast_valHelper((SeqMonitor)args[0],(LongInputTestArgType)args[1]);
    });
  }
  ...
  public void testremoveFirst_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testremoveFirst_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testremoveLast_void(){
    getPeekPollAndPopArgs().parallel().map(Arguments::get).forEach(args->{
        testremoveLast_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testgetFirst_void(){
    getQueueelement_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testgetFirst_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
  ...
  public void testgetLast_void(){
    getQueueelement_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testgetLast_voidHelper((SeqMonitor)args[0],(LongOutputTestArgType)args[1]);
    });
  }
