...
public class LongDblLnkSeqTest{
    ...
    private static void testListget_intHelper(SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,SequenceLocation seqLocation,LongOutputTestArgType outputArgType){
      for(int i=0;i<numToAdd;++i){
        seqMonitor.add(i);
      }
      seqMonitor.illegalAdd(preModScenario);
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new LongDblLnkNode[numThreads];
    ...
    for(var nestedType:NestedType.values()){
      for(var checkedType:CheckedType.values()){
        ...
        for(threadIndex=0,nextWayPointIndex=0;threadIndex<threadBound;++threadIndex){
          ...
          submitTest(()->AbstractLongSeqMonitor.verifyLargeStr(string,finalWayPointIndex,finalWayPointBound,verifyItr));
  ...
  (SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,LongOutputTestArgType outputArgType){
    for(int i=0;i<numToAdd;++i){
      seqMonitor.add(i);
    }
    seqMonitor.illegalAdd(preModScenario);
