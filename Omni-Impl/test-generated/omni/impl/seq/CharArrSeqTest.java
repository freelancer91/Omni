...
public class CharArrSeqTest
{
  ...
  public void testConstructorsUncheckedStack()
  {
    ...
    @Test
    public void testListAddCharUncheckedList()
    {
      var seq=new UncheckedList();
      for(int i=100;--i>=0;)
      {
        //test add at beginning
        seq.add(0,(Character)TypeConversionUtil.convertTochar(i));
      }
      for(int i=0;i<100;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTochar(i)),seq.getChar(i));
      }
      ...
      {
        //add at end
        seq.add(seq.size(),(Character)TypeConversionUtil.convertTochar(i));
      }
      for(int i=100;i<200;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTochar(i+100)),seq.getChar(i));
      }
      currSize=seq.size();
      ...
      {
        //add in middle
        seq.add(100,(Character)TypeConversionUtil.convertTochar(i));
      }
      for(int i=100;i<200;++i)
      {
        Assertions.assertEquals((TypeConversionUtil.convertTochar(i)),seq.getChar(i));
  ...
  public void testConstructorsCheckedStack()
  {
    ...
    @Test
    public void testListAddCharCheckedList()
    {
      ...
      Assertions.assertThrows(IndexOutOfBoundsException.class,()->seq.add(seq.size()+1,TypeConversionUtil.convertTochar(0)));
  ...
  public void testConstructorsCheckedList()
  {
    ...
    @Test
    public void testListAddCharUncheckedSubList()
    {
  ...
  public void testConstructorsUncheckedSubList()
  {
    ...
    @Test
    public void testListAddCharCheckedSubList()
    {
