...
public class ShortDblLnkSeqTest{
    ...
    private static void testListget_intHelper(SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,SequenceLocation seqLocation,ShortOutputTestArgType outputArgType){
      for(int i=0;i<numToAdd;++i){
        seqMonitor.add(i);
      }
      seqMonitor.illegalAdd(preModScenario);
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new ShortDblLnkNode[numThreads];
