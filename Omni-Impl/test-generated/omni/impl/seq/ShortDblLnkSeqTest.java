...
@FunctionalInterface
  ...
  private static class SeqMonitor extends AbstractShortSeqMonitor<ShortDblLnkSeq>{
    ...
    private void verifyEmptyUncheckedSubList(int parentIndex){
      ...
      for(ShortDblLnkSeq currList=(parents=this.parents)[parentIndex],root=parents[parents.length-1];;){
        Assertions.assertNull(currList.head);
        Assertions.assertNull(currList.tail);
        Assertions.assertEquals(0,currList.size);
        if(parentIndex==0){
          Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parent(currList=this.seq));
          Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.root(currList));
          Assertions.assertEquals(0,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parentOffset(currList));
          Assertions.assertNull(currList.head);
          Assertions.assertNull(currList.tail);
          Assertions.assertEquals(0,currList.size);
          return;
        }
        Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parent(currList=parents[--parentIndex]));
        Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.root(currList));
        Assertions.assertEquals(0,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parentOffset(currList));
      }
    }
    private void verifyEmptyCheckedSubList(int parentIndex){
      ...
      for(ShortDblLnkSeq currList=(parents=this.parents)[parentIndex],root=parents[parents.length-1];;){
        if(root!=currList){
          Assertions.assertEquals(expectedParentModCounts[parentIndex],FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.modCount(currList));
        }
        Assertions.assertNull(currList.head);
        Assertions.assertNull(currList.tail);
        Assertions.assertEquals(0,currList.size);
        if(parentIndex==0){
          Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parent(currList=this.seq));
          Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.root(currList));
          Assertions.assertEquals(0,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parentOffset(currList));
          Assertions.assertNull(currList.head);
          Assertions.assertNull(currList.tail);
          Assertions.assertEquals(0,currList.size);
          return;
        }
        Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parent(currList=parents[--parentIndex]));
        Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.root(currList));
        Assertions.assertEquals(0,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parentOffset(currList));
      }
    }
    ...
    /*
      Assertions.assertEquals(expectedParentModCounts[parents.length-1],FieldAndMethodAccessor.ShortDblLnkSeq.CheckedList.modCount(parents[parents.length-1]));
      ...
      if((currSize=(expectedParentSizes=this.expectedParentSizes)[parentIndex=expectedParentSizes.length-1])!=0){
        ...
        for(;;){
          ...
          if(parentIndex==0){
            Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parent(currList=seq));
            Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.root(currList));
          ...
          Assertions.assertSame(parentIndex==parents.length-1?null:currList,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parent(currList=parents[--parentIndex]));
          Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.root(currList));
          Assertions.assertEquals(preAlloc,FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.parentOffset(currList));
          Assertions.assertEquals(expectedParentModCounts[parentIndex],FieldAndMethodAccessor.ShortDblLnkSeq.CheckedSubList.modCount(currList));
    ...
    /*
      ...
      if((currSize=(expectedParentSizes=this.expectedParentSizes)[parentIndex=expectedParentSizes.length-1])!=0){
        ...
        for(;;){
          ...
          if(parentIndex==0){
            Assertions.assertSame(currList,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parent(currList=seq));
            Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.root(currList));
          ...
          Assertions.assertSame(parentIndex==parents.length-1?null:currList,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parent(currList=parents[--parentIndex]));
          Assertions.assertSame(root,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.root(currList));
          Assertions.assertEquals(preAlloc,FieldAndMethodAccessor.ShortDblLnkSeq.UncheckedSubList.parentOffset(currList));
          if((currSize=expectedParentSizes[parentIndex])==0){
            if(head!=tail){
