...
public class IntArrSeqTest{
  ...
  public void testListItrAdd(ListItrAddTestScenario testScenario,IntInputTestArgType inputArgType,ConstructionArguments constructionArgs){
  ...
  public void testremoveVal_ObjectprimitiveVal(QueryTestScenario testScenario,QueryTestPrimitiveInputType inputArgType,StructType structType)
  {
    ...
    boolean removedVal=false;
     switch(testScenario){
      default:
        Assertions.assertEquals(removedVal=int.class.equals(inputArgType.primitiveClass),inputArgType.invokeObjectremoveVal(constructionArgs.seq));
      case EMPTY:
      case DOESNOTCONTAIN:
