...
import omni.impl.seq.IntArrSeqMonitor.NestedType;
...
import omni.impl.seq.IntArrSeqMonitor.QueryTester;
  ...
  interface ArgBuilder{
    ...
    public void testreadAndwriteObject_ObjectInputStream(){
      gettestreadAndwriteObject_ObjectInputStreamArgs().parallel().map(Arguments::get).forEach(args->{
          testreadAndwriteObject_ObjectInputStreamHelper((IntArrSeqMonitor)args[0],(PreModScenario)args[1],(MonitoredFunctionGen)args[2],(SequenceContentsScenario)args[3]);
      });
    }
