...
public class IntArrSeqTest{
  ...
  public void testStackpeek_void(){
    getStackpollpeekAndpop_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testStackpeek_voidHelper((SeqMonitor)args[0],(IntOutputTestArgType)args[1]);
    });
  }
  ...
  public void testStackpop_void(){
    getStackpollpeekAndpop_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testStackpop_voidHelper((SeqMonitor)args[0],(IntOutputTestArgType)args[1]);
    });
  }
  ...
  public void testStackpoll_void(){
    getStackpollpeekAndpop_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testStackpoll_voidHelper((SeqMonitor)args[0],(IntOutputTestArgType)args[1]);
    });
  }
