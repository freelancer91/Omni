...
public class IntArrSeqTest{
  ...
  private static enum InputTestArgType{
     ARRAY_TYPE{
       void callListItrAdd(OmniListIterator.OfInt itr,int valToConvert){
         itr.add(TypeConversionUtil.convertToint(valToConvert));
       }
       void callListItrSet(OmniListIterator.OfInt itr,int valToConvert){
         itr.set(TypeConversionUtil.convertToint(valToConvert));
       }
       void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
         ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertToint(valToConvert));
       }
       void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
         ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertToint(valToConvert));
       }
       void callStackPush(OmniCollection.OfInt seq,int valToConvert){
         ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertToint(valToConvert));
       }
       boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
         return seq.add(TypeConversionUtil.convertToint(valToConvert));
       }
       void verifyIndex(int expectedValToConvert,int actualVal){
         Assertions.assertEquals(TypeConversionUtil.convertToint(expectedValToConvert),actualVal);
       }
     }
    ,
    BOXED_TYPE{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertToInteger(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertToInteger(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertToInteger(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
    ...
    PRIMITIVE_BOOLEAN{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertToboolean(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertToboolean(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertToboolean(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
        return seq.add(TypeConversionUtil.convertToboolean(valToConvert));
      }
      void verifyIndex(int expectedValToConvert,int actualVal){
        Assertions.assertEquals(TypeConversionUtil.convertTointboolean(expectedValToConvert),actualVal);
      }
    }
    ,
    BOXED_BOOLEAN{
    ...
    PRIMITIVE_BYTE{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertTobyte(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertTobyte(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertTobyte(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
    ...
    PRIMTIVE_SHORT{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertToshort(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertToshort(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertToshort(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
    ...
    PRIMITIVE_CHAR{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertTochar(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertTochar(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertTochar(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
    ...
    BOXED_CHAR{
      ...
      void callListPut(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).put(index,TypeConversionUtil.convertToCharacter(valToConvert));
      }
      void callListAdd(OmniCollection.OfInt seq,int index,int valToConvert){
        ((OmniList.OfInt)seq).add(index,TypeConversionUtil.convertToCharacter(valToConvert));
      }
      void callStackPush(OmniCollection.OfInt seq,int valToConvert){
        ((OmniStack.OfInt)seq).push(TypeConversionUtil.convertToCharacter(valToConvert));
      }
      boolean callCollectionAdd(OmniCollection.OfInt seq,int valToConvert){
  ...
  private static class ConstructionArguments{
    ...
    private OmniListIterator.OfInt constructSeqListIterator(){
      return ((OmniList.OfInt)seq).listIterator();
    }
