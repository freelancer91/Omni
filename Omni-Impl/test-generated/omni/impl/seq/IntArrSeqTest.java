...
public class IntArrSeqTest
{
  ...
  //TODO TestRemoveIfMethods<DEFAULT>(Int,)
  //TODO TestRemoveIfMethods<NULL>(Int,)
  //TODO TestRemoveIfMethods<50>(Int,)
  @Test
  ...
  static class MonitoredConsumer extends ArrayList implements IntConsumer
    ,Consumer<Object>
  {
    private static final long serialVersionUID=1L;
    @Override public void accept(int val)
  ...
  private static abstract class AbstractMonitoredPredicate implements IntPredicate
    ,Predicate<Object>
  {
    int callCounter;
