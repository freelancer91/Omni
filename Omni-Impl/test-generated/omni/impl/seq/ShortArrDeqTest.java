...
public class ShortArrDeqTest{
  ...
  public void testelement_void(){
    runOutputTests(true,true,ShortArrDeqTest::testelement_voidHelper);
  }
  ...
  public void testgetFirst_void(){
    runOutputTests(true,true,ShortArrDeqTest::testgetFirst_voidHelper);
  }
  ...
  public void testgetLast_void(){
    runOutputTests(true,true,ShortArrDeqTest::testgetLast_voidHelper);
  }
  ...
  public void testremoveLast_void(){
    runOutputTests(true,true,ShortArrDeqTest::testremoveLast_voidHelper);
  }
  ...
  public void testremoveFirst_void(){
    runOutputTests(true,true,ShortArrDeqTest::testremoveFirst_voidHelper);
  }
  ...
  public void testremove_void(){
    runOutputTests(true,true,ShortArrDeqTest::testremove_voidHelper);
  }
  ...
  public void testpop_void(){
    runOutputTests(true,true,ShortArrDeqTest::testpop_voidHelper);
  }
  ...
  public void testpoll_void(){
    runOutputTests(true,true,ShortArrDeqTest::testpoll_voidHelper);
  }
  ...
  public void testpollFirst_void(){
    runOutputTests(true,true,ShortArrDeqTest::testpollFirst_voidHelper);
  }
  ...
  public void testpollLast_void(){
    runOutputTests(true,true,ShortArrDeqTest::testpollLast_voidHelper);
  }
  ...
  public void testadd_val(){
    runInputTests(true,ShortArrDeqTest::testadd_valHelper);
  }
  ...
  public void testaddLast_val(){
    runInputTests(true,ShortArrDeqTest::testaddLast_valHelper);
  }
  ...
  public void testpush_val(){
    runInputTests(true,ShortArrDeqTest::testpush_valHelper);
  }
  ...
  public void testaddFirst_val(){
    runInputTests(true,ShortArrDeqTest::testaddFirst_valHelper);
  }
  ...
  public void testofferFirst_val(){
    runInputTests(true,ShortArrDeqTest::testofferFirst_valHelper);
  }
  ...
  public void testoffer_val(){
    runInputTests(true,ShortArrDeqTest::testoffer_valHelper);
  }
  ...
  public void tesetofferLast_val(){
    runInputTests(true,ShortArrDeqTest::tesetofferLast_valHelper);
  }
  private static void tesetofferLast_valHelper(CheckedType checkedType,int initialCapacity,int head,int initialSize,ShortInputTestArgType inputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialCapacity,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<100;++i)
