...
interface CharSeqMonitor
{
  interface ItrMonitor
  {
    ...
    CharSeqMonitor getSeqMonitor();
    void verifyNext(int expectedVal,CharOutputTestArgType outputType);
    default void verifyPrevious(int expectedVal,CharOutputTestArgType outputType){
      throw new UnsupportedOperationException();
    }
    void verifyIteratorState();
    default void set(int v,CharInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
    default void set(int v){
      set(v,CharInputTestArgType.ARRAY_TYPE);
    }
    default void add(int v,CharInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
  ...
  static enum MonitoredFunctionGen{
    NoThrow(null,true,true,true){
      ...
      @Override MonitoredObjectInputStream getMonitoredObjectInputStream(File file,CharSeqMonitor seqMonitor) throws IOException{
        return new MonitoredObjectInputStream(file);
      }
      @Override MonitoredObjectOutputStream getMonitoredObjectOutputStream(File file,CharSeqMonitor seqMonitor) throws IOException{
    ...
    MonitoredUnaryOperator getMonitoredUnaryOperator(CharSeqMonitor seqMonitor){
      throw new UnsupportedOperationException();
    }
    ...
    MonitoredArrayConstructor getMonitoredArrayConstructor(CharSeqMonitor seqMonitor){
      throw new UnsupportedOperationException();
    }
    MonitoredObjectInputStream getMonitoredObjectInputStream(File file,CharSeqMonitor seqMonitor) throws IOException{
      throw new UnsupportedOperationException();
    }
    MonitoredObjectOutputStream getMonitoredObjectOutputStream(File file,CharSeqMonitor seqMonitor) throws IOException{
      throw new UnsupportedOperationException();
    }
  }
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyNaturalAscending(CharInputTestArgType inputArgType,int length){
    ...
    public SequenceVerificationItr verifyDescending(int v,CharInputTestArgType inputArgType,int length)
    {
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(CharInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(CharInputTestArgType inputArgType,final int length){
      int v=0;
  ...
  default void add(int index,int val,CharInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void push(int val,CharInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void put(int index,int val,CharInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void removeAt(int expectedVal,CharOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  default void get(int expectedVal,CharOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  void clear();
  default void pop(int expectedVal,CharOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
  default void poll(int expectedVal,CharOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
