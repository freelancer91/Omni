...
public class LongArrDeqTest{
  ...
  public void testpeek_void(){
    runOutputTests(false,true,LongArrDeqTest::testpeek_voidHelper);
  }
  private static void testpeek_voidHelper(CheckedType checkedType,int head,int initialSize,LongOutputTestArgType outputArgType)
  {
  ...
  public void testpeekFirst_void(){
    runOutputTests(false,true,LongArrDeqTest::testpeekFirst_voidHelper);
  }
  private static void testpeekFirst_voidHelper(CheckedType checkedType,int head,int initialSize,LongOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
  ...
  public void testpeekLast_void(){
    runOutputTests(false,true,LongArrDeqTest::testpeekLast_voidHelper);
  }
  private static void testpeekLast_voidHelper(CheckedType checkedType,int head,int initialSize,LongOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
  ...
  private static void testreadandwriteObjectHelper(CheckedType checkedType,MonitoredFunctionGen monitoredFunctionGen,int seqSize,int head
    ...
    if(monitoredFunctionGen.expectedException==null){
      ...
      LongArrDeq readCol=null;
      try(var ois=new ObjectInputStream(new FileInputStream(file));){
        readCol=(LongArrDeq)ois.readObject();
      }catch(Exception e){
        Assertions.fail(e);
        return;
      }
      if(checkedType.checked){
        Assertions.assertEquals(0,((LongArrDeq.Checked)readCol).modCount);
      }
      if(seqSize==0){
        Assertions.assertEquals(-1,readCol.tail);
        Assertions.assertEquals(0,readCol.head);
        Assertions.assertSame(OmniArray.OfLong.DEFAULT_ARR,readCol.arr);
      }else{
        Assertions.assertEquals(0,readCol.head);
        Assertions.assertEquals(seqSize-1,readCol.tail);
        var arr=readCol.arr;
        for(int i=0;i<seqSize;++i){
          Assertions.assertEquals(TypeConversionUtil.convertTolong(i),arr[i]);
        }
      }
    }else{
    ...
    for(var checkedType:CheckedType.values()){
      for(var preModScenario:PreModScenario.values()){
        if(preModScenario.expectedException==null || (preModScenario==PreModScenario.ModSeq && checkedType.checked)){
          for(var itrType:new ItrType[]{ItrType.Itr,ItrType.DescendingItr}){
            Stream.of(LongOutputTestArgType.values())
  ...
  private static void testItrnext_voidHelper(CheckedType checkedType,PreModScenario preModScenario,LongOutputTestArgType outputArgType,ItrType itrType,int seqSize,int head){
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,seqSize,head,seqSize);
    initializeAscending(seqMonitor.seq.arr,head,seqSize);
    var itrMonitor=seqMonitor.getItrMonitor(itrType);
    seqMonitor.illegalAdd(preModScenario);
  ...
  public void testtoArray_void(){
    runOutputTests(false,true,LongArrDeqTest::testtoArray_voidHelper);
  }
  private static void testtoArray_voidHelper(CheckedType checkedType,int head,int initialSize,LongOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
  ...
  public void testMASSIVEtoString_void(){
    ...
    for(int tail=seqLength-1;tail>=(seqLength>>2);tail-=(seqLength>>1)){
      for(var checkedType:CheckedType.values()){
        ...
        AbstractLongSeqMonitor.verifyLargeStr(string,0,seqLength,verifyItr);
      }
    }
  }
  @org.junit.jupiter.api.Test
  public void testhashCode_void(){
    runToStringOrHashCodeTests(false,LongArrDeqTest::testhashCode_voidHelper);
  }
    ...
    }
    {
      ...
      if(size!=0)
      {
        ...
        for(int i=0,j=seqMonitor.seq.head,bound=(arr=seqMonitor.seq.arr).length;i<size;++i){
          expectedHash=(expectedHash*31)+Long.hashCode(arr[j]);
          if(++j==bound){
            j=0;
          }
        }
  ...
  public void testtoString_void(){
    runToStringOrHashCodeTests(false,LongArrDeqTest::testtoString_voidHelper);
  }
  ...
  public void testelement_void(){
    runOutputTests(false,true,LongArrDeqTest::testelement_voidHelper);
  }
  ...
  public void testgetFirst_void(){
    runOutputTests(false,true,LongArrDeqTest::testgetFirst_voidHelper);
  }
  ...
  public void testgetLast_void(){
    runOutputTests(false,true,LongArrDeqTest::testgetLast_voidHelper);
  }
  ...
  public void testremoveLast_void(){
    runOutputTests(false,true,LongArrDeqTest::testremoveLast_voidHelper);
  }
  ...
  public void testremoveFirst_void(){
    runOutputTests(false,true,LongArrDeqTest::testremoveFirst_voidHelper);
  }
  ...
  public void testremove_void(){
    runOutputTests(false,true,LongArrDeqTest::testremove_voidHelper);
  }
  ...
  public void testpop_void(){
    runOutputTests(false,true,LongArrDeqTest::testpop_voidHelper);
  }
  ...
  public void testpoll_void(){
    runOutputTests(false,true,LongArrDeqTest::testpoll_voidHelper);
  }
  ...
  public void testpollFirst_void(){
    runOutputTests(false,true,LongArrDeqTest::testpollFirst_voidHelper);
  }
  ...
  public void testpollLast_void(){
    runOutputTests(false,true,LongArrDeqTest::testpollLast_voidHelper);
  }
  ...
  public void testadd_val(){
    runInputTests(false,LongArrDeqTest::testadd_valHelper);
  }
  ...
  public void testaddLast_val(){
    runInputTests(false,LongArrDeqTest::testaddLast_valHelper);
  }
  ...
  public void testpush_val(){
    runInputTests(false,LongArrDeqTest::testpush_valHelper);
  }
  ...
  public void testaddFirst_val(){
    runInputTests(false,LongArrDeqTest::testaddFirst_valHelper);
  }
  ...
  public void testofferFirst_val(){
    runInputTests(false,LongArrDeqTest::testofferFirst_valHelper);
  }
  ...
  public void testoffer_val(){
    runInputTests(false,LongArrDeqTest::testoffer_valHelper);
  }
  ...
  public void testofferLast_val(){
    runInputTests(false,LongArrDeqTest::testofferLast_valHelper);
  }
  private static void testofferLast_valHelper(CheckedType checkedType,int initialCapacity,int head,int initialSize,LongInputTestArgType inputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialCapacity,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<100;++i)
