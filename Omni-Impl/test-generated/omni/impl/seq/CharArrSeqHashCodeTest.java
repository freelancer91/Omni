...
public class CharArrSeqHashCodeTest
{
//TODO place sanity checks for checked sequence modification behavior
  ...
  public void testEmptyHashCodeArrSeqUncheckedStack()
  {
    ...
    Assertions.assertEquals(expected,new CharArrSeq.UncheckedStack().hashCode());
  }
  @Test
  ...
  {
    var expected=new ArrayList().hashCode();
    Assertions.assertEquals(expected,new CharArrSeq.UncheckedList().hashCode());
  }
  @Test
  ...
  {
    var expected=new ArrayList().hashCode();
    Assertions.assertEquals(expected,new CharArrSeq.CheckedStack().hashCode());
  }
  @Test
  ...
  {
    var expected=new ArrayList().hashCode();
    Assertions.assertEquals(expected,new CharArrSeq.CheckedList().hashCode());
  }
  @Test
  ...
  {
    var expected=new ArrayList().hashCode();
    Assertions.assertEquals(expected,new CharArrSeq.UncheckedList().subList(0,0).hashCode());
  }
  @Test
