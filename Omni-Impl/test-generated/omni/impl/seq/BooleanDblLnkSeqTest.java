...
public class BooleanDblLnkSeqTest{
              ...
              for(var monitoredRemoveIfPredicateGen:MonitoredRemoveIfPredicateGen.values()){
                ...
                for(int seqSize=0;seqSize<=10;++seqSize){
                  ...
                  for(long tmpRandSeed=0;tmpRandSeed<=randSeedBound;++tmpRandSeed){
                    ...
                    for(int tmpPeriod=1;tmpPeriod<limit;tmpPeriod+=inc){
                      ...
                      for(int initVal=0;initVal<=1;++initVal){
                        ...
                        switch(nestedType){
                          ...
                          case LISTDEQUE:
                            submitTest(()->testremoveIf_PredicateHelper(new SeqMonitor(nestedType,checkedType),preModScenario,monitoredRemoveIfPredicateGen,0.5,randSeed,functionCallType,finalSeqSize,finalInitVal,period));
                        }
                      }
                    }
                  }
    ...
    private static void testListget_intHelper(SeqMonitor seqMonitor,PreModScenario preModScenario,int numToAdd,SequenceLocation seqLocation,BooleanOutputTestArgType outputArgType){
      for(int i=0;i<numToAdd;++i){
        seqMonitor.add(i);
      }
      seqMonitor.illegalAdd(preModScenario);
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new BooleanDblLnkNode[numThreads];
