    ...
    public void testMASSIVEtoString_void(){
      ...
      for(var nestedType:NestedType.values()){
        for(var checkedType:CheckedType.values()){
          ...
          EXECUTORSERVICE.completeAllTests("BooleanDblLnkSeqTest.testMASSIVEtoString_void checkedType="+checkedType+"; nestedType="+nestedType);
                  ...
                  for(int tmpPeriod=1;;tmpPeriod+=inc){
                    ...
                    for(int initVal=0;initVal<=1;++initVal){
                      ...
                      switch(nestedType){
                        ...
                        case LISTDEQUE:
                          EXECUTORSERVICE.submitTest(()->testremoveIf_PredicateHelper(new SeqMonitor(nestedType,checkedType),preModScenario,monitoredRemoveIfPredicateGen,0.5,randSeed,functionCallType,finalSeqSize,finalInitVal,period));
                      }
                    }
