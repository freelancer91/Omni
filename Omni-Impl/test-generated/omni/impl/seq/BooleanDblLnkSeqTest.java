  ...
  private static class SeqMonitor extends AbstractBooleanSeqMonitor<BooleanDblLnkSeq>{
    ...
    private static class DblLnkSeqVerificationItr extends SequenceVerificationItr{
      ...
      @Override SequenceVerificationItr getOffset(int i){
        return new DblLnkSeqVerificationItr(i<0?BooleanDblLnkNode.uncheckedIterateDescending(this.curr,i):BooleanDblLnkNode.iterateAscending(this.curr,i),seqMonitor);
      }
      @Override SequenceVerificationItr skip(int i){
        BooleanDblLnkNode curr;
        this.curr=i<0?BooleanDblLnkNode.uncheckedIterateDescending(this.curr,i):BooleanDblLnkNode.iterateAscending(this.curr,i);
        return this;
      }
