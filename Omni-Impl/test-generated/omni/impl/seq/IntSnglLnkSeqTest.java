...
public class IntSnglLnkSeqTest{
  ...
  public void testItrnext_void(){
    getItrnext_voidArgs().parallel().map(Arguments::get).forEach(args->{
        testItrnext_voidHelper((SeqMonitor)args[0],(IterationScenario)args[1],(int)args[2],(IntOutputTestArgType)args[3]);
    });
  }
  ...
  public void testMASSIVEtoString_void(){
    ...
    var wayPointNodes=new IntSnglLnkNode[numThreads];
