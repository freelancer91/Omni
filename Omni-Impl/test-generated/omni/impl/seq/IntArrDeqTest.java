...
public class IntArrDeqTest{
  ...
  public void testpeek_void(){
    runOutputTests(false,true,IntArrDeqTest::testpeek_voidHelper);
  }
  private static void testpeek_voidHelper(CheckedType checkedType,int head,int initialSize,IntOutputTestArgType outputArgType)
  {
  ...
  public void testpeekFirst_void(){
    runOutputTests(false,true,IntArrDeqTest::testpeekFirst_voidHelper);
  }
  private static void testpeekFirst_voidHelper(CheckedType checkedType,int head,int initialSize,IntOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
  ...
  public void testpeekLast_void(){
    runOutputTests(false,true,IntArrDeqTest::testpeekLast_voidHelper);
  }
  private static void testpeekLast_voidHelper(CheckedType checkedType,int head,int initialSize,IntOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<initialSize;++i)
    ...
    for(var checkedType:CheckedType.values()){
      for(var preModScenario:PreModScenario.values()){
        if(preModScenario.expectedException==null || (preModScenario==PreModScenario.ModSeq && checkedType.checked)){
          for(var itrType:new ItrType[]{ItrType.Itr,ItrType.DescendingItr}){
            Stream.of(IntOutputTestArgType.values())
  ...
  public void testtoArray_void(){
    runOutputTests(false,true,IntArrDeqTest::testtoArray_voidHelper);
  }
  private static void testtoArray_voidHelper(CheckedType checkedType,int head,int initialSize,IntOutputTestArgType outputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialSize,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
  ...
  public void testhashCode_void(){
    runToStringOrHashCodeTests(false,IntArrDeqTest::testhashCode_voidHelper);
  }
  ...
  public void testtoString_void(){
    runToStringOrHashCodeTests(false,IntArrDeqTest::testtoString_voidHelper);
  }
  ...
  public void testelement_void(){
    runOutputTests(false,true,IntArrDeqTest::testelement_voidHelper);
  }
  ...
  public void testgetFirst_void(){
    runOutputTests(false,true,IntArrDeqTest::testgetFirst_voidHelper);
  }
  ...
  public void testgetLast_void(){
    runOutputTests(false,true,IntArrDeqTest::testgetLast_voidHelper);
  }
  ...
  public void testremoveLast_void(){
    runOutputTests(false,true,IntArrDeqTest::testremoveLast_voidHelper);
  }
  ...
  public void testremoveFirst_void(){
    runOutputTests(false,true,IntArrDeqTest::testremoveFirst_voidHelper);
  }
  ...
  public void testremove_void(){
    runOutputTests(false,true,IntArrDeqTest::testremove_voidHelper);
  }
  ...
  public void testpop_void(){
    runOutputTests(false,true,IntArrDeqTest::testpop_voidHelper);
  }
  ...
  public void testpoll_void(){
    runOutputTests(false,true,IntArrDeqTest::testpoll_voidHelper);
  }
  ...
  public void testpollFirst_void(){
    runOutputTests(false,true,IntArrDeqTest::testpollFirst_voidHelper);
  }
  ...
  public void testpollLast_void(){
    runOutputTests(false,true,IntArrDeqTest::testpollLast_voidHelper);
  }
  ...
  public void testadd_val(){
    runInputTests(false,IntArrDeqTest::testadd_valHelper);
  }
  ...
  public void testaddLast_val(){
    runInputTests(false,IntArrDeqTest::testaddLast_valHelper);
  }
  ...
  public void testpush_val(){
    runInputTests(false,IntArrDeqTest::testpush_valHelper);
  }
  ...
  public void testaddFirst_val(){
    runInputTests(false,IntArrDeqTest::testaddFirst_valHelper);
  }
  ...
  public void testofferFirst_val(){
    runInputTests(false,IntArrDeqTest::testofferFirst_valHelper);
  }
  ...
  public void testoffer_val(){
    runInputTests(false,IntArrDeqTest::testoffer_valHelper);
  }
  ...
  public void testofferLast_val(){
    runInputTests(false,IntArrDeqTest::testofferLast_valHelper);
  }
  private static void testofferLast_valHelper(CheckedType checkedType,int initialCapacity,int head,int initialSize,IntInputTestArgType inputArgType)
  {
    SeqMonitor seqMonitor=new SeqMonitor(checkedType,initialCapacity,head,initialSize);
    initializeAscending(seqMonitor.seq.arr,head,initialSize);
    for(int i=0;i<100;++i)
