...
//ENDIF
    ...
    for(int i=0;i<100;++i)
    {
      var putVal=TypeConversionUtil.convertTodouble(100-i-1);
      seq.put(i,putVal);
//IF 
      var expectedVal=TypeConversionUtil.convertTodouble(100-i-1);
...
//ENDIF
    ...
    for(int i=0;i<100;++i)
    {
      ...
      seq.put(i,putVal);
//IF 
      var expectedVal=TypeConversionUtil.convertTodoubleboolean(100-i-1);
      Assertions.assertEquals(expectedVal,seq.arr[i]);
//ENDIF
      Assertions.assertEquals(100,seq.size());
    }
...
//ENDIF
    ...
    Assertions.assertThrows(IndexOutOfBoundsException.class,()->seq.put(seq.size(),TypeConversionUtil.convertTodouble(5)));
    Assertions.assertEquals(100,seq.size());
    Assertions.assertEquals(100,seq.modCount);
    for(int i=0;i<100;++i)
    {
