...
class RefSnglLnkSeqMonitor implements RefSeqMonitor{
  ...
  RefSnglLnkSeqMonitor(NestedType nestedType,CheckedType checkedType,RefSnglLnkNode head,int seqSize,RefSnglLnkNode tail){
    this.nestedType=nestedType;
    this.checkedType=checkedType;
    this.expectedSeqSize=seqSize;
    switch(nestedType){
      case QUEUE:
        this.seq=checkedType.checked?new RefSnglLnkSeq.CheckedQueue(head,seqSize,tail):new RefSnglLnkSeq.UncheckedQueue(head,seqSize,tail);
        break;
      case STACK:
        this.seq=checkedType.checked?new RefSnglLnkSeq.CheckedStack(head,seqSize):new RefSnglLnkSeq.UncheckedStack(head,seqSize);
        break;
      default:
