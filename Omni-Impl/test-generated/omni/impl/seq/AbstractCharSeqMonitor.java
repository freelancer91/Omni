...
abstract class AbstractCharSeqMonitor<SEQ extends OmniCollection.OfChar>
{
  ...
  abstract void clear();
  abstract void verifyRemoveIf(MonitoredRemoveIfPredicate pred,FunctionCallType functionCallType,int expectedNumRemoved,OmniCollection.OfChar clone);
  ...
  static enum MonitoredComparatorGen{
    ...
    abstract void initHelper(AbstractCharSeqMonitor seqMonitor);
    void initReverseHelper(AbstractCharSeqMonitor seqMonitor){
      throw new UnsupportedOperationException();
    }
    void init(AbstractCharSeqMonitor seqMonitor,SequenceContentsScenario seqContentsScenario,PreModScenario preModScenario){
    ...
    void initReverse(AbstractCharSeqMonitor seqMonitor,SequenceContentsScenario seqContentsScenario,PreModScenario preModScenario){
      if(seqContentsScenario.nonEmpty){
    ...
    void assertSorted(AbstractCharSeqMonitor seqMonitor,SequenceContentsScenario seqContentsScenario,PreModScenario preModScenario){
    ...
    void assertReverseSorted(AbstractCharSeqMonitor seqMonitor,SequenceContentsScenario seqContentsScenario,PreModScenario preModScenario){
      seqMonitor.verifyStructuralIntegrity();
      var verifyItr=seqMonitor.verifyPreAlloc();
      if(seqContentsScenario.nonEmpty){
  ...
  static enum QueryTester
  {
    Booleannull(false){
      ...
      void addEqualsVal(AbstractCharSeqMonitor seqMonitor){
        throw new UnsupportedOperationException();
      }
      void addNotEqualsVal(AbstractCharSeqMonitor seqMonitor){
