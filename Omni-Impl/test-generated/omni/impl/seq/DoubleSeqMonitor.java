...
interface DoubleSeqMonitor
{
  interface ItrMonitor
  {
    ...
    DoubleSeqMonitor getSeqMonitor();
    void verifyNext(int expectedVal,DoubleOutputTestArgType outputType);
    default void verifyPrevious(int expectedVal,DoubleOutputTestArgType outputType){
      throw new UnsupportedOperationException();
    }
    void verifyIteratorState();
    default void set(int v,DoubleInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
    default void set(int v){
      set(v,DoubleInputTestArgType.ARRAY_TYPE);
    }
    default void add(int v,DoubleInputTestArgType inputArgType){
      throw new UnsupportedOperationException();
    }
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyDescending(int v,DoubleInputTestArgType inputArgType,int length)
    {
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(DoubleInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(DoubleInputTestArgType inputArgType,final int length){
      int v=0;
  ...
  default void add(int index,int val,DoubleInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void push(int val,DoubleInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void put(int index,int val,DoubleInputTestArgType inputArgType)
  {
    throw new UnsupportedOperationException();
  }
  ...
  default void removeAt(int expectedVal,DoubleOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  default void get(int expectedVal,DoubleOutputTestArgType outputType,int index){
    throw new UnsupportedOperationException();
  }
  void clear();
  default void pop(int expectedVal,DoubleOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
  default void poll(int expectedVal,DoubleOutputTestArgType outputType)
  {
    throw new UnsupportedOperationException();
  }
