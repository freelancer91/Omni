...
//ENDIF
    ...
    verifyAscendingSpanboolean(root.arr,i,rootSize+100,100);
  }
  @ParameterizedTest
  //IF STRUCT==List
  @ValueSource(ints={0,5,10,15})
...
//ENDIF
    ...
    assertStructuralIntegrity(seq,100,100,parent,100+parentSize,100,root,100+rootSize,100);
    verifyAscendingSpanboolean(root.arr,0,rootSize+100,-preAllocSpan);
  }
  @ParameterizedTest
  //IF STRUCT==List
  @ValueSource(ints={0,5,10,15})
...
//ENDIF
    ...
    verifyAscendingSpanboolean(root.arr,i,rootSize+100,i);
  }
  @ParameterizedTest
  //IF STRUCT==List
  @ValueSource(ints={0,5,10,15})
...
//ENDIF
  ...
  private static BooleanArrSeq assertStructuralIntegrity(Object seq,int expectedSeqSize,int expectedSeqModCount,Object expectedParent,int expectedParentSize,int expectedParentModCount,BooleanArrSeq expectedRoot,int expectedRootSize,int expectedRootModCount)
  {
    if(seq==expectedRoot)
    {
      ...
      {
        Assertions.assertEquals(expectedSeqModCount,FieldAccessor.BooleanArrSeq.CheckedList.modCount(seq));
      }
      else if(seq instanceof BooleanArrSeq.CheckedStack)
      {
        Assertions.assertEquals(expectedSeqModCount,FieldAccessor.BooleanArrSeq.CheckedStack.modCount(seq));
      }
    }
    else
    {
