...
public class FloatArrSeqTest{
  ...
  private static enum InputTestArgType{
     ARRAY_TYPE{
       void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertTofloat(valToConvert));}
       void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertTofloat(valToConvert));}
       void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertTofloat(valToConvert));}
       void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertTofloat(valToConvert));}
       void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertTofloat(valToConvert));}
       boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertTofloat(valToConvert));}
       void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
     }
    ,
    BOXED_TYPE{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToFloat(valToConvert));}
    ...
    ,
    PRIMITIVE_BOOLEAN{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToboolean(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertToboolean(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertToboolean(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertToboolean(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertToboolean(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertToboolean(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloatboolean(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_BOOLEAN{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToBoolean(valToConvert));}
    ...
    ,
    PRIMITIVE_BYTE{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertTobyte(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertTobyte(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertTobyte(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertTobyte(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertTobyte(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertTobyte(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_BYTE{
    ...
    ,
    PRIMTIVE_SHORT{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToshort(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertToshort(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertToshort(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertToshort(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertToshort(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertToshort(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_SHORT{
    ...
    ,
    PRIMITIVE_CHAR{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertTochar(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertTochar(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertTochar(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertTochar(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertTochar(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertTochar(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_CHAR{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToCharacter(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertToCharacter(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertToCharacter(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertToCharacter(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertToCharacter(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertToCharacter(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    PRIMITIVE_INT{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToint(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertToint(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertToint(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertToint(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertToint(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertToint(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_INT{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertToInteger(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertToInteger(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertToInteger(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertToInteger(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertToInteger(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertToInteger(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    PRIMITIVE_LONG{
      void callListItrAdd(OmniListIterator.OfFloat itr,int valToConvert){itr.add(TypeConversionUtil.convertTolong(valToConvert));}
      void callListItrSet(OmniListIterator.OfFloat itr,int valToConvert){itr.set(TypeConversionUtil.convertTolong(valToConvert));}
      void callListPut(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).put(index,TypeConversionUtil.convertTolong(valToConvert));}
      void callListAdd(OmniCollection.OfFloat seq,int index,int valToConvert){((OmniList.OfFloat)seq).add(index,TypeConversionUtil.convertTolong(valToConvert));}
      void callStackPush(OmniCollection.OfFloat seq,int valToConvert){((OmniStack.OfFloat)seq).push(TypeConversionUtil.convertTolong(valToConvert));}
      boolean callCollectionAdd(OmniCollection.OfFloat seq,int valToConvert){return seq.add(TypeConversionUtil.convertTolong(valToConvert));}
      void verifyIndex(int expectedValToConvert,float actualVal){Assertions.assertEquals(TypeConversionUtil.convertTofloat(expectedValToConvert),actualVal);}
    }
    ,
    BOXED_LONG{
  ...
  private static class ConstructionArguments{
    ...
    private void verifyStructuralIntegrity(int expectedSeqSize,int expectedModCount,int expectedParentSize,int expectedParentModCount,int expectedRootSize,int expectedRootModCount){
      switch(structType){
        case STACK:
          if(checked){Assertions.assertEquals(expectedRootModCount,FieldAccessor.FloatArrSeq.CheckedStack.modCount(root));}
          break;
        case LIST:
          if(checked){Assertions.assertEquals(expectedRootModCount,FieldAccessor.FloatArrSeq.CheckedList.modCount(root));}
          break;
        default:
