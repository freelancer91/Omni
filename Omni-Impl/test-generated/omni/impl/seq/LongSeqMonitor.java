...
class LongSeqMonitor{
  ...
  LongSeqMonitor(NestedType nestedType,CheckedType checkedType,int seqLength,long[] arr){
      ...
      case ARRSEQ:
        switch(nestedType){
          ...
          case SUBLIST:
            if(checkedType.checked)
            {
              FieldAccessor.LongArrSeq.CheckedSubList.readObject(seq,ois);
            }
            else
            {
              FieldAccessor.LongArrSeq.UncheckedSubList.readObject(seq,ois);
            }
            break;
          default:
            throw new Error("Unknown nestedType "+nestedType);
      ...
      case ARRSEQ:
        switch(nestedType){
          ...
          case SUBLIST:
            if(checkedType.checked)
            {
              FieldAccessor.LongArrSeq.CheckedSubList.writeObject(seq,oos);
            }
            else
            {
              FieldAccessor.LongArrSeq.UncheckedSubList.writeObject(seq,oos);
            }
            break;
          default:
            throw new Error("Unknown nestedType "+nestedType);
