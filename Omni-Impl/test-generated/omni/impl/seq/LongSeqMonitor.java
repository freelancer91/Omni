...
interface LongSeqMonitor
{
  ...
  public static abstract class SequenceVerificationItr{
    ...
    public SequenceVerificationItr verifyDescending(int v,LongInputTestArgType inputArgType,int length)
    {
    ...
    public SequenceVerificationItr verifyNearBeginningInsertion(LongInputTestArgType inputArgType,final int length){
      int v=3;
    ...
    public SequenceVerificationItr verifyNearEndInsertion(LongInputTestArgType inputArgType,final int length){
      int v=0;
