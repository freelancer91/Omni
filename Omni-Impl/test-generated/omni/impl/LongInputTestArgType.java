...
public enum LongInputTestArgType{
  ARRAY_TYPE{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertTolong(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertTolong(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertTolong(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertTolong(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertTolong(valToConvert));}
  ...
  ,
  PRIMITIVE_BOOLEAN{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToboolean(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertToboolean(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertToboolean(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertToboolean(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertToboolean(valToConvert));}
  ...
  ,
  PRIMITIVE_BYTE{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertTobyte(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertTobyte(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertTobyte(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertTobyte(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertTobyte(valToConvert));}
    ...
    public void verifyVal(int expectedValToConvert,long actualVal){Assertions.assertEquals(TypeConversionUtil.convertTolongbyte(expectedValToConvert),actualVal);}
  }
  ,
  BOXED_BYTE{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToByte(valToConvert));}
  ...
  ,
  PRIMTIVE_SHORT{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToshort(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertToshort(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertToshort(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertToshort(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertToshort(valToConvert));}
  ...
  BOXED_SHORT{
    ...
    public void callStackPush(OmniCollection.OfLong seq,int valToConvert){((OmniStack.OfLong)seq).push(TypeConversionUtil.convertToShort(valToConvert));}
    public boolean callCollectionAdd(OmniCollection.OfLong seq,int valToConvert){return seq.add(TypeConversionUtil.convertToShort(valToConvert));}
    public void verifyVal(int expectedValToConvert,long actualVal){Assertions.assertEquals(TypeConversionUtil.convertTolongshort(expectedValToConvert),actualVal);}
  }
  ,
  PRIMITIVE_CHAR{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertTochar(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertTochar(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertTochar(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertTochar(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertTochar(valToConvert));}
    ...
    public void verifyVal(int expectedValToConvert,long actualVal){Assertions.assertEquals(TypeConversionUtil.convertTolongchar(expectedValToConvert),actualVal);}
  }
  ,
  BOXED_CHAR{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToCharacter(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertToCharacter(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertToCharacter(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertToCharacter(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertToCharacter(valToConvert));}
  ...
  ,
  PRIMITIVE_INT{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToint(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertToint(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertToint(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertToint(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertToint(valToConvert));}
  ...
  ,
  BOXED_INT{
    public void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addLast(TypeConversionUtil.convertToInteger(valToConvert));}
    public void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert){((OmniDeque.OfLong)seq).addFirst(TypeConversionUtil.convertToInteger(valToConvert));}
    public boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerLast(TypeConversionUtil.convertToInteger(valToConvert));}
    public boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert){return ((OmniDeque.OfLong)seq).offerFirst(TypeConversionUtil.convertToInteger(valToConvert));}
    public boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert){return ((OmniQueue.OfLong)seq).offer(TypeConversionUtil.convertToInteger(valToConvert));}
  ...
  ;
    public abstract void callDequeAddLast(OmniCollection.OfLong seq,int valToConvert);
    public abstract void callDequeAddFirst(OmniCollection.OfLong seq,int valToConvert);
    public abstract boolean callDequeOfferLast(OmniCollection.OfLong seq,int valToConvert);
    public abstract boolean callDequeOfferFirst(OmniCollection.OfLong seq,int valToConvert);
    public abstract boolean callQueueOffer(OmniCollection.OfLong seq,int valToConvert);
