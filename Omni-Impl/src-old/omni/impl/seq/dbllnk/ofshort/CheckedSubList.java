...
public class CheckedSubList extends AbstractSeq{
  ...
  @Override public boolean remove(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Short){ return uncheckedRemoveFirstMatch(head,(short)val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(char val){
    Node head;
    if(val<=Short.MAX_VALUE&&(head=this.head)!=null){ return uncheckedRemoveFirstMatch(head,val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  @Override public boolean removeVal(double val){
    Node head;
    int v;
    if((head=this.head)!=null&&val==(v=(short)val)){ return uncheckedRemoveFirstMatch(head,v); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(int val){
    Node head;
    if((head=this.head)!=null&&val==(short)val){ return uncheckedRemoveFirstMatch(head,val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  void appendHelper(short val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  void initHelper(Checked root,short val,int modCount){
  ...
  void prependHelper(short val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  private void collapseHeadAndTail(int modCount,Node headCandidate,Node tailCandidate,final ShortPredicate filter){
    int size=this.size;
    int numConsumed=2;
    final var root=this.root;
    for(;;){
  ...
  private void insertHelper(Node before,short val,Node after,int modCount){
  ...
  private void rootCollapseHead(int modCount,Node headCandidate,final Node oldTail,ShortPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void rootCollapseTail(int modCount,final Node oldHead,Node tailCandidate,ShortPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void suffixCollapseHead(int modCount,Node oldHead,Node oldTail,ShortPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void uncheckedAddLast(short val){
    if(++size!=1){
      appendHelper(val,modCount);
    }else{
      initHelper(root,val,modCount);
  ...
  static class Body extends CheckedSubList.Prefix{
    ...
    @Override void findNewHead(int modCount,Node curr,ShortPredicate filter){
      final Node tail;
      if(curr==(tail=this.tail)){
        Checked root;
        CheckedCollection.checkModCount(modCount,(root=this.root).modCount);
    ...
    @Override void initHelper(Checked root,short val,int modCount){
      final Node newNode;
    ...
    @Override void prependHelper(short val,int modCount){
      this.modCount=modCount;
    ...
    private OmniList.OfShort getEmptySubList(Checked root,int headDist){
      return new CheckedSubList.Body(root,this,headDist);
    }
    private OmniList.OfShort getSubList1(Checked root,int headDist,int tailDist){
      return new CheckedSubList.Body(root,this,staticGetNode(this,headDist,tailDist),headDist);
  ...
  static class Prefix extends CheckedSubList{
    ...
    @Override void appendHelper(short val,int modCount){
      this.modCount=modCount;
    ...
    @Override boolean removeIfHelper(int modCount,Node curr,ShortPredicate filter){
      final Node tail;
      if(curr!=(tail=this.tail)){
        if(filter.test(tail.val)){
    ...
    private void collapseHeadAndTail(int modCount,Node headCandidate,Node tail,ShortPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
    ...
    private void prefixCollapseTail(int modCount,Node oldHead,Node oldTail,ShortPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
  ...
  static class Suffix extends CheckedSubList{
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tailCandidate,ShortPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends CheckedAscendingSubItr implements OmniListIterator.OfShort{
