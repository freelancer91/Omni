...
class CheckedSubList extends AbstractSeq{
  ...
  @Override public boolean add(boolean val){
    ...
    uncheckedAddLast(TypeUtil.castToFloat(val));
    ++root.size;
    return true;
  }
  ...
  @Override public boolean remove(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Float){ return uncheckedRemoveFirstMatch(head,(float)val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(double val){
    ...
    if((head=this.head)!=null){
      float v;
      if(val==(v=(float)val)){
        return uncheckedRemoveFirstFltBits(head,Float.floatToRawIntBits(v));
      }else if(v!=v){ return uncheckedRemoveFirstFltNaN(head); }
    }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(int val){
    ...
    if((head=this.head)!=null){
      if(val!=0){
        if(TypeUtil.checkCastToFloat(val)){ return uncheckedRemoveFirstFltBits(head,Float.floatToRawIntBits(val)); }
      }else{
        return uncheckedRemoveFirstFlt0(head);
      }
    }
  ...
  @Override protected boolean removeRawInt(int val){
    Node head;
    if((head=this.head)!=null){ return uncheckedRemoveFirstRawInt(head,val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  void appendHelper(float val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  void initHelper(Checked root,float val,int modCount){
  ...
  void prependHelper(float val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  @Override boolean uncheckedRemoveFirstFlt0(Node head){
    ...
    try{
      ...
      return uncheckedRemoveFirstFlt0Helper(modCount,head);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstFlt0Helper(int modCount,Node curr){
  ...
  @Override boolean uncheckedRemoveFirstFltBits(Node head,int fltBits){
    ...
    try{
      ...
      return uncheckedRemoveFirstFltBitsHelper(modCount,head,fltBits);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstFltBitsHelper(int modCount,Node curr,int fltBits){
    final var root=this.root;
    final var tail=this.tail;
    Node prev;
    do{
  ...
  @Override boolean uncheckedRemoveFirstFltNaN(Node head){
    ...
    try{
      ...
      return uncheckedRemoveFirstFltNaNHelper(modCount,head);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstFltNaNHelper(int modCount,Node curr){
    final var root=this.root;
    final var tail=this.tail;
    Node prev;
    do{
  ...
  private void collapseHeadAndTail(int modCount,Node headCandidate,Node tailCandidate,final FloatPredicate filter){
    int size=this.size;
    int numConsumed=2;
    final var root=this.root;
    for(;;){
  ...
  private void insertHelper(Node before,float val,Node after,int modCount){
  ...
  private void rootCollapseHead(int modCount,Node headCandidate,final Node oldTail,FloatPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void rootCollapseTail(int modCount,final Node oldHead,Node tailCandidate,FloatPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void suffixCollapseHead(int modCount,Node oldHead,Node oldTail,FloatPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void uncheckedAddLast(float val){
    if(++size!=1){
      appendHelper(val,modCount);
    }else{
      initHelper(root,val,modCount);
  ...
  static class Body extends CheckedSubList.Prefix{
    ...
    @Override void findNewHead(int modCount,Node curr,FloatPredicate filter){
      final Node tail;
      if(curr==(tail=this.tail)){
        Checked root;
        CheckedCollection.checkModCount(modCount,(root=this.root).modCount);
    ...
    @Override void initHelper(Checked root,float val,int modCount){
      final Node newNode;
    ...
    @Override void prependHelper(float val,int modCount){
      this.modCount=modCount;
    ...
    private OmniList.OfFloat getEmptySubList(Checked root,int headDist){
      return new CheckedSubList.Body(root,this,headDist);
    }
    private OmniList.OfFloat getSubList1(Checked root,int headDist,int tailDist){
      return new CheckedSubList.Body(root,this,staticGetNode(this,headDist,tailDist),headDist);
  ...
  static class Prefix extends CheckedSubList{
    ...
    @Override void appendHelper(float val,int modCount){
      this.modCount=modCount;
    ...
    @Override boolean removeIfHelper(int modCount,Node curr,FloatPredicate filter){
      final Node tail;
      if(curr!=(tail=this.tail)){
        if(filter.test(tail.val)){
    ...
    @Override boolean uncheckedRemoveFirstFlt0Helper(int modCount,Node curr){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    @Override boolean uncheckedRemoveFirstFltBitsHelper(int modCount,Node curr,int fltBits){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    @Override boolean uncheckedRemoveFirstFltNaNHelper(int modCount,Node curr){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    private void collapseHeadAndTail(int modCount,Node headCandidate,Node tail,FloatPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
    ...
    private void prefixCollapseTail(int modCount,Node oldHead,Node oldTail,FloatPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
  ...
  static class Suffix extends CheckedSubList{
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tailCandidate,FloatPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends CheckedAscendingSubItr implements OmniListIterator.OfFloat{
