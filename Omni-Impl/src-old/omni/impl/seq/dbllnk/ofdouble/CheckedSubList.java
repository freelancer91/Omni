...
class CheckedSubList extends AbstractSeq{
  ...
  @Override public boolean add(boolean val){
    ...
    uncheckedAddLast(TypeUtil.castToDouble(val));
    ++root.size;
    return true;
  }
  ...
  @Override public boolean remove(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Double){ return uncheckedRemoveFirstMatch(head,(double)val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(long val){
    ...
    if((head=this.head)!=null){
      if(val!=0){
        if(TypeUtil.checkCastToDouble(val)){ return uncheckedRemoveFirstDblBits(head,Double.doubleToRawLongBits(val)); }
      }else{
        return uncheckedRemoveFirstDbl0(head);
      }
    }
  ...
  void appendHelper(double val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  void initHelper(Checked root,double val,int modCount){
  ...
  void prependHelper(double val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  @Override boolean uncheckedRemoveFirstDbl0(Node head){
    ...
    try{
      ...
      return uncheckedRemoveFirstDbl0Helper(modCount,head);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstDbl0Helper(int modCount,Node curr){
  ...
  @Override boolean uncheckedRemoveFirstDblBits(Node head,long dblBits){
    ...
    try{
      ...
      return uncheckedRemoveFirstDblBitsHelper(modCount,head,dblBits);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstDblBitsHelper(int modCount,Node curr,long dblBits){
    final var root=this.root;
    final var tail=this.tail;
    Node prev;
    do{
  ...
  @Override boolean uncheckedRemoveFirstDblNaN(Node head){
    ...
    try{
      ...
      return uncheckedRemoveFirstDblNaNHelper(modCount,head);
    }catch(final RuntimeException e){
      throw CheckedCollection.checkModCount(modCount,root.modCount,e);
    }
  }
  boolean uncheckedRemoveFirstDblNaNHelper(int modCount,Node curr){
    final var root=this.root;
    final var tail=this.tail;
    Node prev;
    do{
  ...
  private void collapseHeadAndTail(int modCount,Node headCandidate,Node tailCandidate,final DoublePredicate filter){
    int size=this.size;
    int numConsumed=2;
    final var root=this.root;
    for(;;){
  ...
  private void insertHelper(Node before,double val,Node after,int modCount){
  ...
  private void rootCollapseHead(int modCount,Node headCandidate,final Node oldTail,DoublePredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void rootCollapseTail(int modCount,final Node oldHead,Node tailCandidate,DoublePredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void suffixCollapseHead(int modCount,Node oldHead,Node oldTail,DoublePredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void uncheckedAddLast(double val){
    if(++size!=1){
      appendHelper(val,modCount);
    }else{
      initHelper(root,val,modCount);
  ...
  static class Body extends CheckedSubList.Prefix{
    ...
    @Override void findNewHead(int modCount,Node curr,DoublePredicate filter){
      final Node tail;
      if(curr==(tail=this.tail)){
        Checked root;
        CheckedCollection.checkModCount(modCount,(root=this.root).modCount);
    ...
    @Override void initHelper(Checked root,double val,int modCount){
      final Node newNode;
    ...
    @Override void prependHelper(double val,int modCount){
      this.modCount=modCount;
    ...
    private OmniList.OfDouble getEmptySubList(Checked root,int headDist){
      return new CheckedSubList.Body(root,this,headDist);
    }
    private OmniList.OfDouble getSubList1(Checked root,int headDist,int tailDist){
      return new CheckedSubList.Body(root,this,staticGetNode(this,headDist,tailDist),headDist);
  ...
  static class Prefix extends CheckedSubList{
    ...
    @Override void appendHelper(double val,int modCount){
      this.modCount=modCount;
    ...
    @Override boolean removeIfHelper(int modCount,Node curr,DoublePredicate filter){
      final Node tail;
      if(curr!=(tail=this.tail)){
        if(filter.test(tail.val)){
    ...
    @Override boolean uncheckedRemoveFirstDbl0Helper(int modCount,Node curr){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    @Override boolean uncheckedRemoveFirstDblBitsHelper(int modCount,Node curr,long dblBits){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    @Override boolean uncheckedRemoveFirstDblNaNHelper(int modCount,Node curr){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    private void collapseHeadAndTail(int modCount,Node headCandidate,Node tail,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
    ...
    private void prefixCollapseTail(int modCount,Node oldHead,Node oldTail,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
  ...
  static class Suffix extends CheckedSubList{
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tailCandidate,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends CheckedAscendingSubItr implements OmniListIterator.OfDouble{
