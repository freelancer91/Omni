...
abstract class AbstractSeq<E>extends AbstractRefList<E>{
  ...
  static int uncheckedIndexOfMatch(Object[] arr,int offset,int bound,Predicate<Object> pred){
    int index=offset;
    do{
  ...
  static int uncheckedIndexOfMatch(Object[] arr,int size,Predicate<Object> pred){
    int index=0;
    do{
  ...
  static int uncheckedLastIndexOfMatch(Object[] arr,int offset,int bound,Predicate<Object> pred){
    do{
  ...
  public int indexOf(boolean val){
    final int size;
    if((size=this.size)!=0){ return uncheckedIndexOfMatch(arr,size,OmniPred.OfRef.getEqualsPred(val)); }
    return -1;
  }
  public int indexOf(Boolean val){
    final int size;
  ...
  abstract static class Checked<E>extends AbstractSeq<E>{
    ...
    private @SuppressWarnings("unchecked") static <E> int markSurvivors(Object[] arr,long[] survivorSet,int offset,
    ...
    private static int pullSurvivorsDown(Object[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors){
