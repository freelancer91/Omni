...
class CheckedSubList extends AbstractSeq.Checked.AbstractSubList implements OmniList.OfBoolean{
  ...
  @Override public boolean contains(double val){
    ...
    if((size=this.size)!=0){
      ...
      return AbstractSeq.uncheckedAnyMatches(root.arr,rootOffset=this.rootOffset,rootOffset+size,v);
    }
    return false;
  }
  ...
  @Override public boolean contains(Object val){
    ...
    return (size=this.size)!=0&&val instanceof Boolean
        &&AbstractSeq.uncheckedAnyMatches(root.arr,rootOffset=this.rootOffset,rootOffset+size,(boolean)val);
  }
  ...
  @Override public int indexOf(Object val){
    ...
    if((size=this.size)!=0&&val instanceof Boolean){
      final int rootOffset;
      return AbstractSeq.uncheckedIndexOfMatch(root.arr,rootOffset=this.rootOffset,rootOffset+size,(boolean)val);
    }
    return -1;
  }
  ...
  @Override public int lastIndexOf(double val){
    ...
    if((size=this.size)!=0){
      ...
      return super.uncheckedLastIndexOfMatch(size,v);
    }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return -1;
  }
  ...
  @Override public int lastIndexOf(Object val){
    final int size;
    if((size=this.size)!=0&&val instanceof Boolean){ return super.uncheckedLastIndexOfMatch(size,(boolean)val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return -1;
  }
