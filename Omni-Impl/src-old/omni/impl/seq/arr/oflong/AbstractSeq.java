...
abstract class AbstractSeq extends AbstractLongList{
  transient long[] arr;
  ...
  static boolean uncheckedAnyMatches(long[] arr,int offset,int bound,long val){
  ...
  static int uncheckedIndexOfNatch(long[] arr,int offset,int bound,long val){
    int index=offset;
    do{
  ...
  static int uncheckedLastIndexOfMatch(long[] arr,int offset,int bound,long val){
    do{
  ...
  private AbstractSeq(int size,long[] arr){
    super(size);
    this.arr=arr;
  }
  public boolean contains(boolean val){
    final int size;
    return (size=this.size)!=0&&uncheckedAnyMatches(arr,0,size,TypeUtil.castToLong(val));
  }
  public boolean contains(double val){
    final int size;
    final long v;
    return (size=this.size)!=0&&TypeUtil.doubleEquals(val,v=(long)val)&&uncheckedAnyMatches(arr,0,size,v);
  }
  public boolean contains(float val){
    final int size;
    final long v;
    return (size=this.size)!=0&&TypeUtil.floatEquals(val,v=(long)val)&&uncheckedAnyMatches(arr,0,size,v);
  }
  ...
  public boolean contains(Object val){
    final int size;
    return (size=this.size)!=0&&val instanceof Long&&uncheckedAnyMatches(arr,0,size,(long)val);
  }
  ...
  public int indexOf(boolean val){
    final int size;
    if((size=this.size)!=0){ return uncheckedIndexOfMatch(size,TypeUtil.castToLong(val)); }
    return -1;
  }
  public int indexOf(double val){
    final int size;
    final long v;
    if((size=this.size)!=0&&TypeUtil.doubleEquals(val,v=(long)val)){ return uncheckedIndexOfMatch(size,v); }
    return -1;
  }
  public int indexOf(float val){
    final int size;
    final long v;
    if((size=this.size)!=0&&TypeUtil.floatEquals(val,v=(long)val)){ return uncheckedIndexOfMatch(size,v); }
    return -1;
  }
  ...
  public int indexOf(Object val){
    final int size;
    if((size=this.size)!=0&&val instanceof Long){ return uncheckedIndexOfMatch(size,(long)val); }
    return -1;
  }
  public Long peek(){
    final int size;
  ...
  public int search(boolean val){
    final int size;
    if((size=this.size)!=0){ return uncheckedSearch(size,TypeUtil.castToLong(val)); }
    return -1;
  }
  public int search(double val){
    final int size;
    final long v;
    if((size=this.size)!=0&&TypeUtil.doubleEquals(val,v=(long)val)){ return uncheckedSearch(size,v); }
    return -1;
  }
  public int search(float val){
    final int size;
    final long v;
    if((size=this.size)!=0&&TypeUtil.floatEquals(val,v=(long)val)){ return uncheckedSearch(size,v); }
    return -1;
  }
  ...
  private int uncheckedIndexOfMatch(int size,long val){
    final var arr=this.arr;
    int index=0;
    do{
  ...
  static abstract class Checked extends AbstractSeq{
    ...
    private static int pullSurvivorsDown(long[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors){
    ...
    @Override void uncheckedReplaceAll(int size,LongUnaryOperator operator){
      final int expectedModCount=modCount;
      try{
    ...
    @Override void uncheckedSort(int size,LongComparator sorter){
      final int expectedModCount=modCount;
      try{
