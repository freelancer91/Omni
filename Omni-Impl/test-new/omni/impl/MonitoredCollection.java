...
public interface MonitoredCollection<COL extends OmniCollection<?>>{
  ...
  void verifyForEach(MonitoredFunction monitoredFunction);
  ...
  void verifyWriteObject(MonitoredObjectOutputStream monitoredObjectOutputStream);
  void verifyReadObject(COL collection,MonitoredObjectInputStream monitoredObjectInputStream);
  ...
  @SuppressWarnings({"unchecked","rawtypes"}) default void verifyForEach(MonitoredFunctionGen functionGen,
    ...
    case REF:{
      ...
      if(functionCallType == FunctionCallType.Boxed){
        ...
        cast.forEach((Consumer)monitoredFunction);
      }
      break;
    }
    case SHORT:{
    ...
    verifyCollectionState();
    verifyForEach(monitoredFunction);
  }
  ...
  @SuppressWarnings("unchecked") default boolean verifyRemoveIf(MonitoredRemoveIfPredicateGen filterGen,FunctionCallType functionCallType,double threshold,long randSeed) {
    ...
    case REF:
    {
      ...
      if(functionCallType==FunctionCallType.Boxed) {
        ...
        result=cast.removeIf((Predicate<Object>)filter);
      }
      break;
    }
    case SHORT:
    ...
    @SuppressWarnings({"rawtypes","unchecked"}) default void verifyForEachRemaining(MonitoredFunctionGen functionGen,FunctionCallType functionCallType,long randSeed) {
      ...
      if(functionCallType==FunctionCallType.Boxed) {
        ...
        case LONG:
          ...
          break;
        case REF:
          ((OmniIterator.OfRef<?>)iterator).forEachRemaining((Consumer)function);
          break;
        case SHORT:
