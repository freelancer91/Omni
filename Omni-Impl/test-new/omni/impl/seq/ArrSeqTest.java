...
public class ArrSeqTest{
    ...
    private static final int[] ROOT_BUFFERS=new int[]{0};
    private static final EnumSet<StructType> LIST_STRUCTS=EnumSet.of(StructType.ArrList,StructType.ArrSubList);
    private static final EnumSet<StructType> ALL_STRUCTS=EnumSet.of(StructType.ArrList,StructType.ArrStack,
            StructType.ArrSubList);
    ...
    private static MonitoredSequence<?> getMonitoredSequence(DataType collectionType,CheckedType checkedType,
        ...
        case ArrList:
        case ArrSubList:
            return getMonitoredList(collectionType,checkedType,structType,initCapacity,rootPreAlloc,parentPreAlloc,
    ...
    public void testadd_intval(){
        for(final var structType:LIST_STRUCTS){
            final var buffers=structType == StructType.ArrSubList?SUB_LIST_BUFFERS:ROOT_BUFFERS;
                                                        ...
                                                        for(final var initCap:INIT_CAPACITIES){
                                                            TestExecutorService.submitTest(()->{
                                                                if(illegalMod.expectedException == null){
                                                                    ...
                                                                    {
                                                                        final var monitor=getMonitoredSequence(
                                                                    ...
                                                                    {
                                                                        final var monitor=SequenceInitialization.Ascending
                                                                                .initialize(getMonitoredSequence(
                                                                                        collectionType,checkedType,
                                                                                        structType,initCap,rootPreAlloc,
                                                                                        parentPreAlloc,rootPostAlloc,
                                                                                        parentPostAlloc),10,0);
    ...
    public void testConstructor_int(){
        for(final var structType:ROOT_STRUCTS){
    ...
    public void testcontains_val(){
        final QueryTest<MonitoredSequence<?>> test=(monitor,queryVal,inputType,castType,modification,
        ...
        test.runAllTests("ArrSeqTest.testcontains_val",ALL_STRUCTS);
    }
    @Test
    public void testforEach_Consumer(){
        ...
        test.runAllTests("ArrSeqTest.testforEach_Consumer",100,EnumSet.allOf(FunctionCallType.class),ALL_STRUCTS);
    }
    @Test
                                                ...
                                                TestExecutorService.submitTest(()->{
                                                    final var monitor=SequenceInitialization.Ascending.initialize(
                                                            getMonitoredList(collectionType,checkedType,structType,
                                                                    size + rootPreAlloc + parentPreAlloc + rootPostAlloc
                                                                            + parentPostAlloc,
                                                                    rootPreAlloc,parentPreAlloc,rootPostAlloc,
                                                                    parentPostAlloc),
                                                            size,0);
                                                    monitor.illegalMod(illegalMod);
                                                    if(illegalMod.expectedException == null){
    ...
    public void testindexOf_val(){
        ...
        test.runAllTests("ArrSeqTest.testindexOf_val",LIST_STRUCTS);
    }
    @Test
                                                ...
                                                TestExecutorService.submitTest(()->{
                                                    final var monitor=SequenceInitialization.Ascending.initialize(
                                                            getMonitoredSequence(collectionType,checkedType,structType,
                                                                    size + rootPreAlloc + rootPostAlloc + parentPreAlloc
                                                                            + parentPostAlloc,
                                                                    rootPreAlloc,parentPreAlloc,rootPostAlloc,
                                                                    parentPostAlloc),
                                                            size,0);
                                                ...
                                                if(position >= 0 && (index=(int)(position * size)) != prevIndex){
                                                    ...
                                                    TestExecutorService.submitTest(()->{
                                                        final var seqMonitor=SequenceInitialization.Ascending
                                                                .initialize(getMonitoredSequence(collectionType,
                                                                        checkedType,structType,
                                                                        size + rootPreAlloc + rootPostAlloc
                                                                                + parentPreAlloc + parentPostAlloc,
                                                                        rootPreAlloc,parentPreAlloc,rootPostAlloc,
                                                                        parentPostAlloc),size,0);
                                                        final var itrMonitor=seqMonitor.getMonitoredIterator(index,
                                                                itrType);
                                        ...
                                        for(final var functionCallType:FunctionCallType.values()){
                                            if(collectionType != DataType.REF || !functionCallType.boxed){
                                                for(final int size:SIZES){
                                                    ...
                                                    for(final var position:POSITIONS){
                                                        int numToIterate;
                                                        if(position >= 0 && (numToIterate=(int)(position
                                                                * size)) != prevNumToIterate){
                                                                ...
                                                                final var seqMonitor=SequenceInitialization.Ascending
                                                                        .initialize(getMonitoredSequence(collectionType,
                                                                                ...
                                                                                size + rootPreAlloc + rootPostAlloc
                                                                                        + parentPreAlloc
                                                                                        + parentPostAlloc,
                                                                                rootPreAlloc,parentPreAlloc,
                                                                                rootPostAlloc,parentPostAlloc),size,0);
                                                                final var itrMonitor=seqMonitor
                                                                        .getMonitoredIterator(itrType);
                                                                itrMonitor.illegalMod(illegalMod);
                                                                if(illegalMod.expectedException == null){
                                                        ...
                                                        for(final var collectionType:DataType.values()){
                                                            for(final int size:SIZES){
                                                                ...
                                                                positionLoop:for(final var position:POSITIONS){
                                                                    ...
                                                                    if(position >= 0 && (numToIterate=(int)(size
                                                                            * position)) != prevNumToIterate){
                                                                        prevNumToIterate=numToIterate;
                                                                        ...
                                                                        TestExecutorService.submitTest(()->{
                                                                            final var seqMonitor=SequenceInitialization.Ascending
                                                                                    .initialize(getMonitoredSequence(
                                                                                            ...
                                                                                            parentPostAlloc),size,0);
                                                                            final var itrMonitor=seqMonitor
                                                                                    .getMonitoredIterator(numToIterate,
                                                                                            itrType);
                                                                            ...
                                                                            if(removeScenario.expectedException == null){
                                                                                ...
                                                                                Assertions.assertThrows(
                                                                                        removeScenario.expectedException,
                                                                                        ()->itrMonitor.verifyRemove());
                                                                            }
                                                                        });
                                                                    }
    ...
    public void testlastIndexOf_val(){
        ...
        test.runAllTests("ArrSeqTest.testlastIndexOf_val",LIST_STRUCTS);
    }
    @Test
                                                        ...
                                                        TestExecutorService.submitTest(()->{
                                                            ...
                                                            if(illegalMod.expectedException == null){
                                                                if(index >= 0 && index <= size){
                                                                    final var itrMonitor=monitor
                                                                            .getMonitoredListIterator(index);
                                                                    monitor.verifyCollectionState();
                                                    ...
                                                    if(inputType != DataType.REF || !functionCallType.boxed){
                                                        for(final var initCapacity:INIT_CAPACITIES){
                                                            for(final var position:POSITIONS){
                                                                if(position >= 0){
                                                                    TestExecutorService.submitTest(()->{
                                                                        final var seqMonitor=getMonitoredList(
                                                                                collectionType,checkedType,structType,
                                                                                initCapacity,rootPreAlloc,
                                                                                parentPreAlloc,rootPostAlloc,
                                                                                parentPostAlloc);
                                                                        final var itrMonitor=seqMonitor
                                                                                .getMonitoredListIterator();
                                                                        for(int i=0;;){
                                                                            itrMonitor.verifyAdd(
                                                                                    inputType.convertValUnchecked(i),
                                                                                    inputType,functionCallType);
                                                                            if(++i == 100){
                                                                                break;
                                                                            ...
                                                                            final double dI=i;
                                                                            double currPosition;
                                                                            while((currPosition=itrMonitor.nextIndex()
                                                                                    / dI) < position
                                                                                    && itrMonitor.hasNext()){
                                                                                itrMonitor.iterateForward();
                                                                            }
                                                                            while(currPosition > position
                                                                                    && itrMonitor.hasPrevious()){
                                                                                itrMonitor.iterateReverse();
                                                                                currPosition=itrMonitor.nextIndex()
                                                                                        / dI;
                                                                            }
                                                                        }
                                                                        if(illegalMod.expectedException != null){
                                                                            ...
                                                                            Assertions.assertThrows(
                                                                                    illegalMod.expectedException,
                                                                                    ()->itrMonitor.verifyAdd(inputType
                                                                                            .convertValUnchecked(100),
                                                                                            inputType,
                                                                                            functionCallType));
                                                                            // for good measure, do it again with an
                                                                            // empty list
                                                                            final var itrMonitor2=getMonitoredList(
                                                                                    collectionType,checkedType,
                                                                                    structType,initCapacity,
                                                                                    rootPreAlloc,parentPreAlloc,
                                                                                    rootPostAlloc,parentPostAlloc)
                                                                                            .getMonitoredListIterator();
                                                                            ...
                                                                            Assertions.assertThrows(
                                                                                    illegalMod.expectedException,
                                                                                    ()->itrMonitor2.verifyAdd(inputType
                                                                                            .convertValUnchecked(100),
                                                                                            inputType,
                                                                                            functionCallType));
                                                                        }
    ...
    public void testListItrprevious_void(){
        for(final var structType:LIST_STRUCTS){
            final var buffers=structType == StructType.ArrSubList?SUB_LIST_BUFFERS:ROOT_BUFFERS;
            final var itrType=structType == StructType.ArrList?IteratorType.BidirectionalItr
                                                                    ...
                                                                    TestExecutorService.submitTest(()->{
                                                                        ...
                                                                        if(removeScenario.expectedException == null){
                                                                            if(illegalMod.expectedException == null){
                                                                                ...
                                                                                while(itrMonitor.hasNext()){
                                                                                    itrMonitor.iterateForward();
                                                                                    itrMonitor.verifySet(inputType
                                                                                            .convertValUnchecked(++i),
                                                                                            inputType,functionCallType);
                                                                                }
                                                                            }else{
    ...
    public void testpeek_void(){
        for(final var checkedType:CheckedType.values()){
            for(final var collectionType:DataType.values()){
                TestExecutorService.submitTest(()->{
                    final var monitor=new ArrStackMonitor<>(checkedType,collectionType,100);
                    for(int i=0;;++i){
                        for(final var outputType:collectionType.validOutputTypes()){
        ...
        for(final var checkedType:CheckedType.values()){
            for(final var collectionType:DataType.values()){
                for(final var outputType:collectionType.validOutputTypes()){
                    TestExecutorService.submitTest(()->{
                        final var monitor=SequenceInitialization.Ascending
                                .initialize(new ArrStackMonitor<>(checkedType,collectionType,100),100,0);
                        for(int i=0;;++i){
                ...
                if(size > 0 || checkedType.checked){
                    for(final var collectionType:DataType.values()){
                        for(final var outputType:collectionType.validOutputTypes()){
                            TestExecutorService.submitTest(()->{
                                final var monitor=SequenceInitialization.Ascending
                                        .initialize(new ArrStackMonitor<>(checkedType,collectionType,size),size,0);
                ...
                for(final var inputType:collectionType.mayBeAddedTo()){
                    for(final var functionCallType:FunctionCallType.values()){
                        if(inputType != DataType.REF || functionCallType != FunctionCallType.Boxed){
                            for(final var initCap:INIT_CAPACITIES){
                                TestExecutorService.submitTest(()->{
                                    final var monitor=new ArrStackMonitor<>(checkedType,collectionType,initCap);
                                    for(int i=0;i < 100;++i){
    ...
    public void testReadAndWrite(){
        ...
        test.runAllTests("ArrSeqTest.testReadAndWrite",0,EnumSet.of(FunctionCallType.Unboxed),ALL_STRUCTS);
    }
    @Test
                    ...
                    if(checkedType.checked || illegalMod.expectedException == null){
                        for(final var rootPreAlloc:buffers){
                            for(final var parentPreAlloc:buffers){
                                for(final var rootPostAlloc:buffers){
                                    for(final var parentPostAlloc:buffers){
                                        for(final var position:illegalMod.expectedException == null
                                                ?NON_THROWING_REMOVE_AT_POSITIONS
                                                        ...
                                                        for(final var outputType:collectionType.validOutputTypes()){
                                                            TestExecutorService.submitTest(()->{
                                                                final var monitor=SequenceInitialization.Ascending
                                                                        .initialize(getMonitoredList(collectionType,
                                                                                checkedType,structType,
                                                                                size + rootPreAlloc + parentPreAlloc
                                                                                        + rootPostAlloc
                                                                                        + parentPostAlloc,
                                                                                rootPreAlloc,parentPreAlloc,
                                                                                rootPostAlloc,parentPostAlloc),size,0);
                                                                if(illegalMod.expectedException == null){
                                                                    ...
                                                                    case -1:
                                                                        Assertions.assertThrows(
                                                                                IndexOutOfBoundsException.class,
                                                                                ()->monitor.verifyRemoveAt(-1,
                                                                                        outputType));
                                                                        break;
                                                                    case 3:
                                                                        Assertions.assertThrows(
                                                                                IndexOutOfBoundsException.class,
                                                                                ()->monitor.verifyRemoveAt(size,
                                                                                        outputType));
                                                                        break;
                                                                    case 0:
                                                                        for(int i=0;i < size;++i){
                                                                    ...
                                                                    case 1:{
                                                                        for(int i=0;i < size;++i){
                                                                            monitor.verifyRemoveAt((size - i) / 2,
                                                                                    outputType);
                                                                        }
                                                                        break;
                                                                    }
                                                                    case 2:
                                                                        for(int i=0;i < size;++i){
                                                                            monitor.verifyRemoveAt(size - i - 1,
                                                                                    outputType);
                                                                        }
                                                                        break;
                                                                    default:
                                        ...
                                        for(final var filterGen:structType.validMonitoredRemoveIfPredicateGens){
                                            for(final var collectionType:DataType.values()){
                                                ...
                                                for(int tmpSize=0;tmpSize<=sizeBound;tmpSize+=sizeInc) {
                                                    final int size;
                                                    if((size=tmpSize) == 0 || checkedType.checked
                                                        ...
                                                        if(collectionType==DataType.BOOLEAN) {
                                                            ...
                                                            for(final var functionCallType:FunctionCallType.values()){
                                                                if(collectionType != DataType.REF
                                                                    ...
                                                                    long randSeedBound;
                                                                    double[] thresholdArr;
                                                                    if(filterGen.randomized && size > 0
                                                                            && !functionCallType.boxed){
                                                                        randSeedBound=100;
    ...
    public void testremoveVal_val(){
        ...
        test.runAllTests("ArrSeqTest.testremoveVal_val",ALL_STRUCTS);
    }
    @Test
    public void testreplaceAll_UnaryOperator(){
        final MonitoredFunctionTest<MonitoredList<?>> test=(monitor,functionGen,functionCallType,illegalMod,
                randSeed)->{
            if(illegalMod.expectedException == null){
                if(functionGen.expectedException == null || monitor.isEmpty()){
        ...
        test.runAllTests("ArrSeqTest.testreplaceAll_UnaryOperator",100,EnumSet.allOf(FunctionCallType.class),
                LIST_STRUCTS);
    }
    @Tag("Search")
    @Test
    public void testsearch_val(){
        ...
        test.runAllTests("ArrSeqTest.testsearch",EnumSet.of(StructType.ArrStack));
    }
    @Test
                                                                ...
                                                                if(checkedType.checked){
                                                                    ...
                                                                    Assertions.assertThrows(
                                                                            ...
                                                                            ()->monitor.verifySet(size,
                                                                                    collectionType.convertValUnchecked(
                                                                                            size + 1),
                                                                                    functionCallType));
                                                                }
                                                                for(int index=0;index < size;++index){
                                                                    monitor.verifySet(index,collectionType
                                                                            .convertValUnchecked(index + 1),
                                                                            functionCallType);
                                                                }
                                                            }
                                    ...
                                    for(final var parentPostAlloc:buffers){
                                        for(final var size:SIZES){
                                            for(final var comparatorGen:structType.validComparatorGens){
                                                if(size < 2 || checkedType.checked
                                                        || comparatorGen.expectedException == null){
                                                    for(final var functionCallType:FunctionCallType.values()){
                                                        for(final var collectionType:DataType.values()){
                                                            if(collectionType != DataType.REF
                                                                    && comparatorGen.validWithPrimitive
                                                                    || collectionType == DataType.REF
                                                                            && !functionCallType.boxed){
                                                                TestExecutorService.submitTest(()->{
                                                                    final var monitor=getMonitoredList(collectionType,
                                                                            checkedType,structType,
                                                                    ...
                                                                    if(illegalMod.expectedException == null){
                                                                        if(size < 2
                                                                            ...
                                                                            Assertions.assertThrows(
                                                                                    comparatorGen.expectedException,
                                                                                    ()->monitor.verifyStableSort(size,
                                                                                            comparatorGen,
                                                                                            functionCallType));
                                                                        }
                                                                    }else{
                                                            ...
                                                            if(collectionType == DataType.REF
                                                                ...
                                                                TestExecutorService.submitTest(()->{
                                                                    ...
                                                                    if(illegalMod.expectedException == null){
                                                                        if(size < 2
                                                                                || comparatorGen.expectedException == null){
                                                                            monitor.verifyAscendingStableSort(size,
                                                                                    comparatorGen);
                                                                        }else{
                                                                            Assertions.assertThrows(
                                                                                    comparatorGen.expectedException,
                                                                                    ()->monitor
                                                                                            .verifyAscendingStableSort(
                                                                                                    size,
                                                                                                    comparatorGen));
                                                                        }
                                                                    }else{
                                                                        ...
                                                                        Assertions.assertThrows(
                                                                                illegalMod.expectedException,
                                                                                ()->monitor.verifyAscendingStableSort(
                                                                                        size,comparatorGen));
                                                                    }
                                                                });
                                                            }
                                                            ...
                                                            if(collectionType == DataType.REF
                                                                ...
                                                                TestExecutorService.submitTest(()->{
                                                                    ...
                                                                    if(illegalMod.expectedException == null){
                                                                        if(size < 2
                                                                                || comparatorGen.expectedException == null){
                                                                            monitor.verifyDescendingStableSort(size,
                                                                                    comparatorGen);
                                                                        }else{
                                                                            Assertions.assertThrows(
                                                                                    comparatorGen.expectedException,
                                                                                    ()->monitor
                                                                                            .verifyDescendingStableSort(
                                                                                                    size,
                                                                                                    comparatorGen));
                                                                        }
                                                                    }else{
                                                                        ...
                                                                        Assertions.assertThrows(
                                                                                illegalMod.expectedException,
                                                                                ()->monitor.verifyDescendingStableSort(
                                                                                        size,comparatorGen));
                                                                    }
                                                                });
                                                            }
                            ...
                            for(final var parentPreAlloc:buffers){
                                for(final var rootPostAlloc:buffers){
                                    for(final var parentPostAlloc:buffers){
                                        for(final int size:SIZES){
                                            final int inc=Math.max(1,size / 10);
                                            for(int tmpFromIndex=-inc,fromBound=size
                                                    + 2 * inc;tmpFromIndex <= fromBound;tmpFromIndex+=inc){
                                                if(checkedType.checked || tmpFromIndex >= 0 && tmpFromIndex <= size){
                                                    final int fromIndex=tmpFromIndex;
                                                    for(int tmpToIndex=-(2 * inc),toBound=size
                                                            + inc;tmpToIndex < toBound;tmpToIndex+=inc){
                                                        if(checkedType.checked
                                                                || tmpToIndex >= fromIndex && tmpToIndex <= size){
                                                                    ...
                                                                    final var rootMonitor=SequenceInitialization.Ascending
                                                                            .initialize(getMonitoredList(collectionType,
                                                                                    ...
                                                                                    size + rootPreAlloc + rootPostAlloc
                                                                                            ...
                                                                                            + parentPostAlloc,
                                                                                    rootPreAlloc,parentPreAlloc,
                                                                                    rootPostAlloc,parentPostAlloc),size,
                                                                                    0);
                                                                    if(illegalMod.expectedException == null){
                                                                        if(fromIndex >= 0 && toIndex >= fromIndex
                                                                                && toIndex <= size){
                                                                            rootMonitor
                                                                                    .getMonitoredSubList(fromIndex,
                                                                                            toIndex)
                                                                        ...
                                                                        Assertions.assertThrows(
                                                                                illegalMod.expectedException,()->{
                                                                                    try{
                                                                                        rootMonitor.getMonitoredSubList(
                                                                                                fromIndex,toIndex);
                                                                                    }finally{
                                                                                        rootMonitor
                                                                                                .verifyCollectionState();
    ...
    public void testtoArray_IntFunction(){
        ...
        test.runAllTests("ArrSeqTest.testtoArray_IntFunction",0,EnumSet.of(FunctionCallType.Unboxed),ALL_STRUCTS);
    }
    @Test
                                            ...
                                            for(final var comparatorGen:StructType.ArrList.validComparatorGens){
                                                if(comparatorGen.validWithNoComparator){
                                                    if(size < 2 || checkedType.checked
                                                            || comparatorGen.expectedException == null){
                                                        TestExecutorService.submitTest(()->{
                                                            final var monitor=getMonitoredList(DataType.REF,checkedType,
                                                                    structType,
                                                                    size + rootPreAlloc + parentPreAlloc + rootPostAlloc
                                                                            + parentPostAlloc,
                                                                    rootPreAlloc,parentPreAlloc,rootPostAlloc,
                                                            ...
                                                            if(illegalMod.expectedException == null){
                                                                if(size < 2 || comparatorGen.expectedException == null){
                                                                    monitor.verifyAscendingUnstableSort(size,
                                                                            comparatorGen);
                                                                }else{
                                                                    Assertions.assertThrows(
                                                                            comparatorGen.expectedException,
                                                                            ()->monitor.verifyAscendingUnstableSort(
                                                                                    size,comparatorGen));
                                                                }
                                                            }else{
                                                                monitor.illegalMod(illegalMod);
                                                ...
                                                if(comparatorGen.validWithNoComparator){
                                                    if(size < 2 || checkedType.checked
                                                        ...
                                                        TestExecutorService.submitTest(()->{
                                                            ...
                                                            if(illegalMod.expectedException == null){
                                                                if(size < 2 || comparatorGen.expectedException == null){
                                                                    monitor.verifyDescendingUnstableSort(size,
                                                                            comparatorGen);
                                                                }else{
                                                                    Assertions.assertThrows(
                                                                            comparatorGen.expectedException,
                                                                            ()->monitor.verifyDescendingUnstableSort(
                                                                                    size,comparatorGen));
                                                                }
                                                            }else{
                                                                monitor.illegalMod(illegalMod);
                                            ...
                                            for(final var comparatorGen:structType.validComparatorGens){
                                                if(size < 2 || checkedType.checked
                                                    ...
                                                    for(final var collectionType:DataType.values()){
                                                        if(collectionType == DataType.REF
                                                                || comparatorGen.validWithPrimitive
                                                                        && collectionType != DataType.BOOLEAN){
                                                            TestExecutorService.submitTest(()->{
                                                                final var monitor=getMonitoredList(collectionType,
                                                                        checkedType,structType,
                                                                        size + rootPreAlloc + parentPreAlloc
                                                                ...
                                                                if(illegalMod.expectedException == null){
                                                                    if(size < 2
                                                                        ...
                                                                        Assertions.assertThrows(
                                                                                comparatorGen.expectedException,
                                                                                ()->monitor.verifyUnstableSort(size,
                                                                                        comparatorGen));
                                                                    }
                                                                }else{
                                                                    monitor.illegalMod(illegalMod);
    ...
    private static abstract class AbstractArrSeqMonitor<SEQ extends AbstractSeq<?>>
            extends
    ...
    private static class ArrListMonitor<SEQ extends AbstractSeq<E> & OmniList<E>,E> extends AbstractArrSeqMonitor<SEQ>
            implements
            MonitoredList<SEQ>{
        ...
        @Override
        public MonitoredIterator<? extends OmniIterator<?>,SEQ> getMonitoredIterator(int index,
        ...
        @Override
        public MonitoredListIterator<? extends OmniListIterator<?>,SEQ> getMonitoredListIterator(){
        ...
        @Override
        public MonitoredListIterator<? extends OmniListIterator<?>,SEQ> getMonitoredListIterator(int index){
        ...
        @Override
        public ArrSubListMonitor<?,SEQ,E> getMonitoredSubList(int fromIndex,int toIndex){
        ...
        public static class ArrSubListMonitor<SUBLIST extends AbstractSeq<E>&OmniList<E>, SEQ extends AbstractSeq<E>&OmniList<E>,E> implements MonitoredList<SUBLIST>{
            ...
            @SuppressWarnings("unchecked")
            ArrSubListMonitor(ArrListMonitor<SEQ,E> expectedRoot,int fromIndex,int toIndex){
            ...
            @SuppressWarnings("unchecked")
            ArrSubListMonitor(ArrSubListMonitor<SUBLIST,SEQ,E> expectedParent,int fromIndex,int toIndex){
            ...
            public MonitoredIterator<? extends OmniIterator<?>,SUBLIST> getMonitoredIterator(int index,
                ...
                case SubAscendingItr:{
                    final var itr=seq.iterator();
                    MonitoredIterator<? extends OmniIterator<?>,SUBLIST> monitor;
                    if(checked){
            ...
            @Override
            public ArrSubListMonitor<SUBLIST,SEQ,E> getMonitoredSubList(int fromIndex,int toIndex){
                return new ArrSubListMonitor<>(this,fromIndex,toIndex);
            }
            @Override
            public StructType getStructType(){
            ...
            @Override
            public void verifyReadAndWriteClone(SUBLIST clone){
                expectedRoot.verifyCloneTypeAndModCount(clone);
                Assertions.assertNotSame(clone,expectedRoot.seq);
                int size;
                Assertions.assertEquals(size=((AbstractSeq<?>)seq).size,((AbstractSeq<?>)clone).size);
            ...
            private class CheckedListIteratorMonitor extends CheckedIteratorMonitor<OmniListIterator<?>>
                    implements
                    MonitoredListIterator<OmniListIterator<?>,SUBLIST>{
        ...
        private abstract class AbstractListItrMonitor extends AbstractItrMonitor<OmniListIterator<?>>
                implements
                MonitoredListIterator<OmniListIterator<?>,SEQ>{
            int expectedLastRet;
    ...
    private static class ArrStackMonitor<SEQ extends AbstractSeq<E>&OmniStack<E>,E> extends AbstractArrSeqMonitor<SEQ>
            implements
            MonitoredStack<SEQ>{
        ...
        @Override public MonitoredIterator<? extends OmniIterator<?>,SEQ> getMonitoredIterator(int index,IteratorType itrType){
        ...
        private class UncheckedItrMonitor
                implements
                MonitoredCollection.MonitoredIterator<OmniIterator<?>,SEQ>{
    ...
    private static interface MonitoredFunctionTest<MONITOR extends MonitoredSequence<?>>{
        ...
        private void runAllTests(String testName,long maxRand,EnumSet<FunctionCallType> functionCallTypes,
                EnumSet<StructType> structTypes){
    ...
    private static interface QueryTest<MONITOR extends MonitoredSequence<?>>{
        ...
        private void runTest(DataType collectionType,QueryVal queryVal,QueryVal.QueryValModification modification,
            ...
            final var monitor=getMonitoredSequence(collectionType,checkedType,structType,
                                                                ...
                                                                if(checkedType.checked || objGen.expectedException==null) {
                                                                    TestExecutorService.submitTest(()->{
                                                                        if(objGen.expectedException==null||size==0) {
                                                                            var monitor=SequenceInitialization.Ascending.initialize(getMonitoredSequence(collectionType,checkedType,structType,size+rootPreAlloc+parentPreAlloc+rootPostAlloc+parentPostAlloc,rootPreAlloc,parentPreAlloc,rootPostAlloc,parentPostAlloc),size,initVal);
                                                                            if(illegalMod.expectedException==null) {
                                                                                callVerify(monitor);
                                                                            }else {
                                                                                monitor.illegalMod(illegalMod);
                                                                            ...
                                                                            var monitor=SequenceInitialization.Ascending.initializeWithMonitoredObj(getMonitoredSequence(collectionType,checkedType,structType,size+rootPreAlloc+parentPreAlloc+rootPostAlloc+parentPostAlloc,rootPreAlloc,parentPreAlloc,rootPostAlloc,parentPostAlloc),size,initVal,objGen,throwSwitch);
                                                                            monitor.illegalMod(illegalMod);
                                                                            final Class<? extends Throwable> expectedException=illegalMod.expectedException==null?objGen.expectedException:illegalMod.expectedException;
