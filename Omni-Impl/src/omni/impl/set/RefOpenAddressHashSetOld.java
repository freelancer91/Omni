...
public class RefOpenAddressHashSetOld<E>extends AbstractOpenAddressHashSet implements OmniSet.OfRef<E>{
    ...
    public RefOpenAddressHashSetOld(){
        super();
    }
    public RefOpenAddressHashSetOld(float loadFactor){
        super(loadFactor);
    }
    public RefOpenAddressHashSetOld(int initialCapacity){
        super(initialCapacity);
    }
    public RefOpenAddressHashSetOld(int initialCapacity,float loadFactor){
        super(initialCapacity,loadFactor);
    }
    public RefOpenAddressHashSetOld(RefOpenAddressHashSetOld<? extends E> that){
        super(that);
        int size;
        if((size=that.size) != 0){
            Object[] table;
    ...
    @Override
    public Object clone(){
        return new RefOpenAddressHashSetOld<>(this);
    }
    @Override
    ...
    public static class Checked<E>extends RefOpenAddressHashSetOld<E>{
        ...
        public Checked(RefOpenAddressHashSetOld<E> that){
            super(that);
        }
        @Override
        public boolean add(E val){
    ...
    private static class Itr<E> implements OmniIterator.OfRef<E>{
        private final RefOpenAddressHashSetOld<E> root;
        private int tableIndex;
        Itr(RefOpenAddressHashSetOld<E> root){
            this.root=root;
            if(root.size != 0){
                final Object[] table;
                for(int i=(table=root.table).length;;){
        ...
        @Override
        public void remove(){
            RefOpenAddressHashSetOld<E> root;
            --(root=this.root).size;
