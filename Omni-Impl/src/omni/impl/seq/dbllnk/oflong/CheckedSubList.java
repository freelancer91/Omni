...
public class CheckedSubList extends AbstractSeq{
  ...
  @Override public boolean add(boolean val){
    ...
    uncheckedAddLast(TypeUtil.castToLong(val));
    ++root.size;
    return true;
  }
  ...
  @Override public boolean remove(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Long){ return uncheckedRemoveFirstMatch(head,(long)val); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  @Override public boolean removeVal(boolean val){
    Node head;
    if((head=this.head)!=null){ return uncheckedRemoveFirstMatch(head,TypeUtil.castToLong(val)); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  @Override public boolean removeVal(double val){
    Node head;
    long v;
    if((head=this.head)!=null&&TypeUtil.doubleEquals(val,v=(long)val)){ return uncheckedRemoveFirstMatch(head,v); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  @Override public boolean removeVal(float val){
    Node head;
    long v;
    if((head=this.head)!=null&&TypeUtil.floatEquals(val,v=(long)val)){ return uncheckedRemoveFirstMatch(head,v); }
    CheckedCollection.checkModCount(modCount,root.modCount);
    return false;
  }
  ...
  void appendHelper(long val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  void initHelper(Checked root,long val,int modCount){
  ...
  void prependHelper(long val,int modCount){
    this.modCount=modCount;
    Node newNode;
  ...
  boolean uncheckedRemoveFirstMatchHelper(int modCount,Node curr,long val){
  ...
  private void collapseHeadAndTail(int modCount,Node headCandidate,Node tailCandidate,final LongPredicate filter){
    int size=this.size;
    int numConsumed=2;
    final var root=this.root;
    for(;;){
  ...
  private void insertHelper(Node before,long val,Node after,int modCount){
  ...
  private void rootCollapseHead(int modCount,Node headCandidate,final Node oldTail,LongPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void rootCollapseTail(int modCount,final Node oldHead,Node tailCandidate,LongPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void suffixCollapseHead(int modCount,Node oldHead,Node oldTail,LongPredicate filter){
    final int oldSize=size;
    int numConsumed=2;
    final var root=this.root;
  ...
  private void uncheckedAddLast(long val){
    if(++size!=1){
      appendHelper(val,modCount);
    }else{
      initHelper(root,val,modCount);
  ...
  static class Body extends CheckedSubList.Prefix{
    ...
    @Override void findNewHead(int modCount,Node curr,LongPredicate filter){
      final Node tail;
      if(curr==(tail=this.tail)){
        Checked root;
        CheckedCollection.checkModCount(modCount,(root=this.root).modCount);
    ...
    @Override void initHelper(Checked root,long val,int modCount){
      final Node newNode;
    ...
    @Override void prependHelper(long val,int modCount){
      this.modCount=modCount;
    ...
    private OmniList.OfLong getEmptySubList(Checked root,int headDist){
      return new CheckedSubList.Body(root,this,headDist);
    }
    private OmniList.OfLong getSubList1(Checked root,int headDist,int tailDist){
      return new CheckedSubList.Body(root,this,staticGetNode(this,headDist,tailDist),headDist);
  ...
  static class Prefix extends CheckedSubList{
    ...
    @Override void appendHelper(long val,int modCount){
      this.modCount=modCount;
    ...
    @Override boolean removeIfHelper(int modCount,Node curr,LongPredicate filter){
      final Node tail;
      if(curr!=(tail=this.tail)){
        if(filter.test(tail.val)){
    ...
    @Override boolean uncheckedRemoveFirstMatchHelper(int modCount,Node curr,long val){
      final var root=this.root;
      final var tail=this.tail;
      Node prev;
      do{
    ...
    private void collapseHeadAndTail(int modCount,Node headCandidate,Node tail,LongPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
    ...
    private void prefixCollapseTail(int modCount,Node oldHead,Node oldTail,LongPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
  ...
  static class Suffix extends CheckedSubList{
    ...
    private void collapseHeadAndTail(int modCount,Node head,Node tailCandidate,LongPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends CheckedAscendingSubItr implements OmniListIterator.OfLong{
