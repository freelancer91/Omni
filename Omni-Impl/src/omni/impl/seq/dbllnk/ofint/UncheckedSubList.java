...
class UncheckedSubList extends AbstractSeq.Unchecked{
  ...
  @Override final boolean collapseBody(Node head,Node tail,IntPredicate filter){
    Node prev;
  ...
  private void rootCollapseHead(Node headCandidate,Node tail,IntPredicate filter){
    int numRemoved;
  ...
  private void suffixCollapseHead(Node oldHead,Node oldTail,IntPredicate filter){
  ...
  static class Body extends UncheckedSubList.Prefix{
    ...
    @Override void findNewHead(Node curr,IntPredicate filter){
      final Node tail;
    ...
    @Override void initHelper(Unchecked root,int val){
      final Node newNode;
    ...
    @Override void prependHelper(int val){
  ...
  static class Prefix extends UncheckedSubList{
    ...
    @Override void appendHelper(int val){
    ...
    @Override void collapseTail(Node oldHead,Node oldTail,IntPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
    ...
    private void collapseHeadAndTail(Node headCandidate,Node tail,IntPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  static class Suffix extends UncheckedSubList{
    ...
    private void collapseHeadAndTail(Node head,Node tailCandidate,IntPredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends UncheckedAscendingSubItr implements OmniListIterator.OfInt{
