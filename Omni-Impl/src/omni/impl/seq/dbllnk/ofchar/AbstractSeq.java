...
abstract class AbstractSeq extends AbstractCharList implements OmniList.OfChar{
  ...
  static void staticInsertNode(AbstractSeq seq,int headDist,char val,int tailDist){
    Node before,after;
    if(headDist<=tailDist){
  ...
  static void uncheckedForEachForward(Node begin,Node end,CharConsumer action){
    for(;;){
  ...
  static void uncheckedForEachReverse(Node curr,CharConsumer action){
    do{
  ...
  static void uncheckedReplaceAll(Node begin,Node end,CharUnaryOperator operator){
    for(;;){
      begin.val=operator.applyAsChar(begin.val);
      if(begin==end){ return; }
      begin=begin.next;
    }
  }
  ...
  static void uncheckedSort(Node begin,int size,Node end,CharComparator sorter){
    // TODO
  }
  ...
  private static void uncheckedCopyForward(Node src,Character[] dst,int dstOffset,int length){
    for(;;){
      dst[dstOffset]=src.val;
      if(--length==0){ return; }
      ++dstOffset;
  ...
  @Override public boolean contains(double val){
    Node head;
    int v;
    return (head=this.head)!=null&&val==(v=(char)val)&&uncheckedAnyMatches(head,v);
  }
  ...
  @Override public boolean contains(int val){
    Node head;
    return (head=this.head)!=null&&val==(char)val&&uncheckedAnyMatches(head,val);
  }
  ...
  @Override public boolean contains(Object val){
    Node head;
    return (head=this.head)!=null&&val instanceof Character&&uncheckedAnyMatches(head,(char)val);
  }
  @Override public boolean contains(short val){
    Node head;
    return val>=0&&(head=this.head)!=null&&uncheckedAnyMatches(head,val);
  }
  ...
  @Override public int indexOf(double val){
    Node head;
    int v;
    if((head=this.head)!=null&&val==(v=(char)val)){ return uncheckedIndexOfMatch(head,v); }
    return -1;
  }
  ...
  @Override public int indexOf(int val){
    Node head;
    if((head=this.head)!=null&&val==(char)val){ return uncheckedIndexOfMatch(head,val); }
    return -1;
  }
  ...
  @Override public int indexOf(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Character){ return uncheckedIndexOfMatch(head,(char)val); }
    return -1;
  }
  @Override public int indexOf(short val){
    Node head;
    if(val>=0&&(head=this.head)!=null){ return uncheckedIndexOfMatch(head,val); }
    return -1;
  }
  ...
  @Override public boolean remove(Object val){
    Node head;
    return (head=this.head)!=null&&val instanceof Character&&uncheckedRemoveFirstMatch(head,(char)val);
  }
  ...
  public boolean removeFirstOccurrence(double val){
    Node head;
    int v;
    return (head=this.head)!=null&&val==(v=(char)val)&&uncheckedRemoveFirstMatch(head,v);
  }
  ...
  public boolean removeFirstOccurrence(int val){
    Node head;
    return (head=this.head)!=null&&val==(char)val&&uncheckedRemoveFirstMatch(head,val);
  }
  ...
  public int search(double val){
    Node head;
    int v;
    if((head=this.head)!=null&&val==(v=(char)val)){ return uncheckedSearch(head,v); }
    return -1;
  }
  ...
  public int search(int val){
    Node head;
    if((head=this.head)!=null&&val==(char)val){ return uncheckedSearch(head,val); }
    return -1;
  }
  ...
  public int search(Object val){
    Node head;
    if((head=this.head)!=null&&val instanceof Character){ return uncheckedSearch(head,(char)val); }
    return -1;
  }
  public int search(short val){
    Node head;
    if(val>=0&&(head=this.head)!=null){ return uncheckedSearch(head,val); }
    return -1;
  }
  ...
  @Override public Character[] toArray(){
    ...
    if((size=this.size)!=0){
      Character[] dst;
      uncheckedCopyForward(head,dst=new Character[size],0,size);
      return dst;
    }
  ...
  static abstract class Checked extends AbstractSeq implements OmniDeque.OfChar{
  ...
  static abstract class Unchecked extends AbstractSeq{
    ...
    abstract boolean collapseBody(Node head,Node tail,CharPredicate filter);
    abstract void collapseTail(Node head,Node tail,CharPredicate filter);
    abstract void findNewHead(Node head,CharPredicate filter);
