...
public class CheckedList extends AbstractSeq.Checked{
    static int collapseBodyHelper(CheckedCollection.AbstractModCountChecker modCountChecker,Node prev,int numLeft,
            Node next,CharPredicate filter){
        int numRemoved=0;
    ...
    static int markSurvivors(Node begin,int numLeft,long[] survivorSet,CharPredicate filter){
        long survivorWord;
    ...
    @Override
    public void addFirst(Character val){
        super.addFirst((char)val);
    }
    @Override
    public void addLast(Character val){
        super.addLast((char)val);
    }
    @Override
    public void clear(){
    ...
    @Override
    public boolean offerFirst(char val){
        super.addFirst(val);
        return true;
    }
    @Override
    public boolean offerFirst(Character val){
        super.addFirst((char)val);
        return true;
    }
    @Override
    public boolean offerLast(char val){
        super.addLast(val);
        return true;
    }
    @Override
    public boolean offerLast(Character val){
        super.addLast((char)val);
        return true;
    }
    @Override
    ...
    private void collapseHead(int modCount,Node headCandidate,Node oldTail,CharPredicate filter){
    ...
    private void collapseHeadAndTail(int modCount,Node headCandidate,Node tailCandidate,CharPredicate filter){
        int oldSize=size;
        int numConsumed=2;
        for(;;){
            if(numConsumed==oldSize){
    ...
    private void collapseTail(int modCount,Node oldHead,Node tailCandidate,CharPredicate filter){
    ...
    @Override
    public omni.api.OmniIterator.OfChar descendingIterator(){
        // TODO Auto-generated method stub
        return null;
    }
    @Override
    ...
    @Override
    public omni.api.OmniIterator.OfChar iterator(){
        // TODO Auto-generated method stub
        return null;
    }
    @Override
    public omni.api.OmniListIterator.OfChar listIterator(){
        // TODO Auto-generated method stub
        return null;
    }
    @Override
    public omni.api.OmniListIterator.OfChar listIterator(int index){
        // TODO Auto-generated method stub
        return null;
    }
    @Override
