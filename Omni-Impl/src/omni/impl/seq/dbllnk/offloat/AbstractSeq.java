...
abstract class AbstractSeq extends AbstractFloatList implements OmniList.OfFloat{
    ...
    abstract boolean uncheckedRemoveFirstFlt0(Node curr);
    abstract boolean uncheckedRemoveFirstFltBits(Node curr,int fltBits);
    abstract boolean uncheckedRemoveFirstFltNaN(Node curr);
