...
class UncheckedSubList extends AbstractSeq.Unchecked{
  ...
  @Override final boolean collapseBody(Node head,Node tail,BytePredicate filter){
    Node prev;
  ...
  private void rootCollapseHead(Node headCandidate,Node tail,BytePredicate filter){
    int numRemoved;
  ...
  private void suffixCollapseHead(Node oldHead,Node oldTail,BytePredicate filter){
  ...
  static class Body extends UncheckedSubList.Prefix{
    ...
    @Override void findNewHead(Node curr,BytePredicate filter){
      final Node tail;
    ...
    @Override void initHelper(Unchecked root,byte val){
      final Node newNode;
    ...
    @Override void prependHelper(byte val){
  ...
  static class Prefix extends UncheckedSubList{
    ...
    @Override void appendHelper(byte val){
    ...
    @Override void collapseTail(Node oldHead,Node oldTail,BytePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
    ...
    private void collapseHeadAndTail(Node headCandidate,Node tail,BytePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  static class Suffix extends UncheckedSubList{
    ...
    private void collapseHeadAndTail(Node head,Node tailCandidate,BytePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends UncheckedAscendingSubItr implements OmniListIterator.OfByte{
