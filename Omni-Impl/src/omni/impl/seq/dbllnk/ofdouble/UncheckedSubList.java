...
class UncheckedSubList extends AbstractSeq.Unchecked{
  ...
  @Override public boolean add(boolean val){
    ...
    final var v=TypeUtil.castToDouble(val);
    if(++size!=1){
      appendHelper(v);
    }else{
      initHelper(root,v);
  ...
  @Override final boolean collapseBody(Node head,Node tail,DoublePredicate filter){
    Node prev;
  ...
  @Override boolean uncheckedRemoveFirstDbl0(Node head){
    ...
    return uncheckedRemoveFirstDbl0Helper(head);
  }
  boolean uncheckedRemoveFirstDbl0Helper(Node curr){
  ...
  @Override boolean uncheckedRemoveFirstDblBits(Node head,long dblBits){
    ...
    return uncheckedRemoveFirstDblBitsHelper(head,dblBits);
  }
  boolean uncheckedRemoveFirstDblBitsHelper(Node curr,long dblBits){
    final var tail=this.tail;
    Node prev;
    do{
      if(curr==tail){ return false; }
  ...
  @Override boolean uncheckedRemoveFirstDblNaN(Node head){
    ...
    return uncheckedRemoveFirstDblNaNHelper(head);
  }
  boolean uncheckedRemoveFirstDblNaNHelper(Node curr){
    final var tail=this.tail;
    Node prev;
    do{
      if(curr==tail){ return false; }
  ...
  private void rootCollapseHead(Node headCandidate,Node tail,DoublePredicate filter){
    int numRemoved;
  ...
  private void suffixCollapseHead(Node oldHead,Node oldTail,DoublePredicate filter){
  ...
  static class Body extends UncheckedSubList.Prefix{
    ...
    @Override void findNewHead(Node curr,DoublePredicate filter){
      final Node tail;
    ...
    @Override void initHelper(Unchecked root,double val){
      final Node newNode;
    ...
    @Override void prependHelper(double val){
  ...
  static class Prefix extends UncheckedSubList{
    ...
    @Override void appendHelper(double val){
    ...
    @Override void collapseTail(Node oldHead,Node oldTail,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
    ...
    @Override boolean uncheckedRemoveFirstDbl0Helper(Node curr){
      final var tail=this.tail;
      Node prev;
      do{
        if(curr==tail){ return false; }
    ...
    @Override boolean uncheckedRemoveFirstDblBitsHelper(Node curr,long dblBits){
      final var tail=this.tail;
      Node prev;
      do{
        if(curr==tail){ return false; }
    ...
    @Override boolean uncheckedRemoveFirstDblNaNHelper(Node curr){
      final var tail=this.tail;
      Node prev;
      do{
        if(curr==tail){ return false; }
    ...
    private void collapseHeadAndTail(Node headCandidate,Node tail,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  static class Suffix extends UncheckedSubList{
    ...
    private void collapseHeadAndTail(Node head,Node tailCandidate,DoublePredicate filter){
      final int oldSize=size;
      int numConsumed=2;
      final var root=this.root;
      for(;;){
  ...
  private static class BidirectionalItr extends UncheckedAscendingSubItr implements OmniListIterator.OfDouble{
