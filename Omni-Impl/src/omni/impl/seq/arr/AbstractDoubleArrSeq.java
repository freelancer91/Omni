...
abstract class AbstractDoubleArrSeq extends AbstractDoubleList{
    ...
    static boolean uncheckedContains(double[] arr,int offset,int bound,double val){
        if(val==val){
            return uncheckedContainsDblBits(arr,offset,bound,Double.doubleToRawLongBits(val));
        }
    ...
    static int uncheckedIndexOf(double[] arr,int offset,int bound,double val){
        if(val==val){
            return uncheckedIndexOfDblBits(arr,offset,bound,Double.doubleToRawLongBits(val));
        }
    ...
    static int uncheckedLastIndexOf(double[] arr,int offset,int bound,double val){
        if(val==val){
            return uncheckedLastIndexOfDblBits(arr,offset,bound,Double.doubleToRawLongBits(val));
        }
    ...
    static int uncheckedLastIndexOfDblBits(double[] arr,int offset,int bound,long dblBits){
        do{
            if(Double.doubleToRawLongBits(arr[--bound])==dblBits){
                return bound-offset;
            }
        }while(bound!=offset);
        return -1;
    ...
    public boolean contains(boolean val){
        ...
        if((size=this.size)!=0){
            ...
            if(val){
                return uncheckedContainsDblBits(arr,0,size,TypeUtil.DBL_TRUE_BITS);
            }
    ...
    public boolean contains(float val){
        ...
        if((size=this.size)!=0){
            final var arr=this.arr;
            if(val==val){
                return uncheckedContainsDblBits(arr,0,size,Double.doubleToRawLongBits(val));
            }
    ...
    public int indexOf(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedIndexOfDblBits(size,TypeUtil.DBL_TRUE_BITS);
            }
    ...
    public boolean removeVal(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedRemoveFirstDblBits(size,TypeUtil.DBL_TRUE_BITS);
            }
    ...
    public boolean removeVal(float val){
        ...
        if((size=this.size)!=0){
            if(val==val){
                return uncheckedRemoveFirstDblBits(size,Double.doubleToRawLongBits(val));
            }
    ...
    public int search(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedSearchDblBits(size,TypeUtil.DBL_TRUE_BITS);
            }
    ...
    public int search(Object val){
        final int size;
        if((size=this.size)!=0&&val instanceof Double){
            return uncheckedSearch(size,(double)val);
        }
        return -1;
    }
    ...
    @Override
    protected int uncheckedLastIndexOfDbl0(int size){
        final var arr=this.arr;
        do{
            if(arr[--size]==0){
                return size;
    ...
    @Override
    protected int uncheckedLastIndexOfDblBits(int size,long dblBits){
        final var arr=this.arr;
        do{
            if(Double.doubleToRawLongBits(arr[--size])==dblBits){
                return size;
            }
        }while(size!=0);
        return -1;
    ...
    @Override
    protected int uncheckedLastIndexOfDblNaN(int size){
        final var arr=this.arr;
        do{
            if(Double.isNaN(arr[--size])){
                return size;
            }
        }while(size!=0);
        return -1;
    ...
    static abstract class Checked extends AbstractDoubleArrSeq{
        ...
        private static int pullSurvivorsDown(double[] arr,long[] survivorSet,int dstOffset,int srcOffset,
                int numSurvivors){
        ...
        @Override
        void uncheckedReplaceAll(int size,DoubleUnaryOperator operator){
            final int expectedModCount=modCount;
            try{
        ...
        @Override
        void uncheckedSort(int size,DoubleComparator sorter){
            final int expectedModCount=modCount;
            try{
                        ...
                        if(filter.test(arr[srcOffset])){
                            ...
                            while(++srcOffset!=srcBound){
                                ...
                                if(!filter.test(v=arr[srcOffset])){
                                    ...
                                    this.size=size-(size=((AbstractDoubleArrSeq)root).finalizeSubListBatchRemove(arr,
                                            dstOffset,srcBound));
                                    bubbleUpDecrementSize(parent,size);
                                    return true;
                                }
                            ...
                            root.modCount=++expectedModCount;
                            modCount=expectedModCount;
                            this.size=size-(size=((AbstractDoubleArrSeq)root).finalizeSubListBatchRemove(arr,dstOffset,
                                    srcBound));
                            bubbleUpDecrementSize(parent,size);
                            return true;
                        }
