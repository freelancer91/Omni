...
class CheckedSubList extends AbstractSeq.Checked.AbstractSubList implements OmniList.OfFloat{
    ...
    public boolean contains(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedContainsFltBits(root,size,TypeUtil.FLT_TRUE_BITS);
            }
    ...
    public boolean contains(double val){
        ...
        if((size=this.size)!=0){
            final float v;
            if((v=(float)val)==val){
                return uncheckedContainsFltBits(root,size,Float.floatToRawIntBits(v));
            }
    ...
    public boolean contains(int val){
        ...
        if((size=this.size)!=0){
            if(val!=0){
                return TypeUtil.checkCastToFloat(val)&&uncheckedContainsFltBits(root,size,Float.floatToRawIntBits(val));
            }
            return uncheckedContainsFlt0(root,size);
        }
        return false;
    ...
    public int indexOf(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedIndexOfFltBits(root,size,TypeUtil.FLT_TRUE_BITS);
            }
    ...
    public int indexOf(char val){
        ...
        int size;
        if((size=this.size)!=0){
            return uncheckedIndexOfRawInt(root,size,val);
        }
        return -1;
    }
    @Override
    ...
    public int indexOf(Object val){
        ...
        if((size=this.size)!=0&&val instanceof Float){
            return uncheckedIndexOf(root,size,(float)val);
        }
        return -1;
    }
    @Override
    ...
    public int lastIndexOf(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedLastIndexOfFltBits(root,size,TypeUtil.FLT_TRUE_BITS);
            }
    ...
    public int lastIndexOf(char val){
        ...
        int size;
        if((size=this.size)!=0){
            return uncheckedLastIndexOfRawInt(root,size,val);
        }
        return -1;
    }
    @Override
    ...
    public int lastIndexOf(Object val){
        ...
        int size;
        if((size=this.size)!=0&&val instanceof Float){
            return uncheckedLastIndexOf(root,size,(float)val);
        }
        return -1;
    }
    @Override
    ...
    public boolean remove(Object val){
        final int size;
        if((size=this.size)!=0&&val instanceof Float){
            return uncheckedRemove(size,(float)val);
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return false;
    }
    ...
    public boolean removeVal(byte val){
        final int size;
        if((size=this.size)!=0){
            return uncheckedRemoveRawInt(size,val);
        }
        CheckedCollection.checkModCount(modCount,root.modCount);
        return false;
    }
    ...
    private boolean uncheckedContains(AbstractSeq.Checked root,int size,float val){
        if(val==val){
            return uncheckedContainsFltBits(root,size,Float.floatToRawIntBits(val));
        }
