...
abstract class AbstractFloatArrSeq extends AbstractFloatList{
    ...
    static boolean uncheckedContains(float[] arr,int offset,int bound,float val){
        if(val==val){
            return uncheckedContainsFltBits(arr,offset,bound,Float.floatToRawIntBits(val));
        }
        return uncheckedContainsFltNaN(arr,offset,bound);
    }
    static boolean uncheckedContainsFlt0(float[] arr,int offset,int bound){
        while(arr[offset]!=0){
            if(++offset==bound){
                return false;
            }
    ...
    static boolean uncheckedContainsFltBits(float[] arr,int offset,int bound,int fltBits){
    ...
    static boolean uncheckedContainsFltNaN(float[] arr,int offset,int bound){
    ...
    static boolean uncheckedContainsRawInt(float[] arr,int offset,int bound,int val){
        if(val!=0){
            return uncheckedContainsFltBits(arr,offset,bound,Float.floatToRawIntBits(val));
        }
        return uncheckedContainsFlt0(arr,offset,bound);
    }
    ...
    static int uncheckedIndexOf(float[] arr,int offset,int bound,float val){
        if(val==val){
            return uncheckedIndexOfFltBits(arr,offset,bound,Float.floatToRawIntBits(val));
        }
    ...
    static int uncheckedLastIndexOf(float[] arr,int offset,int bound,float val){
        if(val==val){
            return uncheckedLastIndexOfFltBits(arr,offset,bound,Float.floatToRawIntBits(val));
        }
    ...
    static int uncheckedLastIndexOfFltBits(float[] arr,int offset,int bound,int fltBits){
        do{
            if(Float.floatToRawIntBits(arr[--bound])==fltBits){
                return bound-offset;
            }
        }while(bound!=offset);
        return -1;
    ...
    transient float[] arr;
    private AbstractFloatArrSeq(){
        super();
        arr=OmniArray.OfFloat.DEFAULT_ARR;
    }
    private AbstractFloatArrSeq(int capacity){
        super();
        switch(capacity){
        default:
    ...
    private AbstractFloatArrSeq(int size,float[] arr){
        super(size);
        this.arr=arr;
    }
    public boolean contains(boolean val){
        ...
        if((size=this.size)!=0){
            ...
            if(val){
                return uncheckedContainsFltBits(arr,0,size,TypeUtil.FLT_TRUE_BITS);
            }
            return uncheckedContainsFlt0(arr,0,size);
        }
        return false;
    }
    public boolean contains(byte val){
        final int size;
        return (size=this.size)!=0&&uncheckedContainsRawInt(arr,0,size,val);
    }
    ...
    public boolean contains(double val){
        ...
        if((size=this.size)!=0){
            final float v;
            if((v=(float)val)==val){
                return uncheckedContainsFltBits(arr,0,size,Float.floatToRawIntBits(v));
            }
            return v!=v&&uncheckedContainsFltNaN(arr,0,size);
        }
        return false;
    }
    ...
    public boolean contains(int val){
        ...
        if((size=this.size)!=0){
            if(val!=0){
                return TypeUtil.checkCastToFloat(val)
                        &&uncheckedContainsFltBits(arr,0,size,Float.floatToRawIntBits(val));
            }
            return uncheckedContainsFlt0(arr,0,size);
        }
        return false;
    ...
    public boolean contains(Object val){
        final int size;
        return (size=this.size)!=0&&val instanceof Float&&uncheckedContains(arr,0,size,(float)val);
    }
    ...
    public boolean removeVal(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedRemoveFirstFltBits(size,TypeUtil.FLT_TRUE_BITS);
            }
    ...
    public boolean removeVal(double val){
        ...
        if((size=this.size)!=0){
            float v;
            if(val==(v=(float)val)){
                return uncheckedRemoveFirstFltBits(size,Float.floatToRawIntBits(v));
            }
    ...
    public boolean removeVal(int val){
        ...
        if((size=this.size)!=0){
            if(val!=0){
                return TypeUtil.checkCastToFloat(val)&&uncheckedRemoveFirstFltBits(size,Float.floatToRawIntBits(val));
            }
            return uncheckedRemoveFirstFlt0(size);
        }
        return false;
    ...
    public int search(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedSearchFltBits(size,TypeUtil.FLT_TRUE_BITS);
            }
    ...
    public int search(char val){
        final int size;
        if((size=this.size)!=0){
            return uncheckedSearchRawInt(size,val);
        }
        return -1;
    }
    ...
    public int search(Object val){
        final int size;
        if((size=this.size)!=0&&val instanceof Float){
            return uncheckedSearch(size,(float)val);
        }
        return -1;
    }
    ...
    @Override
    protected int uncheckedLastIndexOfFlt0(int size){
        final var arr=this.arr;
        do{
            if(arr[--size]==0){
                return size;
    ...
    @Override
    protected int uncheckedLastIndexOfFltBits(int size,int fltBits){
        final var arr=this.arr;
        do{
            if(Float.floatToRawIntBits(arr[--size])==fltBits){
                return size;
            }
        }while(size!=0);
        return -1;
    ...
    @Override
    protected int uncheckedLastIndexOfFltNaN(int size){
        final var arr=this.arr;
        do{
            if(Float.isNaN(arr[--size])){
                return size;
            }
        }while(size!=0);
        return -1;
    ...
    private boolean uncheckedRemoveFirstMatch(int size,float val){
        if(val==val){
            return uncheckedRemoveFirstFltBits(size,Float.floatToRawIntBits(val));
        }
    ...
    static abstract class Checked extends AbstractFloatArrSeq{
        ...
        private static int pullSurvivorsDown(float[] arr,long[] survivorSet,int dstOffset,int srcOffset,
                int numSurvivors){
        ...
        @Override
        void uncheckedReplaceAll(int size,FloatUnaryOperator operator){
            final int expectedModCount=modCount;
            try{
        ...
        @Override
        void uncheckedSort(int size,FloatComparator sorter){
            final int expectedModCount=modCount;
            try{
        ...
        static abstract class AbstractBidirectionalItr{
            ...
            public void add(float val){
                ...
                if((rootSize=root.size)!=0){
                    ((AbstractFloatArrSeq)root).uncheckedInsert(cursor,val,rootSize);
                }else{
                    ((AbstractFloatArrSeq)root).uncheckedInit(val);
                }
        ...
        static abstract class AbstractSubList extends AbstractSubArrSeq{
            ...
            public boolean add(float val){
                ...
                if((rootSize=root.size)!=0){
                    ((AbstractFloatArrSeq)root).uncheckedInsert(rootOffset+size,val,rootSize);
                }else{
                    ((AbstractFloatArrSeq)root).uncheckedInit(val);
                }
                root.modCount=++modCount;
            ...
            public void add(int index,float val){
                ...
                final int rootSize;
                if((rootSize=root.size)!=0){
                    ((AbstractFloatArrSeq)root).uncheckedInsert(rootOffset+index,val,rootSize);
                }else{
                    ((AbstractFloatArrSeq)root).uncheckedInit(val);
                }
                root.modCount=++modCount;
                        ...
                        if(filter.test(arr[srcOffset])){
                            ...
                            while(++srcOffset!=srcBound){
                                ...
                                if(!filter.test(v=arr[srcOffset])){
                                    ...
                                    this.size=size-(size=((AbstractFloatArrSeq)root).finalizeSubListBatchRemove(arr,
                                            dstOffset,srcBound));
                                    bubbleUpDecrementSize(parent,size);
                                    return true;
                                }
                            ...
                            root.modCount=++expectedModCount;
                            modCount=expectedModCount;
                            this.size=size-(size=((AbstractFloatArrSeq)root).finalizeSubListBatchRemove(arr,dstOffset,
                                    srcBound));
                            bubbleUpDecrementSize(parent,size);
                            return true;
                        }
    ...
    static abstract class Unchecked extends AbstractFloatArrSeq{
        ...
        static abstract class AbstractBidirectionalItr{
            ...
            public void add(float val){
                final AbstractFloatArrSeq root;
                final int rootSize,cursor=this.cursor;
