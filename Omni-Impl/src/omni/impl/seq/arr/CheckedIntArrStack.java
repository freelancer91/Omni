...
public class CheckedIntArrStack extends AbstractIntArrSeq.Checked implements OmniStack.OfInt{
  CheckedIntArrStack(){
    super();
  }
  CheckedIntArrStack(int capacity){
    super(capacity);
  }
  private CheckedIntArrStack(int size,int[] arr){
    super(size,arr);
  }
  @Override public Object clone(){
    ...
    return new CheckedIntArrStack(size,arr);
  }
