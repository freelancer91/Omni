...
public class UncheckedBooleanArrStack extends AbstractBooleanArrSeq.Unchecked implements OmniStack.OfBoolean{
    UncheckedBooleanArrStack(){
        super();
    }
    UncheckedBooleanArrStack(int capacity){
        super(capacity);
    }
    private UncheckedBooleanArrStack(int size,boolean[] arr){
        super(size,arr);
    }
    @Override
    public Object clone(){
        ...
        return new UncheckedBooleanArrStack(size,arr);
    }
    @Override
