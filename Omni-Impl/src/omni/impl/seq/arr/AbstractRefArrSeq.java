...
abstract class AbstractRefArrSeq<E>extends AbstractRefList<E>{
    ...
    private AbstractRefArrSeq(int capacity){
        super();
        switch(capacity){
        default:
    ...
    private AbstractRefArrSeq(int size,Object[] arr){
        super(size);
        this.arr=arr;
    }
    ...
    static abstract class Checked<E>extends AbstractRefArrSeq<E>{
        ...
        static abstract class AbstractBidirectionalItr<E>{
            ...
            public void add(E val){
                ...
                if((rootSize=root.size)!=0){
                    ((AbstractRefArrSeq<E>)root).uncheckedInsert(cursor,val,rootSize);
                }else{
                    ((AbstractRefArrSeq<E>)root).uncheckedInit(val);
                }
        ...
        static abstract class AbstractSubList<E>extends AbstractSubArrSeq{
            ...
            public boolean add(E val){
                ...
                if((rootSize=root.size)!=0){
                    ((AbstractRefArrSeq<E>)root).uncheckedInsert(rootOffset+size,val,rootSize);
                }else{
                    ((AbstractRefArrSeq<E>)root).uncheckedInit(val);
                }
                root.modCount=++modCount;
            ...
            public void add(int index,E val){
                ...
                final int rootSize;
                if((rootSize=root.size)!=0){
                    ((AbstractRefArrSeq<E>)root).uncheckedInsert(rootOffset+index,val,rootSize);
                }else{
                    ((AbstractRefArrSeq<E>)root).uncheckedInit(val);
                }
                root.modCount=++modCount;
