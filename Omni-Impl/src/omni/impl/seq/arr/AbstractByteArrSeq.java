...
abstract class AbstractByteArrSeq extends AbstractByteList{
  transient byte[] arr;
  // TODO redo toString implementation
  static void eraseIndexHelper(byte[] arr,int index,int newSize){
    ArrCopy.semicheckedCopy(arr,index+1,arr,index,newSize-index);
  }
  static int forwardToString(byte[] arr,int begin,int end,char[] buffer,int bufferOffset){
  ...
  static void forwardToString(byte[] arr,int begin,int end,ToStringUtil.OmniStringBuilder builder){
    for(;;++begin){
  ...
  static int reverseToString(byte[] arr,int begin,int end,char[] buffer,int bufferOffset){
  ...
  static void reverseToString(byte[] arr,int begin,int end,ToStringUtil.OmniStringBuilder builder){
    for(;;--end){
  ...
  static int forwardHashCode(byte[] arr,int offset,int bound){
  ...
  static void forwardToString(byte[] arr,int offset,int bound,StringBuilder builder){
    for(builder.append(arr[offset]);++offset!=bound;builder.append(',').append(' ').append(arr[offset])){}
  }
  static int reverseHashCode(byte[] arr,int offset,int bound){
  ...
  static void reverseToString(byte[] arr,int offset,int bound,StringBuilder builder){
  ...
  static void uncheckedForwardForEachInRange(byte[] arr,int offset,int bound,ByteConsumer action){
    do{
      action.accept(arr[offset]);
    }while(++offset!=bound);
  }
  static int uncheckedIndexOf(byte[] arr,int offset,int bound,int val){
    int index=offset;
    do{
  ...
  static int uncheckedLastIndexOf(byte[] arr,int offset,int bound,int val){
    do{
  ...
  static void uncheckedReverseArr(byte[] arr,int begin,int end){
    do{
  ...
  static void uncheckedReverseForEachInRange(byte[] arr,int offset,int bound,ByteConsumer action){
    do{
      action.accept(arr[--bound]);
    }while(bound!=offset);
  }
  static void uncheckedReverseSort(byte[] arr,int begin,int end){
    // TODO
  }
  static void uncheckedSort(byte[] arr,int begin,int end){
    // TODO
  }
  static void uncheckedSort(byte[] arr,int begin,int end,ByteComparator sorter){
    // TODO
  }
  private AbstractByteArrSeq(){
    super();
    arr=OmniArray.OfByte.DEFAULT_ARR;
  }
  private AbstractByteArrSeq(int capacity){
    super();
    switch(capacity){
    default:
  ...
  private AbstractByteArrSeq(int size,byte[] arr){
    super(size);
    this.arr=arr;
  }
  public boolean contains(boolean val){
    final int size;
    return (size=this.size)!=0&&uncheckedContains(arr,0,size,TypeUtil.castToByte(val));
  }
  ...
  public boolean contains(char val){
    final int size;
    return val<=Byte.MAX_VALUE&&(size=this.size)!=0&&uncheckedContains(arr,0,size,val);
  }
  public boolean contains(double val){
    final int size,v;
    return (size=this.size)!=0&&val==(v=(byte)val)&&uncheckedContains(arr,0,size,v);
  }
  ...
  public boolean contains(int val){
    final int size;
    return (size=this.size)!=0&&val==(byte)val&&uncheckedContains(arr,0,size,val);
  }
  ...
  public boolean contains(Object val){
    final int size;
    return (size=this.size)!=0&&val instanceof Byte&&uncheckedContains(arr,0,size,(byte)val);
  }
  ...
  public int indexOf(boolean val){
    final int size;
    if((size=this.size)!=0){ return uncheckedIndexOf(size,TypeUtil.castToByte(val)); }
    return -1;
  }
  ...
  public int indexOf(char val){
    final int size;
    if(val<=Byte.MAX_VALUE&&(size=this.size)!=0){ return uncheckedIndexOf(size,val); }
    return -1;
  }
  public int indexOf(double val){
    final int size,v;
    if((size=this.size)!=0&&val==(v=(byte)val)){ return uncheckedIndexOf(size,v); }
    return -1;
  }
  ...
  public int indexOf(int val){
    final int size;
    if((size=this.size)!=0&&val==(byte)val){ return uncheckedIndexOf(size,val); }
    return -1;
  }
  ...
  public int indexOf(Object val){
    final int size;
    if((size=this.size)!=0&&val instanceof Byte){ return uncheckedIndexOf(size,(byte)val); }
    return -1;
  }
  public Byte peek(){
    final int size;
  ...
  public int search(char val){
    final int size;
    if(val<=Byte.MAX_VALUE&&(size=this.size)!=0){ return uncheckedSearch(size,val); }
    return -1;
  }
  public int search(double val){
    final int size,v;
    if((size=this.size)!=0&&val==(v=(byte)val)){ return uncheckedSearch(size,v); }
    return -1;
  }
  ...
  public int search(int val){
    final int size;
    if((size=this.size)!=0&&val==(byte)val){ return uncheckedSearch(size,val); }
    return -1;
  }
  ...
  @Override protected int uncheckedLastIndexOf(int size,int val){
  ...
  byte uncheckedPopByte(int newSize){
    size=newSize;
    return arr[newSize];
  }
  ...
  abstract void uncheckedReplaceAll(int size,ByteUnaryOperator operator);
  abstract void uncheckedSort(int size,ByteComparator sorter);
  ...
  static abstract class Checked extends AbstractByteArrSeq{
    transient int modCount;
    private static int markSurvivors(byte[] arr,long[] survivorSet,int offset,int bound,BytePredicate filter){
    ...
    private static int pullSurvivorsDown(byte[] arr,long[] survivorSet,int dstOffset,int srcOffset,int numSurvivors){
    ...
    @Override void uncheckedReplaceAll(int size,ByteUnaryOperator operator){
      final int expectedModCount=modCount;
      try{
    ...
    @Override void uncheckedSort(int size,ByteComparator sorter){
      final int expectedModCount=modCount;
      try{
    ...
    static abstract class AbstractBidirectionalItr{
      ...
      public void add(byte val){
        ...
        if((rootSize=root.size)!=0){
          ((AbstractByteArrSeq)root).uncheckedInsert(cursor,val,rootSize);
        }else{
          ((AbstractByteArrSeq)root).uncheckedInit(val);
        }
    ...
    static abstract class AbstractSubList extends AbstractSubArrSeq{
      ...
      public boolean add(byte val){
        ...
        if((rootSize=root.size)!=0){
          ((AbstractByteArrSeq)root).uncheckedInsert(rootOffset+size,val,rootSize);
        }else{
          ((AbstractByteArrSeq)root).uncheckedInit(val);
        }
        root.modCount=++modCount;
      ...
      public void add(int index,byte val){
        ...
        final int rootSize;
        if((rootSize=root.size)!=0){
          ((AbstractByteArrSeq)root).uncheckedInsert(rootOffset+index,val,rootSize);
        }else{
          ((AbstractByteArrSeq)root).uncheckedInit(val);
        }
        root.modCount=++modCount;
            ...
            if(filter.test(arr[srcOffset])){
              ...
              while(++srcOffset!=srcBound){
                ...
                if(!filter.test(v=arr[srcOffset])){
                  ...
                  this.size=size-(size=((AbstractByteArrSeq)root).finalizeSubListBatchRemove(arr,dstOffset,srcBound));
                  bubbleUpDecrementSize(parent,size);
                  return true;
                }
              }
  ...
  static abstract class Unchecked extends AbstractByteArrSeq{
    private static int pullSurvivorsDown(byte[] arr,int srcBegin,int srcEnd,BytePredicate filter){
