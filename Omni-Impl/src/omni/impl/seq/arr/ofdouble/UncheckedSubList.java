...
class UncheckedSubList extends AbstractSeq.Unchecked.AbstractSubList implements OmniList.OfDouble{
    ...
    public boolean contains(boolean val){
        ...
        if((size=this.size)!=0){
            if(val){
                return uncheckedContainsDblBits(size,TypeUtil.DBL_TRUE_BITS);
            }
    ...
    public boolean contains(float val){
        ...
        if((size=this.size)!=0){
            if(val==val){
                return uncheckedContainsDblBits(size,Double.doubleToRawLongBits(val));
            }
    ...
    public boolean contains(long val){
        ...
        if((size=this.size)!=0){
            if(val!=0){
                return TypeUtil.checkCastToDouble(val)&&uncheckedContainsDblBits(size,Double.doubleToRawLongBits(val));
            }
            return uncheckedContainsDbl0(size);
        }
        return false;
    ...
    public boolean contains(Object val){
        ...
        return (size=this.size)!=0&&val instanceof Double
                &&AbstractSeq.uncheckedContains(root.arr,rootOffset=this.rootOffset,rootOffset+size,(double)val);
    }
    @Override
    ...
    public int indexOf(Object val){
        ...
        if((size=this.size)!=0&&val instanceof Double){
            final int rootOffset;
            return AbstractSeq.uncheckedIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,(double)val);
        }
        return -1;
    }
    @Override
    ...
    public int lastIndexOf(Object val){
        ...
        if((size=this.size)!=0&&val instanceof Double){
            final int rootOffset;
            return AbstractSeq.uncheckedLastIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,(double)val);
        }
        return -1;
    }
    @Override
    ...
    public boolean removeVal(long val){
        ...
        if((size=this.size)!=0){
            if(val!=0){
                return TypeUtil.checkCastToDouble(val)&&uncheckedRemoveDblBits(size,Double.doubleToRawLongBits(val));
            }
            return uncheckedRemoveDblNaN(size);
        }
        return false;
