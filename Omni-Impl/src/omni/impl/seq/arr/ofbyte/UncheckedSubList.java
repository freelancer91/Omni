...
class UncheckedSubList extends AbstractSeq.Unchecked.AbstractSubList implements OmniList.OfByte{
    ...
    public boolean contains(Object val){
        ...
        return (size=this.size)!=0&&val instanceof Byte
                &&AbstractSeq.uncheckedContains(root.arr,rootOffset=this.rootOffset,rootOffset+size,(byte)val);
    }
    @Override
    ...
    public int indexOf(Object val){
        ...
        if((size=this.size)!=0&&val instanceof Byte){
            final int rootOffset;
            return AbstractSeq.uncheckedIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,(byte)val);
        }
        return -1;
    }
    @Override
    ...
    public int lastIndexOf(Object val){
        ...
        if((size=this.size)!=0&&val instanceof Byte){
            final int rootOffset;
            return AbstractSeq.uncheckedLastIndexOf(root.arr,rootOffset=this.rootOffset,rootOffset+size,(byte)val);
        }
        return -1;
    }
    @Override
