...
abstract class AbstractSeq extends AbstractByteList{
  ...
  static boolean uncheckedAnyMatches(byte[] arr,int offset,int bound,int val){
  ...
  static int uncheckedIndexOfMatch(byte[] arr,int offset,int bound,int val){
    int index=offset;
    do{
  ...
  static int uncheckedLastIndexOfMatch(byte[] arr,int offset,int bound,int val){
    do{
  ...
  public boolean contains(char val){
    final int size;
    return val<=Byte.MAX_VALUE&&(size=this.size)!=0&&uncheckedAnyMatches(arr,0,size,val);
  }
  public boolean contains(double val){
    final int size,v;
    return (size=this.size)!=0&&val==(v=(byte)val)&&uncheckedAnyMatches(arr,0,size,v);
  }
  ...
  public boolean contains(int val){
    final int size;
    return (size=this.size)!=0&&val==(byte)val&&uncheckedAnyMatches(arr,0,size,val);
  }
  ...
  public boolean contains(Object val){
    final int size;
    return (size=this.size)!=0&&val instanceof Byte&&uncheckedAnyMatches(arr,0,size,(byte)val);
  }
  ...
  public int indexOf(char val){
    final int size;
    if(val<=Byte.MAX_VALUE&&(size=this.size)!=0){ return uncheckedIndexOfMatch(size,val); }
    return -1;
  }
  public int indexOf(double val){
    final int size,v;
    if((size=this.size)!=0&&val==(v=(byte)val)){ return uncheckedIndexOfMatch(size,v); }
    return -1;
  }
  ...
  public int indexOf(int val){
    final int size;
    if((size=this.size)!=0&&val==(byte)val){ return uncheckedIndexOfMatch(size,val); }
    return -1;
  }
  ...
  public int indexOf(Object val){
    final int size;
    if((size=this.size)!=0&&val instanceof Byte){ return uncheckedIndexOfMatch(size,(byte)val); }
    return -1;
  }
  public Byte peek(){
    final int size;
