...
public interface OmniPred{
    ...
    interface OfDouble{
        ...
        static DoublePredicate getEqualsPred(boolean val){
            if(val){
                return equalsDblBits(TypeUtil.DBL_TRUE_BITS);
            }
            return TypeUtil::equalsDbl0;
        }
        static DoublePredicate getEqualsPred(double val){
            if(val==val){
                return equalsDblBits(Double.doubleToRawLongBits(val));
            }
            return Double::isNaN;
        }
    ...
    interface OfFloat{
        ...
        static FloatPredicate getEqualsPred(boolean val){
            if(val){
                return equalsFltBits(TypeUtil.FLT_TRUE_BITS);
            }
            return TypeUtil::equalsFlt0;
        }
        static FloatPredicate getEqualsPred(float val){
            if(val==val){
                return equalsFltBits(Float.floatToRawIntBits(val));
            }
            return Float::isNaN;
        }
    ...
    interface OfRef{
        ...
        static <E> Predicate<E> getEqualsPred(boolean val){
            if(val){
                return TypeUtil::refEqualsTrue;
            }
            return TypeUtil::refEqualsFalse;
        }
        static <E> Predicate<E> getEqualsPred(Boolean val){
            if(val!=null){
                return getEqualsPred((boolean)val);
            }
        ...
        static <E> Predicate<E> getEqualsPred(Character val){
            if(val!=null){
                return getEqualsPred((char)val);
            }
            return Objects::isNull;
        }
        static <E> Predicate<E> getEqualsPred(double val){
            if(val==val){
                return getEqualsDblBitsPred(Double.doubleToRawLongBits(val));
            }
            return TypeUtil::refEqualsDblNaN;
        }
        static <E> Predicate<E> getEqualsPred(Double val){
            if(val!=null){
                return getEqualsPred((double)val);
            }
            return Objects::isNull;
        }
        static <E> Predicate<E> getEqualsPred(float val){
            if(val==val){
                return getEqualsFltBitsPred(Float.floatToRawIntBits(val));
            }
            return TypeUtil::refEqualsFltNaN;
        }
        static <E> Predicate<E> getEqualsPred(Float val){
            if(val!=null){
                return getEqualsPred((float)val);
            }
            return Objects::isNull;
        }
        ...
        static <E> Predicate<E> getEqualsPred(Short val){
            if(val!=null){
                return getEqualsPred((short)val);
            }
            return Objects::isNull;
        }
    }
