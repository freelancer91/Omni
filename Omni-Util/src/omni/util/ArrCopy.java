...
public interface ArrCopy{
  ...
  static void uncheckedCopy(boolean[] src,int srcOffset,byte[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=TypeUtil.castToByte(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=TypeUtil.castToByte(src[--length])){}
  }
  static void uncheckedCopy(boolean[] src,int srcOffset,char[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=TypeUtil.castToChar(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=TypeUtil.castToChar(src[--length])){}
  }
  static void uncheckedCopy(boolean[] src,int srcOffset,double[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=TypeUtil.castToDouble(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=TypeUtil.castToDouble(src[--length])){}
  }
  static void uncheckedCopy(boolean[] src,int srcOffset,float[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=TypeUtil.castToFloat(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=TypeUtil.castToFloat(src[--length])){}
  }
  ...
  static void uncheckedCopy(boolean[] src,int srcOffset,long[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=TypeUtil.castToLong(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=TypeUtil.castToLong(src[--length])){}
  }
  ...
  static void uncheckedDblBitsCopy(long[] src,int srcOffset,double[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=Double.longBitsToDouble(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=Double.longBitsToDouble(src[--length])){}
  }
  static void uncheckedDblBitsCopy(long[] src,int srcOffset,Double[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=Double.longBitsToDouble(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=Double.longBitsToDouble(src[--length])){}
  ...
  static void uncheckedFltBitsCopy(int[] src,int srcOffset,double[] dst,int dstOffset,int length){
    for(dst[dstOffset+=--length]=Float.intBitsToFloat(src[length+=srcOffset]);length!=srcOffset;
        dst[--dstOffset]=Float.intBitsToFloat(src[--length])){}
  }
  ...
  static void uncheckedReverseCopy(boolean[] src,int srcOffset,byte[] dst,int dstOffset,int length){
    for(dst[dstOffset]=TypeUtil.castToByte(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=TypeUtil.castToByte(src[--length])){}
  }
  static void uncheckedReverseCopy(boolean[] src,int srcOffset,char[] dst,int dstOffset,int length){
    for(dst[dstOffset]=TypeUtil.castToChar(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=TypeUtil.castToChar(src[--length])){}
  }
  static void uncheckedReverseCopy(boolean[] src,int srcOffset,double[] dst,int dstOffset,int length){
    for(dst[dstOffset]=TypeUtil.castToDouble(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=TypeUtil.castToDouble(src[--length])){}
  }
  static void uncheckedReverseCopy(boolean[] src,int srcOffset,float[] dst,int dstOffset,int length){
    for(dst[dstOffset]=TypeUtil.castToFloat(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=TypeUtil.castToFloat(src[--length])){}
  }
  ...
  static void uncheckedReverseCopy(boolean[] src,int srcOffset,long[] dst,int dstOffset,int length){
    for(dst[dstOffset]=TypeUtil.castToLong(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=TypeUtil.castToLong(src[--length])){}
  }
  ...
  static void uncheckedReverseDblBitsCopy(long[] src,int srcOffset,double[] dst,int dstOffset,int length){
    for(dst[dstOffset]=Double.longBitsToDouble(src[length+=srcOffset-1]);length!=srcOffset;
        dst[++dstOffset]=Double.longBitsToDouble(src[--length])){}
  }
  static void uncheckedReverseDblBitsCopy(long[] src,int srcOffset,Double[] dst,int dstOffset,int length){
    for(dst[dstOffset]=Double.longBitsToDouble(src[length+=srcOffset-1]);length!=srcOffset;
