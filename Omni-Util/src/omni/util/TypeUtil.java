...
public interface TypeUtil{
    ...
    @Deprecated
    static boolean floatEquals(char val1,float val2){
        return val1==val2;
    }
    @Deprecated
    static boolean floatEquals(float val1,char val2){
        return val1==val2;
    }
    ...
    @Deprecated
    static boolean floatEquals(float val1,int val2){
        return (double)val1==(double)val2;
    }
    static boolean floatEquals(float val1,long val2){
        if(val2<=MAX_SAFE_LONG&&val2>=MIN_SAFE_LONG){
            if(checkCastToFloat(val2)){
                return val1==val2;
            }
        }else if(Long.numberOfLeadingZeros(val2)+Long.numberOfTrailingZeros(val2)<11){
            return false;
        }
        return (double)val1==(double)val2;
    }
    @Deprecated
    static boolean floatEquals(float val1,short val2){
        return val1==val2;
    }
    @Deprecated
    static boolean floatEquals(int val1,float val2){
        return (double)val1==(double)val2;
    }
    @Deprecated
    static boolean floatEquals(long val1,float val2){
        return floatEquals(val2,val1);
    }
    @Deprecated
    static boolean floatEquals(short val1,float val2){
        return val1==val2;
    }
