...
{
  private static void runMaxArrSizeTest(String arrType,Runnable runnable) {
      System.out.print("Testing max array size for type "+arrType+"...");
      try
      {
          runnable.run();
          ...
          if("Java heap space".equals(message)) {
              //not actually a problem with the code
              //just print and skip
              System.err.println("Ran out of memory on max arr size test for type "+arrType);
              return;
          }
          throw e;
      }
  ...
  public void testMaxArraySize(){
    ...
    runMaxArrSizeTest("boolean",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new boolean[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("byte",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new byte[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("char",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new char[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("short",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new short[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("int",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new int[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("long",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new long[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("float",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new float[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("double",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new double[OmniArray.MAX_ARR_SIZE].length));
    runMaxArrSizeTest("Object",()->Assertions.assertEquals(OmniArray.MAX_ARR_SIZE,new Object[OmniArray.MAX_ARR_SIZE].length));
  }
