...
/*
    ...
    public void testSortMethods()
    {
      ...
      .forEach(arr->
      {
        ...
        LongSortUtil.uncheckedStableSort(arr,0,arrLength,Unsorted);
        ...
        copy1=new long[arrLength];
        ArrCopy.uncheckedCopy(arr,0,copy1,0,arrLength);
        LongSortUtil.uncheckedUnstableSort(copy1,0,arrLength,Ascending);
        JunitUtil.uncheckedparallelassertarraysAreEqual(copy1,0,copy,0,arrLength);  
        //test stable ascending comparator sort  
        copy1=new long[arrLength];
        ArrCopy.uncheckedCopy(arr,0,copy1,0,arrLength);
        LongSortUtil.uncheckedStableSort(copy1,0,arrLength,Ascending);
        JunitUtil.uncheckedparallelassertarraysAreEqual(copy1,0,copy,0,arrLength);  
        //test stable ascending non-comparator sort
        copy1=new long[arrLength];
        ArrCopy.uncheckedCopy(arr,0,copy1,0,arrLength);
        LongSortUtil.uncheckedAscendingSort(copy1,0,arrLength);
        JunitUtil.uncheckedparallelassertarraysAreEqual(copy1,0,copy,0,arrLength);  
        OmniArray.OfLong.reverseRange(copy,0,arrLength-1);
        //test unstable descending comparator sort
        copy1=new long[arrLength];
        ArrCopy.uncheckedCopy(arr,0,copy1,0,arrLength);
        LongSortUtil.uncheckedUnstableSort(copy1,0,arrLength,Descending);
        JunitUtil.uncheckedparallelassertarraysAreEqual(copy1,0,copy,0,arrLength);  
        //test stable descending comparator sort
        copy1=new long[arrLength];
        ArrCopy.uncheckedCopy(arr,0,copy1,0,arrLength);
        LongSortUtil.uncheckedStableSort(copy1,0,arrLength,Descending);
        JunitUtil.uncheckedparallelassertarraysAreEqual(copy1,0,copy,0,arrLength);  
        //test stable descending non-comparator sort
        LongSortUtil.uncheckedDescendingSort(arr,0,arrLength);
        JunitUtil.uncheckedparallelassertarraysAreEqual(arr,0,copy,0,arrLength);  
      });
    }
*/
