...
public enum IntegerTestDataBuilder
{
  Randomized
  {
    @Override
  ...
  {
    return "IntegerTestDataBuilder."+this.name();
  }
  ...
  static Integer[] buildRandomArray(int arrLength,int minIncl,int maxIncl,Random rand)
  {
    Integer[] arr=new Integer[arrLength];
    for(int i=0;i<arrLength;++i)
    {
      arr[i]=TypeConversionUtil.convertToInteger(RandomUtil.randomIntBetween(minIncl,maxIncl,rand));
    }
    return arr;
  }
}
