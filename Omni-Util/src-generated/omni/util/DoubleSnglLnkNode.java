...
public class DoubleSnglLnkNode implements Comparable<DoubleSnglLnkNode>
{
  ...
  public static  void pullSurvivorsDown(DoubleSnglLnkNode prev,DoublePredicate filter,long[] survivorSet,int numSurvivors,int numRemoved){
    int wordOffset;
  ...
  public static  int markSurvivors(DoubleSnglLnkNode curr,DoublePredicate filter,long[] survivorSet){
  ...
  public static  void pullSurvivorsDown(DoubleSnglLnkNode prev,long word,int numSurvivors,int numRemoved){
  ...
  public static  long markSurvivors(DoubleSnglLnkNode curr,DoublePredicate filter){
