...
public final class IntSortUtil
{
  ...
  public static void uncheckedAscendingSort(int[] arr,int offset,int bound)
  {
    if((--bound)-offset<286)
    {
  ...
  public static void uncheckedDescendingSort(int[] arr,int offset,int bound)
  {
    if((--bound)-offset<286)
    {
  ...
  public static  void uncheckedStableSort(int[] arr,int offset,int bound,IntBinaryOperator sorter)
  {
    ...
    {
      IntTimSort.binarySort(arr,offset,bound,offset+IntTimSort.countRunAndMakeAscending(arr,offset,bound,sorter),sorter);
      return;
    }
    new IntTimSort(arr,nRemaining,sorter,offset,bound);
  }
    ...
    extends AbstractTimSort
  {
    ...
    private IntTimSort(int[] arr,int nRemaining,IntBinaryOperator sorter,int offset,int bound)
    {
      ...
      this.tmp=new int[tmpLength];
      this.minGallop=7;
      int minRun=AbstractTimSort.minRunLength(nRemaining);
      int runLen;
      do
      {
        if((runLen=IntTimSort.countRunAndMakeAscending(arr,offset,bound,sorter))<minRun)
        {
          int force;
          IntTimSort.binarySort(arr,offset,offset+(force=nRemaining<=minRun?nRemaining:minRun),offset+runLen,sorter);
          runLen=force;
        }
    ...
    int mergeAt(int n,int stackSize,int[] runLenAndBase)
    {
      ...
      base1=(base1=runLenAndBase[n+1])+(k=mergeAtGallopRight((int)(arr=this.arr)[base2],arr,base1,len1,sorter));
      //assert k>=0;
      if((len1-=k)!=0)
      {
    ...
    private void mergeHi(int[] arr,int base1,int len1,int base2,int len2)
    {
      ...
      for(;;)
      {
        ...
        do
        {
          ...
          if((count2=len2-gallopLeft((int)arr[cursor1],tmp,tmpOffset,len2,len2-1,sorter))!=0)
          {
  ...
  private static  void AscendinginsertSort(int[] arr,int begin,int end)
  {
  ...
  private static  void DescendinginsertSort(int[] arr,int begin,int end)
  {
    for(int i=begin,j=i;i!=end;j=++i)
    {
      final int ai=(int)arr[i+1];
  ...
  private static  void AscendingsentinelInsertSort(int[] arr,int begin,int end)
  {
    do
    {
      if(begin>=end)
  ...
  private static  void DescendingsentinelInsertSort(int[] arr,int begin,int end)
  {
    do
    {
      if(begin>=end)
  ...
  private static  void quickAscendingSortleftmost(int[] arr,int begin,int end)
  {
    int length;
    if((length=end-begin+1)<47)
    {
    ...
    int val1,val2,val3,val4,val5;
    if(
    (val2=(int)arr[e2=(e3=(begin+end)>>>1)-(seventh=(length>>3)+(length>>6)+1)])<(val1=(int)arr[e1=e2-seventh])
    )
    {
      int tmp=(int)val2;
      val2=val1;
    ...
    if(
    (val4=(int)arr[e4=e3+seventh])<(val3)
    )
    {
      int tmp=(int)val4;
      val4=val3;
    ...
    if(
    (val5=(int)arr[e5=e4+seventh])<(val4)
    )
    {
      int tmp=(int)val5;
      val5=val4;
  ...
  private static  void quickAscendingSort(int[] arr,int begin,int end)
  {
    int length;
    if((length=end-begin+1)<47)
    {
  ...
  private static  void quickDescendingSortleftmost(int[] arr,int begin,int end)
  {
    int length;
    if((length=end-begin+1)<47)
    {
  ...
  private static  void quickDescendingSort(int[] arr,int begin,int end)
  {
    int length;
    if((length=end-begin+1)<47)
    {
  ...
  private static  void quickAscendingSortleftmostDualPivot(int[] arr,int begin,int end,int pivot1, int pivot2,int e1,int e5)
  {
    int less=begin;
    int great=end;
    while(
  ...
  private static  void quickAscendingSortDualPivot(int[] arr,int begin,int end,int pivot1, int pivot2,int e1,int e5)
  {
    int less=begin;
    int great=end;
    while(
  ...
  private static  void quickDescendingSortleftmostDualPivot(int[] arr,int begin,int end,int pivot1, int pivot2,int e1,int e5)
  {
    int less=begin;
    int great=end;
    while(
  ...
  private static  void quickDescendingSortDualPivot(int[] arr,int begin,int end,int pivot1, int pivot2,int e1,int e5)
  {
    int less=begin;
    int great=end;
    while(
  ...
  private static  void quickAscendingSortleftmostSinglePivot(int[] arr,int begin,int end,int pivot)
  {
    int less=begin;
    int great=end;
    for(int k=less;k<=great;++k)
  ...
  private static  void quickAscendingSortSinglePivot(int[] arr,int begin,int end,int pivot)
  {
    int less=begin;
    int great=end;
    for(int k=less;k<=great;++k)
  ...
  private static  void quickDescendingSortleftmostSinglePivot(int[] arr,int begin,int end,int pivot)
  {
    int less=begin;
    int great=end;
    for(int k=less;k<=great;++k)
  ...
  private static  void quickDescendingSortSinglePivot(int[] arr,int begin,int end,int pivot)
  {
    int less=begin;
    int great=end;
    for(int k=less;k<=great;++k)
  ...
  private static  void Ascendingmerge(int[] arr,int begin,int end,int[] run,int count)
  {
    byte odd=0;
    for(int n=1;(n<<=1)<=count;odd^=1){}
    int[] b;
  ...
  private static  void Descendingmerge(int[] arr,int begin,int end,int[] run,int count)
  {
    byte odd=0;
    for(int n=1;(n<<=1)<=count;odd^=1){}
    int[] b;
