...
public interface OmniQueue extends OmniCollection{
  interface OfBoolean extends OmniQueue,OmniCollection.OfBoolean,PeekAndPollIfc<Boolean>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfByte
      extends OmniQueue,OmniCollection.OfByte,PeekAndPollIfc<Byte>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,
      PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput,PeekAndPollIfc.ByteInput{
    byte byteElement();
    default double doubleElement(){
      return byteElement();
    }
  ...
  interface OfChar extends OmniQueue,OmniCollection.OfChar,PeekAndPollIfc<Character>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfFloat extends OmniQueue,OmniCollection.OfFloat,PeekAndPollIfc<Float>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfInt extends OmniQueue,OmniCollection.OfInt,PeekAndPollIfc<Integer>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfLong extends OmniQueue,OmniCollection.OfLong,PeekAndPollIfc<Long>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfShort extends OmniQueue,OmniCollection.OfShort,PeekAndPollIfc<Short>,PeekAndPollIfc.DoubleInput,
      PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput{
    default double doubleElement(){
      return shortElement();
    }
