...
public interface OmniQueue extends OmniCollection{
  interface OfBoolean
      extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfBoolean,PeekAndPollIfc<Boolean>,
      PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput,
      PeekAndPollIfc.ShortInput,PeekAndPollIfc.CharInput,PeekAndPollIfc.ByteInput,PeekAndPollIfc.BooleanInput{
  ...
  interface OfByte extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfByte,
  ...
  interface OfChar extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfChar,
  ...
  interface OfDouble extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfDouble,
  ...
  interface OfFloat extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfFloat,
  ...
  interface OfInt
      extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfInt,PeekAndPollIfc<Integer>,
      PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput{
    default double doubleElement(){
      return intElement();
    }
  ...
  interface OfLong extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfLong,
  ...
  interface OfRef<E>extends OmniCollection,OmniQueue,OmniCollection.OfRef<E>,PeekAndPollIfc<E>{
    E element();
    boolean offer(E val);
    E remove();
  }
  interface OfShort extends OmniCollection,OmniCollection.OfPrimitive,OmniQueue,OmniCollection.OfShort,
