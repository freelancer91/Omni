...
public interface OmniStack extends OmniCollection{
  ...
  int search(Short val);
  interface OfBoolean extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfBoolean,
      PeekAndPollIfc<Boolean>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,
      PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput,PeekAndPollIfc.CharInput,PeekAndPollIfc.ByteInput,
  ...
  interface OfByte extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfByte,
      PeekAndPollIfc<Byte>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,
      PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput,PeekAndPollIfc.ByteInput{
    Byte pop();
    byte popByte();
    default double popDouble(){
      return popByte();
  ...
  interface OfChar extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfChar,
      PeekAndPollIfc<Character>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,
      PeekAndPollIfc.IntInput,PeekAndPollIfc.CharInput{
    Character pop();
    char popChar();
    default double popDouble(){
      return popChar();
  ...
  interface OfDouble extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfDouble,
      PeekAndPollIfc<Double>,PeekAndPollIfc.DoubleInput{
    Double pop();
    double popDouble();
    default void push(boolean val){
  ...
  interface OfFloat extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfFloat,
      PeekAndPollIfc<Float>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput{
    Float pop();
    default double popDouble(){
      return popFloat();
    }
  ...
  interface OfInt extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfInt,
      PeekAndPollIfc<Integer>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,
  ...
  interface OfLong extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfLong,
      PeekAndPollIfc<Long>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput{
    Long pop();
    default double popDouble(){
      return popLong();
    }
  ...
  interface OfShort extends OmniCollection,OmniStack,OmniCollection.OfPrimitive,OfPrimitive,OmniCollection.OfShort,
      PeekAndPollIfc<Short>,PeekAndPollIfc.DoubleInput,PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,
      PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput{
    Short pop();
    default double popDouble(){
      return popShort();
    }
