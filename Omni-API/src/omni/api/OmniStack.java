...
public interface OmniStack extends OmniCollection{
    ...
    interface OfBoolean
        ...
        // TODO vanillaView
        @Override
        default int search(byte val){
            return search((int)val);
        }
        @Override
        default int search(char val){
            return search((int)val);
        }
        @Override
        default int search(short val){
            return search((int)val);
        }
    }
    interface OfByte
    ...
    interface OfPrimitive extends OmniStack,OmniCollection.OfPrimitive{
        @Override
        default int search(Boolean val){
            if(val!=null){
                return search(val.booleanValue());
            }
            return -1;
        }
        @Override
        default int search(Byte val){
            if(val!=null){
                return search(val.byteValue());
            }
            return -1;
        }
        @Override
        default int search(Character val){
            if(val!=null){
                return search(val.charValue());
            }
            return -1;
        }
        @Override
        default int search(Double val){
            if(val!=null){
                return search(val.doubleValue());
            }
            return -1;
        }
        @Override
        default int search(Float val){
            if(val!=null){
                return search(val.floatValue());
            }
            return -1;
        }
        @Override
        default int search(Integer val){
            if(val!=null){
                return search(val.intValue());
            }
            return -1;
        }
        @Override
        default int search(Long val){
            if(val!=null){
                return search(val.longValue());
            }
            return -1;
        }
        @Override
