...
public interface OmniStack extends OmniCollection{
  ...
  int search(Short val);
  interface OfBoolean extends OfPrimitive,OmniCollection.OfBoolean,PeekAndPollIfc<Boolean>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfByte extends OfPrimitive,OmniCollection.OfByte,PeekAndPollIfc<Byte>,PeekAndPollIfc.DoubleInput,
      PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput,
  ...
  interface OfChar extends OfPrimitive,OmniCollection.OfChar,PeekAndPollIfc<Character>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfDouble extends OfPrimitive,OmniCollection.OfDouble,PeekAndPollIfc<Double>,PeekAndPollIfc.DoubleInput{
    Double pop();
    double popDouble();
    default void push(boolean val){
  ...
  interface OfFloat extends OfPrimitive,OmniCollection.OfFloat,PeekAndPollIfc<Float>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfInt extends OfPrimitive,OmniCollection.OfInt,PeekAndPollIfc<Integer>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfLong extends OfPrimitive,OmniCollection.OfLong,PeekAndPollIfc<Long>,PeekAndPollIfc.DoubleInput,
  ...
  interface OfPrimitive extends OmniStack,OmniCollection.OfPrimitive{
  ...
  interface OfRef<E>extends OmniStack,OmniCollection.OfRef<E>,PeekAndPollIfc<E>{
    E pop();
    void push(E val);
    // TODO spliterator,
    // TODO stream
  ...
  interface OfShort extends OfPrimitive,OmniCollection.OfShort,PeekAndPollIfc<Short>,PeekAndPollIfc.DoubleInput,
      PeekAndPollIfc.FloatInput,PeekAndPollIfc.LongInput,PeekAndPollIfc.IntInput,PeekAndPollIfc.ShortInput{
    Short pop();
    default double popDouble(){
      return popShort();
