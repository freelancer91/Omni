...
public interface OmniCollection{
    ...
    interface OfBoolean extends OfPrimitive{
        ...
        boolean add(Boolean val);
        @Override
        default boolean contains(byte val){
            return contains((int)val);
        }
        @Override
        default boolean contains(char val){
            return contains((int)val);
        }
        @Override
        ...
        @Override
        default boolean removeVal(byte val){
            return removeVal((int)val);
        }
        @Override
        default boolean removeVal(char val){
            return removeVal((int)val);
        }
        @Override
        default boolean removeVal(short val){
            return removeVal((int)val);
        }
        @Override
        Boolean[] toArray();
    ...
    interface OfPrimitive extends OmniCollection{
        @Override
        default boolean contains(Boolean val){
        ...
        @Override
        default boolean contains(Character val){
            return contains(val.charValue());
        }
        @Override
        default boolean contains(Double val){
            return contains(val.doubleValue());
        }
        @Override
        default boolean contains(Float val){
            return contains(val.floatValue());
        }
        @Override
        default boolean contains(Integer val){
            return contains(val.intValue());
        }
        @Override
        default boolean contains(Long val){
        ...
        @Override
        default boolean removeVal(Boolean val){
        ...
        @Override
        default boolean removeVal(Character val){
            return removeVal(val.charValue());
        }
        @Override
        default boolean removeVal(Double val){
            return removeVal(val.doubleValue());
        }
        @Override
        default boolean removeVal(Float val){
            return removeVal(val.floatValue());
        }
        @Override
        default boolean removeVal(Integer val){
            return removeVal(val.intValue());
        }
        @Override
        default boolean removeVal(Long val){
