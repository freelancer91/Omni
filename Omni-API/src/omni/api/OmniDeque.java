...
public interface OmniDeque extends OmniQueue,OmniStack{
    ...
    boolean removeLastOccurrence(Short val);
    interface OfBoolean extends OfPrimitive,OmniQueue.OfBoolean,OmniStack.OfBoolean{
    ...
    interface OfPrimitive extends OmniDeque,OmniStack.OfPrimitive{
        @Override
        default boolean removeFirstOccurrence(Boolean val){
            return val!=null&&removeFirstOccurrence(val.booleanValue());
        }
        @Override
        default boolean removeFirstOccurrence(Byte val){
            return val!=null&&removeFirstOccurrence(val.byteValue());
        }
        @Override
        default boolean removeFirstOccurrence(Character val){
        ...
        @Override
        default boolean removeFirstOccurrence(Integer val){
        ...
        @Override
        default boolean removeFirstOccurrence(Short val){
            return val!=null&&removeFirstOccurrence(val.shortValue());
        }
        @Override
        default boolean removeLastOccurrence(Boolean val){
            return val!=null&&removeLastOccurrence(val.booleanValue());
        }
        @Override
        default boolean removeLastOccurrence(Byte val){
            return val!=null&&removeLastOccurrence(val.byteValue());
        }
        @Override
        default boolean removeLastOccurrence(Character val){
            return val!=null&&removeLastOccurrence(val.charValue());
        }
        @Override
        default boolean removeLastOccurrence(Double val){
            return val!=null&&removeLastOccurrence(val.doubleValue());
        }
        @Override
        default boolean removeLastOccurrence(Float val){
            return val!=null&&removeLastOccurrence(val.floatValue());
        }
        @Override
        default boolean removeLastOccurrence(Integer val){
            return val!=null&&removeLastOccurrence(val.intValue());
        }
        @Override
        default boolean removeLastOccurrence(Long val){
            return val!=null&&removeLastOccurrence(val.longValue());
        }
        @Override
        default boolean removeLastOccurrence(Short val){
            return val!=null&&removeLastOccurrence(val.shortValue());
        }
    }
    interface OfRef<E>extends OmniDeque,OmniQueue.OfRef<E>,OmniStack.OfRef<E>{
        void addFirst(E val);
        void addLast(E val);
