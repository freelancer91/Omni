...
public interface OmniList extends OmniCollection{
  ...
  interface OfBoolean extends OfPrimitive,OmniCollection.OfBoolean{
    ...
    @Override default int indexOf(byte val){
      return indexOf((int)val);
    }
    @Override default int indexOf(char val){
      return indexOf((int)val);
    }
    @Override default int indexOf(short val){
      return indexOf((int)val);
    }
    @Override default int lastIndexOf(byte val){
      return lastIndexOf((int)val);
    }
    @Override default int lastIndexOf(char val){
      return lastIndexOf((int)val);
    }
    @Override default int lastIndexOf(short val){
      return lastIndexOf((int)val);
    }
  ...
  interface OfPrimitive extends OmniList,OmniCollection.OfPrimitive{
    @Override default int indexOf(Boolean val){
      if(val!=null){ return indexOf(val.booleanValue()); }
      return -1;
    }
    @Override default int indexOf(Byte val){
      if(val!=null){ return indexOf(val.byteValue()); }
      return -1;
    }
    @Override default int indexOf(Character val){
      if(val!=null){ return indexOf(val.charValue()); }
      return -1;
    }
    @Override default int indexOf(Double val){
      if(val!=null){ return indexOf(val.doubleValue()); }
      return -1;
    }
    @Override default int indexOf(Float val){
      if(val!=null){ return indexOf(val.floatValue()); }
      return -1;
    }
    @Override default int indexOf(Integer val){
      if(val!=null){ return indexOf(val.intValue()); }
      return -1;
    }
    @Override default int indexOf(Long val){
      if(val!=null){ return indexOf(val.longValue()); }
      return -1;
    }
    @Override default int indexOf(Short val){
      if(val!=null){ return indexOf(val.shortValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Boolean val){
      if(val!=null){ return lastIndexOf(val.booleanValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Byte val){
      if(val!=null){ return lastIndexOf(val.byteValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Character val){
      if(val!=null){ return lastIndexOf(val.charValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Double val){
      if(val!=null){ return lastIndexOf(val.doubleValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Float val){
      if(val!=null){ return lastIndexOf(val.floatValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Integer val){
      if(val!=null){ return lastIndexOf(val.intValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Long val){
      if(val!=null){ return lastIndexOf(val.longValue()); }
      return -1;
    }
    @Override default int lastIndexOf(Short val){
      if(val!=null){ return lastIndexOf(val.shortValue()); }
      return -1;
    }
  }
